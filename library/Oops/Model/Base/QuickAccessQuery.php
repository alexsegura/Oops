...
/**
 * Base class that represents a query for the 'djland_quick_access' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_QuickAccessQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_QUICK_ACCESS`, `NEW_WINDOW`, `LINK` FROM `djland_quick_access` WHERE `ID_QUICK_ACCESS` = :p0';
		try {
