...
/**
 * Base class that represents a query for the 'djland_date_range' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_DateRangeQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_DATE_RANGE`, `TIME_START`, `TIME_END` FROM `djland_date_range` WHERE `ID_DATE_RANGE` = :p0';
		try {
