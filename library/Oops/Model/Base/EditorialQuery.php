...
/**
 * Base class that represents a query for the 'djland_editorial' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_EditorialQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_EDITORIAL`, `BODY_HOME_LOGO_LINK` FROM `djland_editorial` WHERE `ID_EDITORIAL` = :p0';
		try {
