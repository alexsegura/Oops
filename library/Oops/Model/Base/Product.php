 ...
 */
abstract class Oops_Model_Base_Product extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Model_ProductPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Model_ProductPeer
	 */
	...
	/**
	 * @var        array Oops_Model_CategoryProduct[] Collection to store aggregation of Oops_Model_CategoryProduct objects.
	 */
	...
	/**
	 * @var        array Oops_Model_Image[] Collection to store aggregation of Oops_Model_Image objects.
	 */
	...
	/**
	 * @var        array Oops_Model_StockMvt[] Collection to store aggregation of Oops_Model_StockMvt objects.
	 */
	protected $collStockMvts;

	/**
	 * @var        Oops_Model_Supplier one-to-one related Oops_Model_Supplier object
	 */
	...
	/**
	 * @var        array Oops_Model_Feature[] Collection to store aggregation of Oops_Model_Feature objects.
	 */
	...
	/**
	 * Initializes internal state of Oops_Model_Base_Product object.
	 * @see        applyDefaults()
	 */
	...
	public function setIdProduct($v)
	{
		...
		if ($this->id_product !== $v) {
			$this->id_product = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::ID_PRODUCT;
		}
	...
	public function setIdSupplier($v)
	{
		...
		if ($this->id_supplier !== $v) {
			$this->id_supplier = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::ID_SUPPLIER;
		}
	...
	public function setIdManufacturer($v)
	{
		...
		if ($this->id_manufacturer !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::ID_MANUFACTURER;
		}
	...
	public function setIdTaxRulesGroup($v)
	{
		...
		if ($this->id_tax_rules_group !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::ID_TAX_RULES_GROUP;
		}
	...
	public function setIdCategoryDefault($v)
	{
		...
		if ($this->id_category_default !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::ID_CATEGORY_DEFAULT;
		}
	...
	public function setIdColorDefault($v)
	{
		...
		if ($this->id_color_default !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::ID_COLOR_DEFAULT;
		}
	...
	public function setOnSale($v)
	{
		...
		if ($this->on_sale !== $v) {
			$this->on_sale = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::ON_SALE;
		}
	...
	public function setOnlineOnly($v)
	{
		...
		if ($this->online_only !== $v) {
			$this->online_only = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::ONLINE_ONLY;
		}
	...
	public function setEan13($v)
	{
		...
		if ($this->ean13 !== $v) {
			$this->ean13 = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::EAN13;
		}
	...
	public function setUpc($v)
	{
		...
		if ($this->upc !== $v) {
			$this->upc = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::UPC;
		}
	...
	public function setEcotax($v)
	{
		...
		if ($this->ecotax !== $v) {
			$this->ecotax = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::ECOTAX;
		}
	...
	public function setQuantity($v)
	{
		...
		if ($this->quantity !== $v) {
			$this->quantity = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::QUANTITY;
		}
	...
	public function setMinimalQuantity($v)
	{
		...
		if ($this->minimal_quantity !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::MINIMAL_QUANTITY;
		}
	...
	public function setPrice($v)
	{
		...
		if ($this->price !== $v) {
			$this->price = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::PRICE;
		}
	...
	public function setWholesalePrice($v)
	{
		...
		if ($this->wholesale_price !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::WHOLESALE_PRICE;
		}
	...
	public function setUnity($v)
	{
		...
		if ($this->unity !== $v) {
			$this->unity = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::UNITY;
		}
	...
	public function setUnitPriceRatio($v)
	{
		...
		if ($this->unit_price_ratio !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::UNIT_PRICE_RATIO;
		}
	...
	public function setAdditionalShippingCost($v)
	{
		...
		if ($this->additional_shipping_cost !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::ADDITIONAL_SHIPPING_COST;
		}
	...
	public function setReference($v)
	{
		...
		if ($this->reference !== $v) {
			$this->reference = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::REFERENCE;
		}
	...
	public function setSupplierReference($v)
	{
		...
		if ($this->supplier_reference !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::SUPPLIER_REFERENCE;
		}
	...
	public function setLocation($v)
	{
		...
		if ($this->location !== $v) {
			$this->location = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::LOCATION;
		}
	...
	public function setWidth($v)
	{
		...
		if ($this->width !== $v) {
			$this->width = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::WIDTH;
		}
	...
	public function setHeight($v)
	{
		...
		if ($this->height !== $v) {
			$this->height = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::HEIGHT;
		}
	...
	public function setDepth($v)
	{
		...
		if ($this->depth !== $v) {
			$this->depth = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::DEPTH;
		}
	...
	public function setWeight($v)
	{
		...
		if ($this->weight !== $v) {
			$this->weight = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::WEIGHT;
		}
	...
	public function setOutOfStock($v)
	{
		...
		if ($this->out_of_stock !== $v) {
			$this->out_of_stock = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::OUT_OF_STOCK;
		}
	...
	public function setQuantityDiscount($v)
	{
		...
		if ($this->quantity_discount !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::QUANTITY_DISCOUNT;
		}
	...
	public function setCustomizable($v)
	{
		...
		if ($this->customizable !== $v) {
			$this->customizable = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::CUSTOMIZABLE;
		}
	...
	public function setUploadableFiles($v)
	{
		...
		if ($this->uploadable_files !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::UPLOADABLE_FILES;
		}
	...
	public function setTextFields($v)
	{
		...
		if ($this->text_fields !== $v) {
			$this->text_fields = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::TEXT_FIELDS;
		}
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v) {
			$this->active = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::ACTIVE;
		}
	...
	public function setAvailableForOrder($v)
	{
		...
		if ($this->available_for_order !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::AVAILABLE_FOR_ORDER;
		}
	...
	public function setCondition($v)
	{
		...
		if ($this->condition !== $v) {
			$this->condition = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::CONDITION;
		}
	...
	public function setShowPrice($v)
	{
		...
		if ($this->show_price !== $v) {
			$this->show_price = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::SHOW_PRICE;
		}
	...
	public function setIndexed($v)
	{
		...
		if ($this->indexed !== $v) {
			$this->indexed = $v;
			$this->modifiedColumns[] = Oops_Model_ProductPeer::INDEXED;
		}
	...
	public function setCacheIsPack($v)
	{
		...
		if ($this->cache_is_pack !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::CACHE_IS_PACK;
		}
	...
	public function setCacheHasAttachments($v)
	{
		...
		if ($this->cache_has_attachments !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::CACHE_HAS_ATTACHMENTS;
		}
	...
	public function setCacheDefaultAttribute($v)
	{
		...
		if ($this->cache_default_attribute !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_ProductPeer::CACHE_DEFAULT_ATTRIBUTE;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Model_ProductPeer::DATE_ADD;
			}
	...
	public function setDateUpd($v)
	{
		...
		if ($this->date_upd !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Model_ProductPeer::DATE_UPD;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 40; // 40 = Oops_Model_ProductPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Model_Product object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Model_ProductPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Model_ProductQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Model_ProductPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->categoryProductsScheduledForDeletion !== null) {
				if (!$this->categoryProductsScheduledForDeletion->isEmpty()) {
					Oops_Model_CategoryProductQuery::create()
			...
			if ($this->stockMvtsScheduledForDeletion !== null) {
				if (!$this->stockMvtsScheduledForDeletion->isEmpty()) {
					Oops_Model_StockMvtQuery::create()
			...
			if ($this->suppliersScheduledForDeletion !== null) {
				if (!$this->suppliersScheduledForDeletion->isEmpty()) {
					Oops_Model_SupplierQuery::create()
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Model_ProductPeer::ID_PRODUCT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PRODUCT`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::ID_SUPPLIER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_SUPPLIER`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::ID_MANUFACTURER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_MANUFACTURER`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::ID_TAX_RULES_GROUP)) {
			$modifiedColumns[':p' . $index++]  = '`ID_TAX_RULES_GROUP`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::ID_CATEGORY_DEFAULT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CATEGORY_DEFAULT`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::ID_COLOR_DEFAULT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_COLOR_DEFAULT`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::ON_SALE)) {
			$modifiedColumns[':p' . $index++]  = '`ON_SALE`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::ONLINE_ONLY)) {
			$modifiedColumns[':p' . $index++]  = '`ONLINE_ONLY`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::EAN13)) {
			$modifiedColumns[':p' . $index++]  = '`EAN13`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::UPC)) {
			$modifiedColumns[':p' . $index++]  = '`UPC`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::ECOTAX)) {
			$modifiedColumns[':p' . $index++]  = '`ECOTAX`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::QUANTITY)) {
			$modifiedColumns[':p' . $index++]  = '`QUANTITY`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::MINIMAL_QUANTITY)) {
			$modifiedColumns[':p' . $index++]  = '`MINIMAL_QUANTITY`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::PRICE)) {
			$modifiedColumns[':p' . $index++]  = '`PRICE`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::WHOLESALE_PRICE)) {
			$modifiedColumns[':p' . $index++]  = '`WHOLESALE_PRICE`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::UNITY)) {
			$modifiedColumns[':p' . $index++]  = '`UNITY`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::UNIT_PRICE_RATIO)) {
			$modifiedColumns[':p' . $index++]  = '`UNIT_PRICE_RATIO`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::ADDITIONAL_SHIPPING_COST)) {
			$modifiedColumns[':p' . $index++]  = '`ADDITIONAL_SHIPPING_COST`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::REFERENCE)) {
			$modifiedColumns[':p' . $index++]  = '`REFERENCE`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::SUPPLIER_REFERENCE)) {
			$modifiedColumns[':p' . $index++]  = '`SUPPLIER_REFERENCE`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::LOCATION)) {
			$modifiedColumns[':p' . $index++]  = '`LOCATION`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::WIDTH)) {
			$modifiedColumns[':p' . $index++]  = '`WIDTH`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::HEIGHT)) {
			$modifiedColumns[':p' . $index++]  = '`HEIGHT`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::DEPTH)) {
			$modifiedColumns[':p' . $index++]  = '`DEPTH`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::WEIGHT)) {
			$modifiedColumns[':p' . $index++]  = '`WEIGHT`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::OUT_OF_STOCK)) {
			$modifiedColumns[':p' . $index++]  = '`OUT_OF_STOCK`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::QUANTITY_DISCOUNT)) {
			$modifiedColumns[':p' . $index++]  = '`QUANTITY_DISCOUNT`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::CUSTOMIZABLE)) {
			$modifiedColumns[':p' . $index++]  = '`CUSTOMIZABLE`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::UPLOADABLE_FILES)) {
			$modifiedColumns[':p' . $index++]  = '`UPLOADABLE_FILES`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::TEXT_FIELDS)) {
			$modifiedColumns[':p' . $index++]  = '`TEXT_FIELDS`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::ACTIVE)) {
			$modifiedColumns[':p' . $index++]  = '`ACTIVE`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::AVAILABLE_FOR_ORDER)) {
			$modifiedColumns[':p' . $index++]  = '`AVAILABLE_FOR_ORDER`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::CONDITION)) {
			$modifiedColumns[':p' . $index++]  = '`CONDITION`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::SHOW_PRICE)) {
			$modifiedColumns[':p' . $index++]  = '`SHOW_PRICE`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::INDEXED)) {
			$modifiedColumns[':p' . $index++]  = '`INDEXED`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::CACHE_IS_PACK)) {
			$modifiedColumns[':p' . $index++]  = '`CACHE_IS_PACK`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::CACHE_HAS_ATTACHMENTS)) {
			$modifiedColumns[':p' . $index++]  = '`CACHE_HAS_ATTACHMENTS`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::CACHE_DEFAULT_ATTRIBUTE)) {
			$modifiedColumns[':p' . $index++]  = '`CACHE_DEFAULT_ATTRIBUTE`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}
		if ($this->isColumnModified(Oops_Model_ProductPeer::DATE_UPD)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Model_ProductPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Model_ProductPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Model_Product'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Model_Product'][$this->getPrimaryKey()] = true;
		$keys = Oops_Model_ProductPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Model_ProductPeer::ID_PRODUCT)) $criteria->add(Oops_Model_ProductPeer::ID_PRODUCT, $this->id_product);
		if ($this->isColumnModified(Oops_Model_ProductPeer::ID_SUPPLIER)) $criteria->add(Oops_Model_ProductPeer::ID_SUPPLIER, $this->id_supplier);
		if ($this->isColumnModified(Oops_Model_ProductPeer::ID_MANUFACTURER)) $criteria->add(Oops_Model_ProductPeer::ID_MANUFACTURER, $this->id_manufacturer);
		if ($this->isColumnModified(Oops_Model_ProductPeer::ID_TAX_RULES_GROUP)) $criteria->add(Oops_Model_ProductPeer::ID_TAX_RULES_GROUP, $this->id_tax_rules_group);
		if ($this->isColumnModified(Oops_Model_ProductPeer::ID_CATEGORY_DEFAULT)) $criteria->add(Oops_Model_ProductPeer::ID_CATEGORY_DEFAULT, $this->id_category_default);
		if ($this->isColumnModified(Oops_Model_ProductPeer::ID_COLOR_DEFAULT)) $criteria->add(Oops_Model_ProductPeer::ID_COLOR_DEFAULT, $this->id_color_default);
		if ($this->isColumnModified(Oops_Model_ProductPeer::ON_SALE)) $criteria->add(Oops_Model_ProductPeer::ON_SALE, $this->on_sale);
		if ($this->isColumnModified(Oops_Model_ProductPeer::ONLINE_ONLY)) $criteria->add(Oops_Model_ProductPeer::ONLINE_ONLY, $this->online_only);
		if ($this->isColumnModified(Oops_Model_ProductPeer::EAN13)) $criteria->add(Oops_Model_ProductPeer::EAN13, $this->ean13);
		if ($this->isColumnModified(Oops_Model_ProductPeer::UPC)) $criteria->add(Oops_Model_ProductPeer::UPC, $this->upc);
		if ($this->isColumnModified(Oops_Model_ProductPeer::ECOTAX)) $criteria->add(Oops_Model_ProductPeer::ECOTAX, $this->ecotax);
		if ($this->isColumnModified(Oops_Model_ProductPeer::QUANTITY)) $criteria->add(Oops_Model_ProductPeer::QUANTITY, $this->quantity);
		if ($this->isColumnModified(Oops_Model_ProductPeer::MINIMAL_QUANTITY)) $criteria->add(Oops_Model_ProductPeer::MINIMAL_QUANTITY, $this->minimal_quantity);
		if ($this->isColumnModified(Oops_Model_ProductPeer::PRICE)) $criteria->add(Oops_Model_ProductPeer::PRICE, $this->price);
		if ($this->isColumnModified(Oops_Model_ProductPeer::WHOLESALE_PRICE)) $criteria->add(Oops_Model_ProductPeer::WHOLESALE_PRICE, $this->wholesale_price);
		if ($this->isColumnModified(Oops_Model_ProductPeer::UNITY)) $criteria->add(Oops_Model_ProductPeer::UNITY, $this->unity);
		if ($this->isColumnModified(Oops_Model_ProductPeer::UNIT_PRICE_RATIO)) $criteria->add(Oops_Model_ProductPeer::UNIT_PRICE_RATIO, $this->unit_price_ratio);
		if ($this->isColumnModified(Oops_Model_ProductPeer::ADDITIONAL_SHIPPING_COST)) $criteria->add(Oops_Model_ProductPeer::ADDITIONAL_SHIPPING_COST, $this->additional_shipping_cost);
		if ($this->isColumnModified(Oops_Model_ProductPeer::REFERENCE)) $criteria->add(Oops_Model_ProductPeer::REFERENCE, $this->reference);
		if ($this->isColumnModified(Oops_Model_ProductPeer::SUPPLIER_REFERENCE)) $criteria->add(Oops_Model_ProductPeer::SUPPLIER_REFERENCE, $this->supplier_reference);
		if ($this->isColumnModified(Oops_Model_ProductPeer::LOCATION)) $criteria->add(Oops_Model_ProductPeer::LOCATION, $this->location);
		if ($this->isColumnModified(Oops_Model_ProductPeer::WIDTH)) $criteria->add(Oops_Model_ProductPeer::WIDTH, $this->width);
		if ($this->isColumnModified(Oops_Model_ProductPeer::HEIGHT)) $criteria->add(Oops_Model_ProductPeer::HEIGHT, $this->height);
		if ($this->isColumnModified(Oops_Model_ProductPeer::DEPTH)) $criteria->add(Oops_Model_ProductPeer::DEPTH, $this->depth);
		if ($this->isColumnModified(Oops_Model_ProductPeer::WEIGHT)) $criteria->add(Oops_Model_ProductPeer::WEIGHT, $this->weight);
		if ($this->isColumnModified(Oops_Model_ProductPeer::OUT_OF_STOCK)) $criteria->add(Oops_Model_ProductPeer::OUT_OF_STOCK, $this->out_of_stock);
		if ($this->isColumnModified(Oops_Model_ProductPeer::QUANTITY_DISCOUNT)) $criteria->add(Oops_Model_ProductPeer::QUANTITY_DISCOUNT, $this->quantity_discount);
		if ($this->isColumnModified(Oops_Model_ProductPeer::CUSTOMIZABLE)) $criteria->add(Oops_Model_ProductPeer::CUSTOMIZABLE, $this->customizable);
		if ($this->isColumnModified(Oops_Model_ProductPeer::UPLOADABLE_FILES)) $criteria->add(Oops_Model_ProductPeer::UPLOADABLE_FILES, $this->uploadable_files);
		if ($this->isColumnModified(Oops_Model_ProductPeer::TEXT_FIELDS)) $criteria->add(Oops_Model_ProductPeer::TEXT_FIELDS, $this->text_fields);
		if ($this->isColumnModified(Oops_Model_ProductPeer::ACTIVE)) $criteria->add(Oops_Model_ProductPeer::ACTIVE, $this->active);
		if ($this->isColumnModified(Oops_Model_ProductPeer::AVAILABLE_FOR_ORDER)) $criteria->add(Oops_Model_ProductPeer::AVAILABLE_FOR_ORDER, $this->available_for_order);
		if ($this->isColumnModified(Oops_Model_ProductPeer::CONDITION)) $criteria->add(Oops_Model_ProductPeer::CONDITION, $this->condition);
		if ($this->isColumnModified(Oops_Model_ProductPeer::SHOW_PRICE)) $criteria->add(Oops_Model_ProductPeer::SHOW_PRICE, $this->show_price);
		if ($this->isColumnModified(Oops_Model_ProductPeer::INDEXED)) $criteria->add(Oops_Model_ProductPeer::INDEXED, $this->indexed);
		if ($this->isColumnModified(Oops_Model_ProductPeer::CACHE_IS_PACK)) $criteria->add(Oops_Model_ProductPeer::CACHE_IS_PACK, $this->cache_is_pack);
		if ($this->isColumnModified(Oops_Model_ProductPeer::CACHE_HAS_ATTACHMENTS)) $criteria->add(Oops_Model_ProductPeer::CACHE_HAS_ATTACHMENTS, $this->cache_has_attachments);
		if ($this->isColumnModified(Oops_Model_ProductPeer::CACHE_DEFAULT_ATTRIBUTE)) $criteria->add(Oops_Model_ProductPeer::CACHE_DEFAULT_ATTRIBUTE, $this->cache_default_attribute);
		if ($this->isColumnModified(Oops_Model_ProductPeer::DATE_ADD)) $criteria->add(Oops_Model_ProductPeer::DATE_ADD, $this->date_add);
		if ($this->isColumnModified(Oops_Model_ProductPeer::DATE_UPD)) $criteria->add(Oops_Model_ProductPeer::DATE_UPD, $this->date_upd);
	...
	{
		$criteria = new Criteria(Oops_Model_ProductPeer::DATABASE_NAME);
		$criteria->add(Oops_Model_ProductPeer::ID_PRODUCT, $this->id_product);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Model_Product (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Model_Product Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Model_ProductPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Model_ProductPeer();
		}
		return self::$peer;
	}
	...
	public function initCategoryProducts($overrideExisting = true)
	{
		...
		$this->collCategoryProducts->setModel('Oops_Model_CategoryProduct');
	}

	/**
	 * Gets an array of Oops_Model_CategoryProduct objects which contain a foreign key that references this object.
	 *
	 * If the $criteria is not null, it is used to always fetch the results from the database.
	 * Otherwise the results are fetched from the database the first time, then cached.
	 * Next time the same method is called without $criteria, the cached collection is returned.
	 * If this Oops_Model_Product is new, it will return
	 * an empty collection or the current collection; the criteria is ignored on a new object.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array Oops_Model_CategoryProduct[] List of Oops_Model_CategoryProduct objects
	 * @throws     PropelException
	 */
	public function getCategoryProducts($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collCategoryProducts || null !== $criteria) {
			if ($this->isNew() && null === $this->collCategoryProducts) {
				...
				$collCategoryProducts = Oops_Model_CategoryProductQuery::create(null, $criteria)
	...
	/**
	 * Returns the number of related Oops_Model_CategoryProduct objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Oops_Model_CategoryProduct objects.
	 * @throws     PropelException
	 */
	public function countCategoryProducts(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collCategoryProducts || null !== $criteria) {
			if ($this->isNew() && null === $this->collCategoryProducts) {
				...
				$query = Oops_Model_CategoryProductQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
	...
	/**
	 * Method called to associate a Oops_Model_CategoryProduct object to this object
	 * through the Oops_Model_CategoryProduct foreign key attribute.
	 *
	 * @param      Oops_Model_CategoryProduct $l Oops_Model_CategoryProduct
	 * @return     Oops_Model_Product The current object (for fluent API support)
	 */
	public function addCategoryProduct(Oops_Model_CategoryProduct $l)
	{
		if ($this->collCategoryProducts === null) {
			$this->initCategoryProducts();
		}
	...
	public function initImages($overrideExisting = true)
	{
		...
		$this->collImages->setModel('Oops_Model_Image');
	}

	/**
	 * Gets an array of Oops_Model_Image objects which contain a foreign key that references this object.
	 *
	 * If the $criteria is not null, it is used to always fetch the results from the database.
	 * Otherwise the results are fetched from the database the first time, then cached.
	 * Next time the same method is called without $criteria, the cached collection is returned.
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array Oops_Model_Image[] List of Oops_Model_Image objects
	 * @throws     PropelException
	 */
	public function getImages($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collImages || null !== $criteria) {
			if ($this->isNew() && null === $this->collImages) {
				...
				$collImages = Oops_Model_ImageQuery::create(null, $criteria)
					->filterByProduct($this)
					->find($con);
				if (null !== $criteria) {
					return $collImages;
	...
	/**
	 * Returns the number of related Oops_Model_Image objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Oops_Model_Image objects.
	 * @throws     PropelException
	 */
	public function countImages(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collImages || null !== $criteria) {
			if ($this->isNew() && null === $this->collImages) {
				...
				$query = Oops_Model_ImageQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
	...
	/**
	 * Method called to associate a Oops_Model_Image object to this object
	 * through the Oops_Model_Image foreign key attribute.
	 *
	 * @param      Oops_Model_Image $l Oops_Model_Image
	 * @return     Oops_Model_Product The current object (for fluent API support)
	 */
	public function addImage(Oops_Model_Image $l)
	{
		if ($this->collImages === null) {
			$this->initImages();
		}
	...
	public function initStockMvts($overrideExisting = true)
	{
		...
		$this->collStockMvts->setModel('Oops_Model_StockMvt');
	}

	/**
	 * Gets an array of Oops_Model_StockMvt objects which contain a foreign key that references this object.
	 *
	 * If the $criteria is not null, it is used to always fetch the results from the database.
	 * Otherwise the results are fetched from the database the first time, then cached.
	 * Next time the same method is called without $criteria, the cached collection is returned.
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array Oops_Model_StockMvt[] List of Oops_Model_StockMvt objects
	 * @throws     PropelException
	 */
	public function getStockMvts($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collStockMvts || null !== $criteria) {
			if ($this->isNew() && null === $this->collStockMvts) {
				...
				$collStockMvts = Oops_Model_StockMvtQuery::create(null, $criteria)
					->filterByProduct($this)
					->find($con);
				if (null !== $criteria) {
	...
	/**
	 * Returns the number of related Oops_Model_StockMvt objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Oops_Model_StockMvt objects.
	 * @throws     PropelException
	 */
	public function countStockMvts(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collStockMvts || null !== $criteria) {
			if ($this->isNew() && null === $this->collStockMvts) {
				...
				$query = Oops_Model_StockMvtQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
	...
	/**
	 * Method called to associate a Oops_Model_StockMvt object to this object
	 * through the Oops_Model_StockMvt foreign key attribute.
	 *
	 * @param      Oops_Model_StockMvt $l Oops_Model_StockMvt
	 * @return     Oops_Model_Product The current object (for fluent API support)
	 */
	public function addStockMvt(Oops_Model_StockMvt $l)
	{
		if ($this->collStockMvts === null) {
			$this->initStockMvts();
		}
	...
	/**
	 * Gets a single Oops_Model_Supplier object, which is related to this object by a one-to-one relationship.
	 *
	 * @param      PropelPDO $con optional connection object
	 * @return     Oops_Model_Supplier
	 * @throws     PropelException
	 */
	public function getSupplier(PropelPDO $con = null)
	{
		...
		if ($this->singleSupplier === null && !$this->isNew()) {
			$this->singleSupplier = Oops_Model_SupplierQuery::create()->findPk($this->getPrimaryKey(), $con);
		}
	...
	/**
	 * Sets a single Oops_Model_Supplier object as related to this object by a one-to-one relationship.
	 *
	 * @param      Oops_Model_Supplier $v Oops_Model_Supplier
	 * @return     Oops_Model_Product The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setSupplier(Oops_Model_Supplier $v = null)
	{
		$this->singleSupplier = $v;

		// Make sure that that the passed-in Oops_Model_Supplier isn't already associated with this object
	...
	{
		$oops_Model_CategoryProducts = CategoryProductQuery::create()
			->filterByOops_Model_Category($categories)
			->filterByProduct($this)
			->find($con);

		$this->categoriesScheduledForDeletion = $this->getCategoryProducts()->diff($oops_Model_CategoryProducts);
		$this->collCategoryProducts = $oops_Model_CategoryProducts;
	...
	{
		$categoryProduct = new Oops_Model_CategoryProduct();
		$categoryProduct->setCategory($category);
		$this->addOops_Model_CategoryProduct($categoryProduct);
	}
	...
	public function initFeatures()
	{
		...
		$this->collFeatures->setModel('Oops_Model_Feature');
	}

	/**
	 * Gets a collection of Oops_Model_Feature objects related by a many-to-many relationship
	 ...
	 * @param      PropelPDO $con Optional connection object
	 *
	 * @return     PropelCollection|array Oops_Model_Feature[] List of Oops_Model_Feature objects
	 */
	public function getFeatures($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collFeatures || null !== $criteria) {
			if ($this->isNew() && null === $this->collFeatures) {
				...
				$collFeatures = Oops_Model_FeatureQuery::create(null, $criteria)
					->filterByProduct($this)
					->find($con);
				if (null !== $criteria) {
					return $collFeatures;
	...
	/**
	 * Sets a collection of Oops_Model_Feature objects related by a many-to-many relationship
	 * to the current object by way of the feature_product cross-reference table.
	 * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
	 * and new objects from the given Propel collection.
	 *
	...
	public function setFeatures(PropelCollection $features, PropelPDO $con = null)
	{
		$oops_Model_FeatureProducts = FeatureProductQuery::create()
			->filterByOops_Model_Feature($features)
			->filterByProduct($this)
			->find($con);

		$this->featuresScheduledForDeletion = $this->getFeatureProducts()->diff($oops_Model_FeatureProducts);
		$this->collFeatureProducts = $oops_Model_FeatureProducts;

		foreach ($features as $feature) {
			// Fix issue with collection modified by reference
			if ($feature->isNew()) {
				$this->doAddOops_Model_Feature($feature);
			} else {
				$this->addOops_Model_Feature($feature);
			}
		}
	...
	/**
	 * Gets the number of Oops_Model_Feature objects related by a many-to-many relationship
	 * to the current object by way of the feature_product cross-reference table.
	 *
	 * @param      Criteria $criteria Optional query object to filter the query
	 * @param      boolean $distinct Set to true to force count distinct
	 * @param      PropelPDO $con Optional connection object
	 *
	 * @return     int the number of related Oops_Model_Feature objects
	 */
	public function countFeatures($criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collFeatures || null !== $criteria) {
			if ($this->isNew() && null === $this->collFeatures) {
				...
				$query = Oops_Model_FeatureQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
	...
	/**
	 * Associate a Oops_Model_Feature object to this object
	 * through the feature_product cross reference table.
	 *
	 * @param      Oops_Model_Feature $feature The Oops_Model_FeatureProduct object to relate
	 * @return     void
	 */
