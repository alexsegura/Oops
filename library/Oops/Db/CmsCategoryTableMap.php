 ...
 */
class Oops_Db_CmsCategoryTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_CmsCategoryTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'cms_category');
		$this->setPhpName('CmsCategory');
		$this->setClassname('Oops_Db_CmsCategory');
