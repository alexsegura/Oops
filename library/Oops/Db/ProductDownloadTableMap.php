 ...
 */
class Oops_Db_ProductDownloadTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_ProductDownloadTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_ProductDownload');
...
} // Oops_Db_ProductDownloadTableMap
