 ...
 */
class Oops_Db_OrderReturnTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_OrderReturnTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_OrderReturn');
