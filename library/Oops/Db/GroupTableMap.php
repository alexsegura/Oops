 ...
 */
class Oops_Db_GroupTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_GroupTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'group');
		$this->setPhpName('Group');
		$this->setClassname('Oops_Db_Group');
