 ...
 */
class Oops_Db_CartProductTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_CartProductTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_CartProduct');
