...
/**
 * This class defines the structure of the 'carrier' table.
 *
 *
 *
 ...
 */
class Oops_Db_CarrierTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_CarrierTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'carrier');
		$this->setPhpName('Carrier');
		$this->setClassname('Oops_Db_Carrier');
