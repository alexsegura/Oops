 ...
 */
class Oops_Db_ProductAttributeCombinationTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_ProductAttributeCombinationTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_ProductAttributeCombination');
...
} // Oops_Db_ProductAttributeCombinationTableMap
