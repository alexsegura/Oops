 ...
 */
class Oops_Db_DiscountTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_DiscountTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'discount');
		$this->setPhpName('Discount');
		$this->setClassname('Oops_Db_Discount');
