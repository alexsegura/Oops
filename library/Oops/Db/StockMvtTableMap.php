 ...
 */
class Oops_Db_StockMvtTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_StockMvtTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_StockMvt');
	...
	public function buildRelations()
	{
		...
		$this->addRelation('StockMvtReason', 'Oops_Db_StockMvtReason', RelationMap::ONE_TO_MANY, array('id_stock_mvt_reason' => 'id_stock_mvt_reason', ), null, null, 'StockMvtReasons');
	} // buildRelations()

} // Oops_Db_StockMvtTableMap
