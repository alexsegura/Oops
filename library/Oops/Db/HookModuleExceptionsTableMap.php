 ...
 */
class Oops_Db_HookModuleExceptionsTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_HookModuleExceptionsTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_HookModuleExceptions');
...
} // Oops_Db_HookModuleExceptionsTableMap
