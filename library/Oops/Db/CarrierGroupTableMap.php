 ...
 */
class Oops_Db_CarrierGroupTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_CarrierGroupTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_CarrierGroup');
