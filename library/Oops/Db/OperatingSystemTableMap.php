 ...
 */
class Oops_Db_OperatingSystemTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_OperatingSystemTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_OperatingSystem');
...
} // Oops_Db_OperatingSystemTableMap
