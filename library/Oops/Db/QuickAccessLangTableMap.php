 ...
 */
class Oops_Db_QuickAccessLangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_QuickAccessLangTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_QuickAccessLang');
...
} // Oops_Db_QuickAccessLangTableMap
