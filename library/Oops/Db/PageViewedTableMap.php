 ...
 */
class Oops_Db_PageViewedTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_PageViewedTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_PageViewed');
