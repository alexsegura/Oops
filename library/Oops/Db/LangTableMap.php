 ...
 */
class Oops_Db_LangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_LangTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'lang');
		$this->setPhpName('Lang');
		$this->setClassname('Oops_Db_Lang');
	...
	{
		$this->addRelation('CategoryLang', 'Oops_Db_CategoryLang', RelationMap::ONE_TO_MANY, array('id_lang' => 'id_lang', ), null, null, 'CategoryLangs');
		$this->addRelation('ProductLang', 'Oops_Db_ProductLang', RelationMap::ONE_TO_MANY, array('id_lang' => 'id_lang', ), null, null, 'ProductLangs');
		$this->addRelation('Category', 'Oops_Db_Category', RelationMap::MANY_TO_MANY, array(), null, null, 'Categories');
	} // buildRelations()

} // Oops_Db_LangTableMap
