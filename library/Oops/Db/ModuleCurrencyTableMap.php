 ...
 */
class Oops_Db_ModuleCurrencyTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_ModuleCurrencyTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_ModuleCurrency');
...
} // Oops_Db_ModuleCurrencyTableMap
