 ...
 */
class Oops_Db_DateRangeTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_DateRangeTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_DateRange');
