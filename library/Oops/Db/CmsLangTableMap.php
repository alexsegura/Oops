...
/**
 * This class defines the structure of the 'cms_lang' table.
 *
 *
 *
 ...
 */
class Oops_Db_CmsLangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_CmsLangTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'cms_lang');
		$this->setPhpName('CmsLang');
		$this->setClassname('Oops_Db_CmsLang');
