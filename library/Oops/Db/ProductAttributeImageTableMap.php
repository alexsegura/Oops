 ...
 */
class Oops_Db_ProductAttributeImageTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_ProductAttributeImageTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_ProductAttributeImage');
...
} // Oops_Db_ProductAttributeImageTableMap
