 ...
 */
class Oops_Db_StockMvtReasonLangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_StockMvtReasonLangTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_StockMvtReasonLang');
...
} // Oops_Db_StockMvtReasonLangTableMap
