 ...
 */
class Oops_Db_CountryTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_CountryTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'country');
		$this->setPhpName('Country');
		$this->setClassname('Oops_Db_Country');
