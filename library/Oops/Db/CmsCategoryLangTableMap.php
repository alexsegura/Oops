 ...
 */
class Oops_Db_CmsCategoryLangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_CmsCategoryLangTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_CmsCategoryLang');
...
} // Oops_Db_CmsCategoryLangTableMap
