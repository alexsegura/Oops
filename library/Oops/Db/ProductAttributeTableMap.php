 ...
 */
class Oops_Db_ProductAttributeTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_ProductAttributeTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_ProductAttribute');
...
} // Oops_Db_ProductAttributeTableMap
