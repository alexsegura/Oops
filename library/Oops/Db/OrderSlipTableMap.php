...
/**
 * This class defines the structure of the 'order_slip' table.
 *
 *
 *
 ...
 */
class Oops_Db_OrderSlipTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_OrderSlipTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'order_slip');
		$this->setPhpName('OrderSlip');
		$this->setClassname('Oops_Db_OrderSlip');
