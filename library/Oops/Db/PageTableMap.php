 ...
 */
class Oops_Db_PageTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_PageTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'page');
		$this->setPhpName('Page');
		$this->setClassname('Oops_Db_Page');
