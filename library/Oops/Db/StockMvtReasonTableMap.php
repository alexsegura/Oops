 ...
 */
class Oops_Db_StockMvtReasonTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_StockMvtReasonTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_StockMvtReason');
	...
	{
		$this->addRelation('StockMvt', 'Oops_Db_StockMvt', RelationMap::MANY_TO_ONE, array('id_stock_mvt_reason' => 'id_stock_mvt_reason', ), null, null);
	} // buildRelations()

} // Oops_Db_StockMvtReasonTableMap
