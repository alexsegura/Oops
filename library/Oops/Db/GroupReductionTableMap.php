 ...
 */
class Oops_Db_GroupReductionTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_GroupReductionTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_GroupReduction');
...
} // Oops_Db_GroupReductionTableMap
