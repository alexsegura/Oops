 ...
 */
class Oops_Db_ConfigurationLangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_ConfigurationLangTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_ConfigurationLang');
...
} // Oops_Db_ConfigurationLangTableMap
