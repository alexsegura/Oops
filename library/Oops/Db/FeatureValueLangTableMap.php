 ...
 */
class Oops_Db_FeatureValueLangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_FeatureValueLangTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_FeatureValueLang');
	...
	{
		$this->addRelation('FeatureValue', 'Oops_Db_FeatureValue', RelationMap::MANY_TO_ONE, array('id_feature_value' => 'id_feature_value', ), 'CASCADE', null);
	} // buildRelations()

} // Oops_Db_FeatureValueLangTableMap
