 ...
 */
class Oops_Db_SupplierTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_SupplierTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_Supplier');
	...
	{
		$this->addRelation('Product', 'Oops_Db_Product', RelationMap::MANY_TO_ONE, array('id_supplier' => 'id_supplier', ), null, null);
	} // buildRelations()

} // Oops_Db_SupplierTableMap
