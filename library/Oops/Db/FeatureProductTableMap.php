 ...
 */
class Oops_Db_FeatureProductTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_FeatureProductTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_FeatureProduct');
	...
	public function buildRelations()
	{
		...
		$this->addRelation('FeatureValue', 'Oops_Db_FeatureValue', RelationMap::ONE_TO_ONE, array('id_feature_value' => 'id_feature_value', ), null, null);
	} // buildRelations()

} // Oops_Db_FeatureProductTableMap
