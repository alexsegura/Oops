...
/**
 * This class defines the structure of the 'connections' table.
 *
 *
 *
 ...
 */
class Oops_Db_ConnectionsTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_ConnectionsTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'connections');
		$this->setPhpName('Connections');
		$this->setClassname('Oops_Db_Connections');
