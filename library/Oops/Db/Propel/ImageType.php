 ...
 */
abstract class Oops_Db_Propel_ImageType extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_ImageTypePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_ImageTypePeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_ImageType object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Db_ImageType The current object (for fluent API support)
	 */
	public function setIdImageType($v)
	{
		...
		if ($this->id_image_type !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ImageTypePeer::ID_IMAGE_TYPE;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = Oops_Db_ImageTypePeer::NAME;
		}
	...
	public function setWidth($v)
	{
		...
		if ($this->width !== $v) {
			$this->width = $v;
			$this->modifiedColumns[] = Oops_Db_ImageTypePeer::WIDTH;
		}
	...
	public function setHeight($v)
	{
		...
		if ($this->height !== $v) {
			$this->height = $v;
			$this->modifiedColumns[] = Oops_Db_ImageTypePeer::HEIGHT;
		}
	...
	public function setProducts($v)
	{
		...
		if ($this->products !== $v) {
			$this->products = $v;
			$this->modifiedColumns[] = Oops_Db_ImageTypePeer::PRODUCTS;
		}
	...
	public function setCategories($v)
	{
		...
		if ($this->categories !== $v) {
			$this->categories = $v;
			$this->modifiedColumns[] = Oops_Db_ImageTypePeer::CATEGORIES;
		}
	...
	public function setManufacturers($v)
	{
		...
		if ($this->manufacturers !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ImageTypePeer::MANUFACTURERS;
		}
	...
	public function setSuppliers($v)
	{
		...
		if ($this->suppliers !== $v) {
			$this->suppliers = $v;
			$this->modifiedColumns[] = Oops_Db_ImageTypePeer::SUPPLIERS;
		}
	...
	public function setScenes($v)
	{
		...
		if ($this->scenes !== $v) {
			$this->scenes = $v;
			$this->modifiedColumns[] = Oops_Db_ImageTypePeer::SCENES;
		}
	...
	public function setStores($v)
	{
		...
		if ($this->stores !== $v) {
			$this->stores = $v;
			$this->modifiedColumns[] = Oops_Db_ImageTypePeer::STORES;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 10; // 10 = Oops_Db_ImageTypePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_ImageType object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_ImageTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_ImageTypeQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_ImageTypePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::ID_IMAGE_TYPE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_IMAGE_TYPE`';
		}
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::NAME)) {
			$modifiedColumns[':p' . $index++]  = '`NAME`';
		}
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::WIDTH)) {
			$modifiedColumns[':p' . $index++]  = '`WIDTH`';
		}
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::HEIGHT)) {
			$modifiedColumns[':p' . $index++]  = '`HEIGHT`';
		}
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::PRODUCTS)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCTS`';
		}
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::CATEGORIES)) {
			$modifiedColumns[':p' . $index++]  = '`CATEGORIES`';
		}
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::MANUFACTURERS)) {
			$modifiedColumns[':p' . $index++]  = '`MANUFACTURERS`';
		}
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::SUPPLIERS)) {
			$modifiedColumns[':p' . $index++]  = '`SUPPLIERS`';
		}
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::SCENES)) {
			$modifiedColumns[':p' . $index++]  = '`SCENES`';
		}
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::STORES)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_ImageTypePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_ImageTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_ImageType'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_ImageType'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_ImageTypePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::ID_IMAGE_TYPE)) $criteria->add(Oops_Db_ImageTypePeer::ID_IMAGE_TYPE, $this->id_image_type);
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::NAME)) $criteria->add(Oops_Db_ImageTypePeer::NAME, $this->name);
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::WIDTH)) $criteria->add(Oops_Db_ImageTypePeer::WIDTH, $this->width);
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::HEIGHT)) $criteria->add(Oops_Db_ImageTypePeer::HEIGHT, $this->height);
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::PRODUCTS)) $criteria->add(Oops_Db_ImageTypePeer::PRODUCTS, $this->products);
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::CATEGORIES)) $criteria->add(Oops_Db_ImageTypePeer::CATEGORIES, $this->categories);
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::MANUFACTURERS)) $criteria->add(Oops_Db_ImageTypePeer::MANUFACTURERS, $this->manufacturers);
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::SUPPLIERS)) $criteria->add(Oops_Db_ImageTypePeer::SUPPLIERS, $this->suppliers);
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::SCENES)) $criteria->add(Oops_Db_ImageTypePeer::SCENES, $this->scenes);
		if ($this->isColumnModified(Oops_Db_ImageTypePeer::STORES)) $criteria->add(Oops_Db_ImageTypePeer::STORES, $this->stores);
	...
	{
		$criteria = new Criteria(Oops_Db_ImageTypePeer::DATABASE_NAME);
		$criteria->add(Oops_Db_ImageTypePeer::ID_IMAGE_TYPE, $this->id_image_type);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_ImageType (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_ImageType Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_ImageTypePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_ImageTypePeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_ImageTypePeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_ImageType
