 ...
 */
abstract class Oops_Db_Propel_Orders extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_OrdersPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_OrdersPeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_Orders object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Db_Orders The current object (for fluent API support)
	 */
	public function setIdOrder($v)
	{
		...
		if ($this->id_order !== $v) {
			$this->id_order = $v;
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::ID_ORDER;
		}
	...
	public function setIdCarrier($v)
	{
		...
		if ($this->id_carrier !== $v) {
			$this->id_carrier = $v;
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::ID_CARRIER;
		}
	...
	public function setIdLang($v)
	{
		...
		if ($this->id_lang !== $v) {
			$this->id_lang = $v;
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::ID_LANG;
		}
	...
	public function setIdCustomer($v)
	{
		...
		if ($this->id_customer !== $v) {
			$this->id_customer = $v;
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::ID_CUSTOMER;
		}
	...
	public function setIdCart($v)
	{
		...
		if ($this->id_cart !== $v) {
			$this->id_cart = $v;
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::ID_CART;
		}
	...
	public function setIdCurrency($v)
	{
		...
		if ($this->id_currency !== $v) {
			$this->id_currency = $v;
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::ID_CURRENCY;
		}
	...
	public function setIdAddressDelivery($v)
	{
		...
		if ($this->id_address_delivery !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::ID_ADDRESS_DELIVERY;
		}
	...
	public function setIdAddressInvoice($v)
	{
		...
		if ($this->id_address_invoice !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::ID_ADDRESS_INVOICE;
		}
	...
	public function setSecureKey($v)
	{
		...
		if ($this->secure_key !== $v) {
			$this->secure_key = $v;
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::SECURE_KEY;
		}
	...
	public function setPayment($v)
	{
		...
		if ($this->payment !== $v) {
			$this->payment = $v;
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::PAYMENT;
		}
	...
	public function setConversionRate($v)
	{
		...
		if ($this->conversion_rate !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::CONVERSION_RATE;
		}
	...
	public function setModule($v)
	{
		...
		if ($this->module !== $v) {
			$this->module = $v;
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::MODULE;
		}
	...
	public function setRecyclable($v)
	{
		...
		if ($this->recyclable !== $v) {
			$this->recyclable = $v;
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::RECYCLABLE;
		}
	...
	public function setGift($v)
	{
		...
		if ($this->gift !== $v) {
			$this->gift = $v;
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::GIFT;
		}
	...
	public function setGiftMessage($v)
	{
		...
		if ($this->gift_message !== $v) {
			$this->gift_message = $v;
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::GIFT_MESSAGE;
		}
	...
	public function setShippingNumber($v)
	{
		...
		if ($this->shipping_number !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::SHIPPING_NUMBER;
		}
	...
	public function setTotalDiscounts($v)
	{
		...
		if ($this->total_discounts !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::TOTAL_DISCOUNTS;
		}
	...
	public function setTotalPaid($v)
	{
		...
		if ($this->total_paid !== $v) {
			$this->total_paid = $v;
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::TOTAL_PAID;
		}
	...
	public function setTotalPaidReal($v)
	{
		...
		if ($this->total_paid_real !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::TOTAL_PAID_REAL;
		}
	...
	public function setTotalProducts($v)
	{
		...
		if ($this->total_products !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::TOTAL_PRODUCTS;
		}
	...
	public function setTotalProductsWt($v)
	{
		...
		if ($this->total_products_wt !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::TOTAL_PRODUCTS_WT;
		}
	...
	public function setTotalShipping($v)
	{
		...
		if ($this->total_shipping !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::TOTAL_SHIPPING;
		}
	...
	public function setCarrierTaxRate($v)
	{
		...
		if ($this->carrier_tax_rate !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::CARRIER_TAX_RATE;
		}
	...
	public function setTotalWrapping($v)
	{
		...
		if ($this->total_wrapping !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::TOTAL_WRAPPING;
		}
	...
	public function setInvoiceNumber($v)
	{
		...
		if ($this->invoice_number !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::INVOICE_NUMBER;
		}
	...
	public function setDeliveryNumber($v)
	{
		...
		if ($this->delivery_number !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::DELIVERY_NUMBER;
		}
	...
	public function setInvoiceDate($v)
	{
		...
		if ($this->invoice_date !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_OrdersPeer::INVOICE_DATE;
			}
	...
	public function setDeliveryDate($v)
	{
		...
		if ($this->delivery_date !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_OrdersPeer::DELIVERY_DATE;
			}
		} // if either are not null
	...
	public function setValid($v)
	{
		...
		if ($this->valid !== $v) {
			$this->valid = $v;
			$this->modifiedColumns[] = Oops_Db_OrdersPeer::VALID;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_OrdersPeer::DATE_ADD;
			}
		} // if either are not null
	...
	public function setDateUpd($v)
	{
		...
		if ($this->date_upd !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_OrdersPeer::DATE_UPD;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 31; // 31 = Oops_Db_OrdersPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_Orders object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_OrdersPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_OrdersQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_OrdersPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_ORDER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ORDER`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_CARRIER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CARRIER`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_LANG)) {
			$modifiedColumns[':p' . $index++]  = '`ID_LANG`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_CUSTOMER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CUSTOMER`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_CART)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CART`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_CURRENCY)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CURRENCY`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_ADDRESS_DELIVERY)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ADDRESS_DELIVERY`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_ADDRESS_INVOICE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ADDRESS_INVOICE`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::SECURE_KEY)) {
			$modifiedColumns[':p' . $index++]  = '`SECURE_KEY`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::PAYMENT)) {
			$modifiedColumns[':p' . $index++]  = '`PAYMENT`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::CONVERSION_RATE)) {
			$modifiedColumns[':p' . $index++]  = '`CONVERSION_RATE`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::MODULE)) {
			$modifiedColumns[':p' . $index++]  = '`MODULE`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::RECYCLABLE)) {
			$modifiedColumns[':p' . $index++]  = '`RECYCLABLE`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::GIFT)) {
			$modifiedColumns[':p' . $index++]  = '`GIFT`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::GIFT_MESSAGE)) {
			$modifiedColumns[':p' . $index++]  = '`GIFT_MESSAGE`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::SHIPPING_NUMBER)) {
			$modifiedColumns[':p' . $index++]  = '`SHIPPING_NUMBER`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::TOTAL_DISCOUNTS)) {
			$modifiedColumns[':p' . $index++]  = '`TOTAL_DISCOUNTS`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::TOTAL_PAID)) {
			$modifiedColumns[':p' . $index++]  = '`TOTAL_PAID`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::TOTAL_PAID_REAL)) {
			$modifiedColumns[':p' . $index++]  = '`TOTAL_PAID_REAL`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::TOTAL_PRODUCTS)) {
			$modifiedColumns[':p' . $index++]  = '`TOTAL_PRODUCTS`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::TOTAL_PRODUCTS_WT)) {
			$modifiedColumns[':p' . $index++]  = '`TOTAL_PRODUCTS_WT`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::TOTAL_SHIPPING)) {
			$modifiedColumns[':p' . $index++]  = '`TOTAL_SHIPPING`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::CARRIER_TAX_RATE)) {
			$modifiedColumns[':p' . $index++]  = '`CARRIER_TAX_RATE`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::TOTAL_WRAPPING)) {
			$modifiedColumns[':p' . $index++]  = '`TOTAL_WRAPPING`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::INVOICE_NUMBER)) {
			$modifiedColumns[':p' . $index++]  = '`INVOICE_NUMBER`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::DELIVERY_NUMBER)) {
			$modifiedColumns[':p' . $index++]  = '`DELIVERY_NUMBER`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::INVOICE_DATE)) {
			$modifiedColumns[':p' . $index++]  = '`INVOICE_DATE`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::DELIVERY_DATE)) {
			$modifiedColumns[':p' . $index++]  = '`DELIVERY_DATE`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::VALID)) {
			$modifiedColumns[':p' . $index++]  = '`VALID`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}
		if ($this->isColumnModified(Oops_Db_OrdersPeer::DATE_UPD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_UPD`';
		}

		$sql = sprintf(
			'INSERT INTO `' .  _DB_PREFIX_ . 'orders` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_OrdersPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_OrdersPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_Orders'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_Orders'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_OrdersPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_ORDER)) $criteria->add(Oops_Db_OrdersPeer::ID_ORDER, $this->id_order);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_CARRIER)) $criteria->add(Oops_Db_OrdersPeer::ID_CARRIER, $this->id_carrier);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_LANG)) $criteria->add(Oops_Db_OrdersPeer::ID_LANG, $this->id_lang);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_CUSTOMER)) $criteria->add(Oops_Db_OrdersPeer::ID_CUSTOMER, $this->id_customer);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_CART)) $criteria->add(Oops_Db_OrdersPeer::ID_CART, $this->id_cart);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_CURRENCY)) $criteria->add(Oops_Db_OrdersPeer::ID_CURRENCY, $this->id_currency);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_ADDRESS_DELIVERY)) $criteria->add(Oops_Db_OrdersPeer::ID_ADDRESS_DELIVERY, $this->id_address_delivery);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::ID_ADDRESS_INVOICE)) $criteria->add(Oops_Db_OrdersPeer::ID_ADDRESS_INVOICE, $this->id_address_invoice);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::SECURE_KEY)) $criteria->add(Oops_Db_OrdersPeer::SECURE_KEY, $this->secure_key);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::PAYMENT)) $criteria->add(Oops_Db_OrdersPeer::PAYMENT, $this->payment);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::CONVERSION_RATE)) $criteria->add(Oops_Db_OrdersPeer::CONVERSION_RATE, $this->conversion_rate);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::MODULE)) $criteria->add(Oops_Db_OrdersPeer::MODULE, $this->module);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::RECYCLABLE)) $criteria->add(Oops_Db_OrdersPeer::RECYCLABLE, $this->recyclable);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::GIFT)) $criteria->add(Oops_Db_OrdersPeer::GIFT, $this->gift);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::GIFT_MESSAGE)) $criteria->add(Oops_Db_OrdersPeer::GIFT_MESSAGE, $this->gift_message);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::SHIPPING_NUMBER)) $criteria->add(Oops_Db_OrdersPeer::SHIPPING_NUMBER, $this->shipping_number);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::TOTAL_DISCOUNTS)) $criteria->add(Oops_Db_OrdersPeer::TOTAL_DISCOUNTS, $this->total_discounts);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::TOTAL_PAID)) $criteria->add(Oops_Db_OrdersPeer::TOTAL_PAID, $this->total_paid);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::TOTAL_PAID_REAL)) $criteria->add(Oops_Db_OrdersPeer::TOTAL_PAID_REAL, $this->total_paid_real);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::TOTAL_PRODUCTS)) $criteria->add(Oops_Db_OrdersPeer::TOTAL_PRODUCTS, $this->total_products);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::TOTAL_PRODUCTS_WT)) $criteria->add(Oops_Db_OrdersPeer::TOTAL_PRODUCTS_WT, $this->total_products_wt);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::TOTAL_SHIPPING)) $criteria->add(Oops_Db_OrdersPeer::TOTAL_SHIPPING, $this->total_shipping);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::CARRIER_TAX_RATE)) $criteria->add(Oops_Db_OrdersPeer::CARRIER_TAX_RATE, $this->carrier_tax_rate);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::TOTAL_WRAPPING)) $criteria->add(Oops_Db_OrdersPeer::TOTAL_WRAPPING, $this->total_wrapping);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::INVOICE_NUMBER)) $criteria->add(Oops_Db_OrdersPeer::INVOICE_NUMBER, $this->invoice_number);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::DELIVERY_NUMBER)) $criteria->add(Oops_Db_OrdersPeer::DELIVERY_NUMBER, $this->delivery_number);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::INVOICE_DATE)) $criteria->add(Oops_Db_OrdersPeer::INVOICE_DATE, $this->invoice_date);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::DELIVERY_DATE)) $criteria->add(Oops_Db_OrdersPeer::DELIVERY_DATE, $this->delivery_date);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::VALID)) $criteria->add(Oops_Db_OrdersPeer::VALID, $this->valid);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::DATE_ADD)) $criteria->add(Oops_Db_OrdersPeer::DATE_ADD, $this->date_add);
		if ($this->isColumnModified(Oops_Db_OrdersPeer::DATE_UPD)) $criteria->add(Oops_Db_OrdersPeer::DATE_UPD, $this->date_upd);
	...
	{
		$criteria = new Criteria(Oops_Db_OrdersPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_OrdersPeer::ID_ORDER, $this->id_order);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_Orders (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_Orders Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_OrdersPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_OrdersPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_OrdersPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_Orders
