 ...
 */
abstract class Oops_Db_Propel_Customer extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_CustomerPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_CustomerPeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_Customer object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Db_Customer The current object (for fluent API support)
	 */
	public function setIdCustomer($v)
	{
		...
		if ($this->id_customer !== $v) {
			$this->id_customer = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::ID_CUSTOMER;
		}
	...
	public function setIdGender($v)
	{
		...
		if ($this->id_gender !== $v) {
			$this->id_gender = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::ID_GENDER;
		}
	...
	public function setIdDefaultGroup($v)
	{
		...
		if ($this->id_default_group !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::ID_DEFAULT_GROUP;
		}
	...
	public function setFirstname($v)
	{
		...
		if ($this->firstname !== $v) {
			$this->firstname = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::FIRSTNAME;
		}
	...
	public function setLastname($v)
	{
		...
		if ($this->lastname !== $v) {
			$this->lastname = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::LASTNAME;
		}
	...
	public function setEmail($v)
	{
		...
		if ($this->email !== $v) {
			$this->email = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::EMAIL;
		}
	...
	public function setPasswd($v)
	{
		...
		if ($this->passwd !== $v) {
			$this->passwd = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::PASSWD;
		}
	...
	public function setLastPasswdGen($v)
	{
		...
		if ($this->last_passwd_gen !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_CustomerPeer::LAST_PASSWD_GEN;
			}
	...
	public function setBirthday($v)
	{
		...
		if ($this->birthday !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_CustomerPeer::BIRTHDAY;
			}
		} // if either are not null
	...
	public function setNewsletter($v)
	{
		...
		if ($this->newsletter !== $v) {
			$this->newsletter = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::NEWSLETTER;
		}
	...
	public function setIpRegistrationNewsletter($v)
	{
		...
		if ($this->ip_registration_newsletter !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::IP_REGISTRATION_NEWSLETTER;
		}
	...
	public function setNewsletterDateAdd($v)
	{
		...
		if ($this->newsletter_date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_CustomerPeer::NEWSLETTER_DATE_ADD;
			}
		} // if either are not null
	...
	public function setOptin($v)
	{
		...
		if ($this->optin !== $v) {
			$this->optin = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::OPTIN;
		}
	...
	public function setSecureKey($v)
	{
		...
		if ($this->secure_key !== $v) {
			$this->secure_key = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::SECURE_KEY;
		}
	...
	public function setNote($v)
	{
		...
		if ($this->note !== $v) {
			$this->note = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::NOTE;
		}
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v) {
			$this->active = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::ACTIVE;
		}
	...
	public function setIsGuest($v)
	{
		...
		if ($this->is_guest !== $v) {
			$this->is_guest = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::IS_GUEST;
		}
	...
	public function setDeleted($v)
	{
		...
		if ($this->deleted !== $v) {
			$this->deleted = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerPeer::DELETED;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_CustomerPeer::DATE_ADD;
			}
		} // if either are not null
	...
	public function setDateUpd($v)
	{
		...
		if ($this->date_upd !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_CustomerPeer::DATE_UPD;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 20; // 20 = Oops_Db_CustomerPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_Customer object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_CustomerPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_CustomerQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_CustomerPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_CustomerPeer::ID_CUSTOMER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CUSTOMER`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::ID_GENDER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_GENDER`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::ID_DEFAULT_GROUP)) {
			$modifiedColumns[':p' . $index++]  = '`ID_DEFAULT_GROUP`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::FIRSTNAME)) {
			$modifiedColumns[':p' . $index++]  = '`FIRSTNAME`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::LASTNAME)) {
			$modifiedColumns[':p' . $index++]  = '`LASTNAME`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::EMAIL)) {
			$modifiedColumns[':p' . $index++]  = '`EMAIL`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::PASSWD)) {
			$modifiedColumns[':p' . $index++]  = '`PASSWD`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::LAST_PASSWD_GEN)) {
			$modifiedColumns[':p' . $index++]  = '`LAST_PASSWD_GEN`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::BIRTHDAY)) {
			$modifiedColumns[':p' . $index++]  = '`BIRTHDAY`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::NEWSLETTER)) {
			$modifiedColumns[':p' . $index++]  = '`NEWSLETTER`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::IP_REGISTRATION_NEWSLETTER)) {
			$modifiedColumns[':p' . $index++]  = '`IP_REGISTRATION_NEWSLETTER`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::NEWSLETTER_DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`NEWSLETTER_DATE_ADD`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::OPTIN)) {
			$modifiedColumns[':p' . $index++]  = '`OPTIN`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::SECURE_KEY)) {
			$modifiedColumns[':p' . $index++]  = '`SECURE_KEY`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::NOTE)) {
			$modifiedColumns[':p' . $index++]  = '`NOTE`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::ACTIVE)) {
			$modifiedColumns[':p' . $index++]  = '`ACTIVE`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::IS_GUEST)) {
			$modifiedColumns[':p' . $index++]  = '`IS_GUEST`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::DELETED)) {
			$modifiedColumns[':p' . $index++]  = '`DELETED`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerPeer::DATE_UPD)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_CustomerPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_CustomerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_Customer'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_Customer'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_CustomerPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_CustomerPeer::ID_CUSTOMER)) $criteria->add(Oops_Db_CustomerPeer::ID_CUSTOMER, $this->id_customer);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::ID_GENDER)) $criteria->add(Oops_Db_CustomerPeer::ID_GENDER, $this->id_gender);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::ID_DEFAULT_GROUP)) $criteria->add(Oops_Db_CustomerPeer::ID_DEFAULT_GROUP, $this->id_default_group);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::FIRSTNAME)) $criteria->add(Oops_Db_CustomerPeer::FIRSTNAME, $this->firstname);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::LASTNAME)) $criteria->add(Oops_Db_CustomerPeer::LASTNAME, $this->lastname);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::EMAIL)) $criteria->add(Oops_Db_CustomerPeer::EMAIL, $this->email);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::PASSWD)) $criteria->add(Oops_Db_CustomerPeer::PASSWD, $this->passwd);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::LAST_PASSWD_GEN)) $criteria->add(Oops_Db_CustomerPeer::LAST_PASSWD_GEN, $this->last_passwd_gen);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::BIRTHDAY)) $criteria->add(Oops_Db_CustomerPeer::BIRTHDAY, $this->birthday);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::NEWSLETTER)) $criteria->add(Oops_Db_CustomerPeer::NEWSLETTER, $this->newsletter);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::IP_REGISTRATION_NEWSLETTER)) $criteria->add(Oops_Db_CustomerPeer::IP_REGISTRATION_NEWSLETTER, $this->ip_registration_newsletter);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::NEWSLETTER_DATE_ADD)) $criteria->add(Oops_Db_CustomerPeer::NEWSLETTER_DATE_ADD, $this->newsletter_date_add);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::OPTIN)) $criteria->add(Oops_Db_CustomerPeer::OPTIN, $this->optin);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::SECURE_KEY)) $criteria->add(Oops_Db_CustomerPeer::SECURE_KEY, $this->secure_key);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::NOTE)) $criteria->add(Oops_Db_CustomerPeer::NOTE, $this->note);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::ACTIVE)) $criteria->add(Oops_Db_CustomerPeer::ACTIVE, $this->active);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::IS_GUEST)) $criteria->add(Oops_Db_CustomerPeer::IS_GUEST, $this->is_guest);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::DELETED)) $criteria->add(Oops_Db_CustomerPeer::DELETED, $this->deleted);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::DATE_ADD)) $criteria->add(Oops_Db_CustomerPeer::DATE_ADD, $this->date_add);
		if ($this->isColumnModified(Oops_Db_CustomerPeer::DATE_UPD)) $criteria->add(Oops_Db_CustomerPeer::DATE_UPD, $this->date_upd);
	...
	{
		$criteria = new Criteria(Oops_Db_CustomerPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_CustomerPeer::ID_CUSTOMER, $this->id_customer);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_Customer (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_Customer Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_CustomerPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_CustomerPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_CustomerPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_Customer
