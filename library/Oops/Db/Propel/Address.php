 ...
 */
abstract class Oops_Db_Propel_Address extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_AddressPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_AddressPeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_Address object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Db_Address The current object (for fluent API support)
	 */
	public function setIdAddress($v)
	{
		...
		if ($this->id_address !== $v) {
			$this->id_address = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::ID_ADDRESS;
		}
	...
	public function setIdCountry($v)
	{
		...
		if ($this->id_country !== $v) {
			$this->id_country = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::ID_COUNTRY;
		}
	...
	public function setIdState($v)
	{
		...
		if ($this->id_state !== $v) {
			$this->id_state = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::ID_STATE;
		}
	...
	public function setIdCustomer($v)
	{
		...
		if ($this->id_customer !== $v) {
			$this->id_customer = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::ID_CUSTOMER;
		}
	...
	public function setIdManufacturer($v)
	{
		...
		if ($this->id_manufacturer !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_AddressPeer::ID_MANUFACTURER;
		}
	...
	public function setIdSupplier($v)
	{
		...
		if ($this->id_supplier !== $v) {
			$this->id_supplier = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::ID_SUPPLIER;
		}
	...
	public function setAlias($v)
	{
		...
		if ($this->alias !== $v) {
			$this->alias = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::ALIAS;
		}
	...
	public function setCompany($v)
	{
		...
		if ($this->company !== $v) {
			$this->company = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::COMPANY;
		}
	...
	public function setLastname($v)
	{
		...
		if ($this->lastname !== $v) {
			$this->lastname = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::LASTNAME;
		}
	...
	public function setFirstname($v)
	{
		...
		if ($this->firstname !== $v) {
			$this->firstname = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::FIRSTNAME;
		}
	...
	public function setAddress1($v)
	{
		...
		if ($this->address1 !== $v) {
			$this->address1 = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::ADDRESS1;
		}
	...
	public function setAddress2($v)
	{
		...
		if ($this->address2 !== $v) {
			$this->address2 = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::ADDRESS2;
		}
	...
	public function setPostcode($v)
	{
		...
		if ($this->postcode !== $v) {
			$this->postcode = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::POSTCODE;
		}
	...
	public function setCity($v)
	{
		...
		if ($this->city !== $v) {
			$this->city = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::CITY;
		}
	...
	public function setOther($v)
	{
		...
		if ($this->other !== $v) {
			$this->other = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::OTHER;
		}
	...
	public function setPhone($v)
	{
		...
		if ($this->phone !== $v) {
			$this->phone = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::PHONE;
		}
	...
	public function setPhoneMobile($v)
	{
		...
		if ($this->phone_mobile !== $v) {
			$this->phone_mobile = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::PHONE_MOBILE;
		}
	...
	public function setVatNumber($v)
	{
		...
		if ($this->vat_number !== $v) {
			$this->vat_number = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::VAT_NUMBER;
		}
	...
	public function setDni($v)
	{
		...
		if ($this->dni !== $v) {
			$this->dni = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::DNI;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_AddressPeer::DATE_ADD;
			}
	...
	public function setDateUpd($v)
	{
		...
		if ($this->date_upd !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_AddressPeer::DATE_UPD;
			}
		} // if either are not null
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v) {
			$this->active = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::ACTIVE;
		}
	...
	public function setDeleted($v)
	{
		...
		if ($this->deleted !== $v) {
			$this->deleted = $v;
			$this->modifiedColumns[] = Oops_Db_AddressPeer::DELETED;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 23; // 23 = Oops_Db_AddressPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_Address object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_AddressPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_AddressQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_AddressPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_AddressPeer::ID_ADDRESS)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ADDRESS`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::ID_COUNTRY)) {
			$modifiedColumns[':p' . $index++]  = '`ID_COUNTRY`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::ID_STATE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_STATE`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::ID_CUSTOMER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CUSTOMER`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::ID_MANUFACTURER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_MANUFACTURER`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::ID_SUPPLIER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_SUPPLIER`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::ALIAS)) {
			$modifiedColumns[':p' . $index++]  = '`ALIAS`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::COMPANY)) {
			$modifiedColumns[':p' . $index++]  = '`COMPANY`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::LASTNAME)) {
			$modifiedColumns[':p' . $index++]  = '`LASTNAME`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::FIRSTNAME)) {
			$modifiedColumns[':p' . $index++]  = '`FIRSTNAME`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::ADDRESS1)) {
			$modifiedColumns[':p' . $index++]  = '`ADDRESS1`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::ADDRESS2)) {
			$modifiedColumns[':p' . $index++]  = '`ADDRESS2`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::POSTCODE)) {
			$modifiedColumns[':p' . $index++]  = '`POSTCODE`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::CITY)) {
			$modifiedColumns[':p' . $index++]  = '`CITY`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::OTHER)) {
			$modifiedColumns[':p' . $index++]  = '`OTHER`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::PHONE)) {
			$modifiedColumns[':p' . $index++]  = '`PHONE`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::PHONE_MOBILE)) {
			$modifiedColumns[':p' . $index++]  = '`PHONE_MOBILE`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::VAT_NUMBER)) {
			$modifiedColumns[':p' . $index++]  = '`VAT_NUMBER`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::DNI)) {
			$modifiedColumns[':p' . $index++]  = '`DNI`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::DATE_UPD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_UPD`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::ACTIVE)) {
			$modifiedColumns[':p' . $index++]  = '`ACTIVE`';
		}
		if ($this->isColumnModified(Oops_Db_AddressPeer::DELETED)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_AddressPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_AddressPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_Address'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_Address'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_AddressPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_AddressPeer::ID_ADDRESS)) $criteria->add(Oops_Db_AddressPeer::ID_ADDRESS, $this->id_address);
		if ($this->isColumnModified(Oops_Db_AddressPeer::ID_COUNTRY)) $criteria->add(Oops_Db_AddressPeer::ID_COUNTRY, $this->id_country);
		if ($this->isColumnModified(Oops_Db_AddressPeer::ID_STATE)) $criteria->add(Oops_Db_AddressPeer::ID_STATE, $this->id_state);
		if ($this->isColumnModified(Oops_Db_AddressPeer::ID_CUSTOMER)) $criteria->add(Oops_Db_AddressPeer::ID_CUSTOMER, $this->id_customer);
		if ($this->isColumnModified(Oops_Db_AddressPeer::ID_MANUFACTURER)) $criteria->add(Oops_Db_AddressPeer::ID_MANUFACTURER, $this->id_manufacturer);
		if ($this->isColumnModified(Oops_Db_AddressPeer::ID_SUPPLIER)) $criteria->add(Oops_Db_AddressPeer::ID_SUPPLIER, $this->id_supplier);
		if ($this->isColumnModified(Oops_Db_AddressPeer::ALIAS)) $criteria->add(Oops_Db_AddressPeer::ALIAS, $this->alias);
		if ($this->isColumnModified(Oops_Db_AddressPeer::COMPANY)) $criteria->add(Oops_Db_AddressPeer::COMPANY, $this->company);
		if ($this->isColumnModified(Oops_Db_AddressPeer::LASTNAME)) $criteria->add(Oops_Db_AddressPeer::LASTNAME, $this->lastname);
		if ($this->isColumnModified(Oops_Db_AddressPeer::FIRSTNAME)) $criteria->add(Oops_Db_AddressPeer::FIRSTNAME, $this->firstname);
		if ($this->isColumnModified(Oops_Db_AddressPeer::ADDRESS1)) $criteria->add(Oops_Db_AddressPeer::ADDRESS1, $this->address1);
		if ($this->isColumnModified(Oops_Db_AddressPeer::ADDRESS2)) $criteria->add(Oops_Db_AddressPeer::ADDRESS2, $this->address2);
		if ($this->isColumnModified(Oops_Db_AddressPeer::POSTCODE)) $criteria->add(Oops_Db_AddressPeer::POSTCODE, $this->postcode);
		if ($this->isColumnModified(Oops_Db_AddressPeer::CITY)) $criteria->add(Oops_Db_AddressPeer::CITY, $this->city);
		if ($this->isColumnModified(Oops_Db_AddressPeer::OTHER)) $criteria->add(Oops_Db_AddressPeer::OTHER, $this->other);
		if ($this->isColumnModified(Oops_Db_AddressPeer::PHONE)) $criteria->add(Oops_Db_AddressPeer::PHONE, $this->phone);
		if ($this->isColumnModified(Oops_Db_AddressPeer::PHONE_MOBILE)) $criteria->add(Oops_Db_AddressPeer::PHONE_MOBILE, $this->phone_mobile);
		if ($this->isColumnModified(Oops_Db_AddressPeer::VAT_NUMBER)) $criteria->add(Oops_Db_AddressPeer::VAT_NUMBER, $this->vat_number);
		if ($this->isColumnModified(Oops_Db_AddressPeer::DNI)) $criteria->add(Oops_Db_AddressPeer::DNI, $this->dni);
		if ($this->isColumnModified(Oops_Db_AddressPeer::DATE_ADD)) $criteria->add(Oops_Db_AddressPeer::DATE_ADD, $this->date_add);
		if ($this->isColumnModified(Oops_Db_AddressPeer::DATE_UPD)) $criteria->add(Oops_Db_AddressPeer::DATE_UPD, $this->date_upd);
		if ($this->isColumnModified(Oops_Db_AddressPeer::ACTIVE)) $criteria->add(Oops_Db_AddressPeer::ACTIVE, $this->active);
		if ($this->isColumnModified(Oops_Db_AddressPeer::DELETED)) $criteria->add(Oops_Db_AddressPeer::DELETED, $this->deleted);
	...
	{
		$criteria = new Criteria(Oops_Db_AddressPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_AddressPeer::ID_ADDRESS, $this->id_address);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_Address (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_Address Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_AddressPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_AddressPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_AddressPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_Address
