 ...
 */
abstract class Oops_Db_Propel_ProductSale extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_ProductSalePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_ProductSalePeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_ProductSale object.
	 * @see        applyDefaults()
	 */
	...
	public function setQuantity($v)
	{
		...
		if ($this->quantity !== $v) {
			$this->quantity = $v;
			$this->modifiedColumns[] = Oops_Db_ProductSalePeer::QUANTITY;
		}
	...
	public function setSaleNbr($v)
	{
		...
		if ($this->sale_nbr !== $v) {
			$this->sale_nbr = $v;
			$this->modifiedColumns[] = Oops_Db_ProductSalePeer::SALE_NBR;
		}
	...
	public function setDateUpd($v)
	{
		...
		if ($this->date_upd !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_ProductSalePeer::DATE_UPD;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = Oops_Db_ProductSalePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_ProductSale object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_ProductSalePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_ProductSaleQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_ProductSalePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_ProductSalePeer::ID_PRODUCT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PRODUCT`';
		}
		if ($this->isColumnModified(Oops_Db_ProductSalePeer::QUANTITY)) {
			$modifiedColumns[':p' . $index++]  = '`QUANTITY`';
		}
		if ($this->isColumnModified(Oops_Db_ProductSalePeer::SALE_NBR)) {
			$modifiedColumns[':p' . $index++]  = '`SALE_NBR`';
		}
		if ($this->isColumnModified(Oops_Db_ProductSalePeer::DATE_UPD)) {
	...
	{
		$pos = Oops_Db_ProductSalePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
	{
		...
		$alreadyDumpedObjects['Oops_Db_ProductSale'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_ProductSalePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_ProductSalePeer::ID_PRODUCT)) $criteria->add(Oops_Db_ProductSalePeer::ID_PRODUCT, $this->id_product);
		if ($this->isColumnModified(Oops_Db_ProductSalePeer::QUANTITY)) $criteria->add(Oops_Db_ProductSalePeer::QUANTITY, $this->quantity);
		if ($this->isColumnModified(Oops_Db_ProductSalePeer::SALE_NBR)) $criteria->add(Oops_Db_ProductSalePeer::SALE_NBR, $this->sale_nbr);
		if ($this->isColumnModified(Oops_Db_ProductSalePeer::DATE_UPD)) $criteria->add(Oops_Db_ProductSalePeer::DATE_UPD, $this->date_upd);
	...
	{
		$criteria = new Criteria(Oops_Db_ProductSalePeer::DATABASE_NAME);
		$criteria->add(Oops_Db_ProductSalePeer::ID_PRODUCT, $this->id_product);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_ProductSale (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_ProductSale Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_ProductSalePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_ProductSalePeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_ProductSalePeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_ProductSale
