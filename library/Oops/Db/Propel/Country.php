 ...
 */
abstract class Oops_Db_Propel_Country extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_CountryPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_CountryPeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_Country object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Db_Country The current object (for fluent API support)
	 */
	public function setIdCountry($v)
	{
		...
		if ($this->id_country !== $v) {
			$this->id_country = $v;
			$this->modifiedColumns[] = Oops_Db_CountryPeer::ID_COUNTRY;
		}
	...
	public function setIdZone($v)
	{
		...
		if ($this->id_zone !== $v) {
			$this->id_zone = $v;
			$this->modifiedColumns[] = Oops_Db_CountryPeer::ID_ZONE;
		}
	...
	public function setIdCurrency($v)
	{
		...
		if ($this->id_currency !== $v) {
			$this->id_currency = $v;
			$this->modifiedColumns[] = Oops_Db_CountryPeer::ID_CURRENCY;
		}
	...
	public function setIsoCode($v)
	{
		...
		if ($this->iso_code !== $v) {
			$this->iso_code = $v;
			$this->modifiedColumns[] = Oops_Db_CountryPeer::ISO_CODE;
		}
	...
	public function setCallPrefix($v)
	{
		...
		if ($this->call_prefix !== $v) {
			$this->call_prefix = $v;
			$this->modifiedColumns[] = Oops_Db_CountryPeer::CALL_PREFIX;
		}
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v) {
			$this->active = $v;
			$this->modifiedColumns[] = Oops_Db_CountryPeer::ACTIVE;
		}
	...
	public function setContainsStates($v)
	{
		...
		if ($this->contains_states !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CountryPeer::CONTAINS_STATES;
		}
	...
	public function setNeedIdentificationNumber($v)
	{
		...
		if ($this->need_identification_number !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CountryPeer::NEED_IDENTIFICATION_NUMBER;
		}
	...
	public function setNeedZipCode($v)
	{
		...
		if ($this->need_zip_code !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CountryPeer::NEED_ZIP_CODE;
		}
	...
	public function setZipCodeFormat($v)
	{
		...
		if ($this->zip_code_format !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CountryPeer::ZIP_CODE_FORMAT;
		}
	...
	public function setDisplayTaxLabel($v)
	{
		...
		if ($this->display_tax_label !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CountryPeer::DISPLAY_TAX_LABEL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 11; // 11 = Oops_Db_CountryPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_Country object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_CountryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_CountryQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_CountryPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_CountryPeer::ID_COUNTRY)) {
			$modifiedColumns[':p' . $index++]  = '`ID_COUNTRY`';
		}
		if ($this->isColumnModified(Oops_Db_CountryPeer::ID_ZONE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ZONE`';
		}
		if ($this->isColumnModified(Oops_Db_CountryPeer::ID_CURRENCY)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CURRENCY`';
		}
		if ($this->isColumnModified(Oops_Db_CountryPeer::ISO_CODE)) {
			$modifiedColumns[':p' . $index++]  = '`ISO_CODE`';
		}
		if ($this->isColumnModified(Oops_Db_CountryPeer::CALL_PREFIX)) {
			$modifiedColumns[':p' . $index++]  = '`CALL_PREFIX`';
		}
		if ($this->isColumnModified(Oops_Db_CountryPeer::ACTIVE)) {
			$modifiedColumns[':p' . $index++]  = '`ACTIVE`';
		}
		if ($this->isColumnModified(Oops_Db_CountryPeer::CONTAINS_STATES)) {
			$modifiedColumns[':p' . $index++]  = '`CONTAINS_STATES`';
		}
		if ($this->isColumnModified(Oops_Db_CountryPeer::NEED_IDENTIFICATION_NUMBER)) {
			$modifiedColumns[':p' . $index++]  = '`NEED_IDENTIFICATION_NUMBER`';
		}
		if ($this->isColumnModified(Oops_Db_CountryPeer::NEED_ZIP_CODE)) {
			$modifiedColumns[':p' . $index++]  = '`NEED_ZIP_CODE`';
		}
		if ($this->isColumnModified(Oops_Db_CountryPeer::ZIP_CODE_FORMAT)) {
			$modifiedColumns[':p' . $index++]  = '`ZIP_CODE_FORMAT`';
		}
		if ($this->isColumnModified(Oops_Db_CountryPeer::DISPLAY_TAX_LABEL)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_CountryPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_CountryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_Country'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_Country'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_CountryPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_CountryPeer::ID_COUNTRY)) $criteria->add(Oops_Db_CountryPeer::ID_COUNTRY, $this->id_country);
		if ($this->isColumnModified(Oops_Db_CountryPeer::ID_ZONE)) $criteria->add(Oops_Db_CountryPeer::ID_ZONE, $this->id_zone);
		if ($this->isColumnModified(Oops_Db_CountryPeer::ID_CURRENCY)) $criteria->add(Oops_Db_CountryPeer::ID_CURRENCY, $this->id_currency);
		if ($this->isColumnModified(Oops_Db_CountryPeer::ISO_CODE)) $criteria->add(Oops_Db_CountryPeer::ISO_CODE, $this->iso_code);
		if ($this->isColumnModified(Oops_Db_CountryPeer::CALL_PREFIX)) $criteria->add(Oops_Db_CountryPeer::CALL_PREFIX, $this->call_prefix);
		if ($this->isColumnModified(Oops_Db_CountryPeer::ACTIVE)) $criteria->add(Oops_Db_CountryPeer::ACTIVE, $this->active);
		if ($this->isColumnModified(Oops_Db_CountryPeer::CONTAINS_STATES)) $criteria->add(Oops_Db_CountryPeer::CONTAINS_STATES, $this->contains_states);
		if ($this->isColumnModified(Oops_Db_CountryPeer::NEED_IDENTIFICATION_NUMBER)) $criteria->add(Oops_Db_CountryPeer::NEED_IDENTIFICATION_NUMBER, $this->need_identification_number);
		if ($this->isColumnModified(Oops_Db_CountryPeer::NEED_ZIP_CODE)) $criteria->add(Oops_Db_CountryPeer::NEED_ZIP_CODE, $this->need_zip_code);
		if ($this->isColumnModified(Oops_Db_CountryPeer::ZIP_CODE_FORMAT)) $criteria->add(Oops_Db_CountryPeer::ZIP_CODE_FORMAT, $this->zip_code_format);
		if ($this->isColumnModified(Oops_Db_CountryPeer::DISPLAY_TAX_LABEL)) $criteria->add(Oops_Db_CountryPeer::DISPLAY_TAX_LABEL, $this->display_tax_label);
	...
	{
		$criteria = new Criteria(Oops_Db_CountryPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_CountryPeer::ID_COUNTRY, $this->id_country);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_Country (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_Country Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_CountryPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_CountryPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_CountryPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_Country
