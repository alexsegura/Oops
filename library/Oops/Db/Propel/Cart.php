 ...
 */
abstract class Oops_Db_Propel_Cart extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_CartPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_CartPeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_Cart object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Db_Cart The current object (for fluent API support)
	 */
	public function setIdCart($v)
	{
		...
		if ($this->id_cart !== $v) {
			$this->id_cart = $v;
			$this->modifiedColumns[] = Oops_Db_CartPeer::ID_CART;
		}
	...
	public function setIdCarrier($v)
	{
		...
		if ($this->id_carrier !== $v) {
			$this->id_carrier = $v;
			$this->modifiedColumns[] = Oops_Db_CartPeer::ID_CARRIER;
		}
	...
	public function setIdLang($v)
	{
		...
		if ($this->id_lang !== $v) {
			$this->id_lang = $v;
			$this->modifiedColumns[] = Oops_Db_CartPeer::ID_LANG;
		}
	...
	public function setIdAddressDelivery($v)
	{
		...
		if ($this->id_address_delivery !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CartPeer::ID_ADDRESS_DELIVERY;
		}
	...
	public function setIdAddressInvoice($v)
	{
		...
		if ($this->id_address_invoice !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CartPeer::ID_ADDRESS_INVOICE;
		}
	...
	public function setIdCurrency($v)
	{
		...
		if ($this->id_currency !== $v) {
			$this->id_currency = $v;
			$this->modifiedColumns[] = Oops_Db_CartPeer::ID_CURRENCY;
		}
	...
	public function setIdCustomer($v)
	{
		...
		if ($this->id_customer !== $v) {
			$this->id_customer = $v;
			$this->modifiedColumns[] = Oops_Db_CartPeer::ID_CUSTOMER;
		}
	...
	public function setIdGuest($v)
	{
		...
		if ($this->id_guest !== $v) {
			$this->id_guest = $v;
			$this->modifiedColumns[] = Oops_Db_CartPeer::ID_GUEST;
		}
	...
	public function setSecureKey($v)
	{
		...
		if ($this->secure_key !== $v) {
			$this->secure_key = $v;
			$this->modifiedColumns[] = Oops_Db_CartPeer::SECURE_KEY;
		}
	...
	public function setRecyclable($v)
	{
		...
		if ($this->recyclable !== $v) {
			$this->recyclable = $v;
			$this->modifiedColumns[] = Oops_Db_CartPeer::RECYCLABLE;
		}
	...
	public function setGift($v)
	{
		...
		if ($this->gift !== $v) {
			$this->gift = $v;
			$this->modifiedColumns[] = Oops_Db_CartPeer::GIFT;
		}
	...
	public function setGiftMessage($v)
	{
		...
		if ($this->gift_message !== $v) {
			$this->gift_message = $v;
			$this->modifiedColumns[] = Oops_Db_CartPeer::GIFT_MESSAGE;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_CartPeer::DATE_ADD;
			}
	...
	public function setDateUpd($v)
	{
		...
		if ($this->date_upd !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_CartPeer::DATE_UPD;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 14; // 14 = Oops_Db_CartPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_Cart object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_CartPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_CartQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_CartPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_CART)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CART`';
		}
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_CARRIER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CARRIER`';
		}
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_LANG)) {
			$modifiedColumns[':p' . $index++]  = '`ID_LANG`';
		}
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_ADDRESS_DELIVERY)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ADDRESS_DELIVERY`';
		}
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_ADDRESS_INVOICE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ADDRESS_INVOICE`';
		}
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_CURRENCY)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CURRENCY`';
		}
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_CUSTOMER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CUSTOMER`';
		}
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_GUEST)) {
			$modifiedColumns[':p' . $index++]  = '`ID_GUEST`';
		}
		if ($this->isColumnModified(Oops_Db_CartPeer::SECURE_KEY)) {
			$modifiedColumns[':p' . $index++]  = '`SECURE_KEY`';
		}
		if ($this->isColumnModified(Oops_Db_CartPeer::RECYCLABLE)) {
			$modifiedColumns[':p' . $index++]  = '`RECYCLABLE`';
		}
		if ($this->isColumnModified(Oops_Db_CartPeer::GIFT)) {
			$modifiedColumns[':p' . $index++]  = '`GIFT`';
		}
		if ($this->isColumnModified(Oops_Db_CartPeer::GIFT_MESSAGE)) {
			$modifiedColumns[':p' . $index++]  = '`GIFT_MESSAGE`';
		}
		if ($this->isColumnModified(Oops_Db_CartPeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}
		if ($this->isColumnModified(Oops_Db_CartPeer::DATE_UPD)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_CartPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_CartPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_Cart'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_Cart'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_CartPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_CART)) $criteria->add(Oops_Db_CartPeer::ID_CART, $this->id_cart);
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_CARRIER)) $criteria->add(Oops_Db_CartPeer::ID_CARRIER, $this->id_carrier);
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_LANG)) $criteria->add(Oops_Db_CartPeer::ID_LANG, $this->id_lang);
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_ADDRESS_DELIVERY)) $criteria->add(Oops_Db_CartPeer::ID_ADDRESS_DELIVERY, $this->id_address_delivery);
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_ADDRESS_INVOICE)) $criteria->add(Oops_Db_CartPeer::ID_ADDRESS_INVOICE, $this->id_address_invoice);
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_CURRENCY)) $criteria->add(Oops_Db_CartPeer::ID_CURRENCY, $this->id_currency);
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_CUSTOMER)) $criteria->add(Oops_Db_CartPeer::ID_CUSTOMER, $this->id_customer);
		if ($this->isColumnModified(Oops_Db_CartPeer::ID_GUEST)) $criteria->add(Oops_Db_CartPeer::ID_GUEST, $this->id_guest);
		if ($this->isColumnModified(Oops_Db_CartPeer::SECURE_KEY)) $criteria->add(Oops_Db_CartPeer::SECURE_KEY, $this->secure_key);
		if ($this->isColumnModified(Oops_Db_CartPeer::RECYCLABLE)) $criteria->add(Oops_Db_CartPeer::RECYCLABLE, $this->recyclable);
		if ($this->isColumnModified(Oops_Db_CartPeer::GIFT)) $criteria->add(Oops_Db_CartPeer::GIFT, $this->gift);
		if ($this->isColumnModified(Oops_Db_CartPeer::GIFT_MESSAGE)) $criteria->add(Oops_Db_CartPeer::GIFT_MESSAGE, $this->gift_message);
		if ($this->isColumnModified(Oops_Db_CartPeer::DATE_ADD)) $criteria->add(Oops_Db_CartPeer::DATE_ADD, $this->date_add);
		if ($this->isColumnModified(Oops_Db_CartPeer::DATE_UPD)) $criteria->add(Oops_Db_CartPeer::DATE_UPD, $this->date_upd);
	...
	{
		$criteria = new Criteria(Oops_Db_CartPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_CartPeer::ID_CART, $this->id_cart);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_Cart (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_Cart Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_CartPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_CartPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_CartPeer::DEFAULT_STRING_FORMAT);
	}
