 ...
 */
abstract class Oops_Db_Propel_ProductAttachment extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_ProductAttachmentPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_ProductAttachmentPeer
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = Oops_Db_ProductAttachmentPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_ProductAttachment object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_ProductAttachmentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_ProductAttachmentQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_ProductAttachmentPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_ProductAttachmentPeer::ID_PRODUCT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PRODUCT`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttachmentPeer::ID_ATTACHMENT)) {
	...
	{
		$pos = Oops_Db_ProductAttachmentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
	{
		...
		$alreadyDumpedObjects['Oops_Db_ProductAttachment'][serialize($this->getPrimaryKey())] = true;
		$keys = Oops_Db_ProductAttachmentPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_ProductAttachmentPeer::ID_PRODUCT)) $criteria->add(Oops_Db_ProductAttachmentPeer::ID_PRODUCT, $this->id_product);
		if ($this->isColumnModified(Oops_Db_ProductAttachmentPeer::ID_ATTACHMENT)) $criteria->add(Oops_Db_ProductAttachmentPeer::ID_ATTACHMENT, $this->id_attachment);
	...
	{
		$criteria = new Criteria(Oops_Db_ProductAttachmentPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_ProductAttachmentPeer::ID_PRODUCT, $this->id_product);
		$criteria->add(Oops_Db_ProductAttachmentPeer::ID_ATTACHMENT, $this->id_attachment);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_ProductAttachment (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_ProductAttachment Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_ProductAttachmentPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_ProductAttachmentPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_ProductAttachmentPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_ProductAttachment
