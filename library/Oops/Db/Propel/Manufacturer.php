 ...
 */
abstract class Oops_Db_Propel_Manufacturer extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_ManufacturerPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_ManufacturerPeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_Manufacturer object.
	 * @see        applyDefaults()
	 */
	...
	public function setIdManufacturer($v)
	{
		...
		if ($this->id_manufacturer !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ManufacturerPeer::ID_MANUFACTURER;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = Oops_Db_ManufacturerPeer::NAME;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_ManufacturerPeer::DATE_ADD;
			}
	...
	public function setDateUpd($v)
	{
		...
		if ($this->date_upd !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_ManufacturerPeer::DATE_UPD;
			}
		} // if either are not null
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v) {
			$this->active = $v;
			$this->modifiedColumns[] = Oops_Db_ManufacturerPeer::ACTIVE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = Oops_Db_ManufacturerPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_Manufacturer object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_ManufacturerPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_ManufacturerQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_ManufacturerPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_ManufacturerPeer::ID_MANUFACTURER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_MANUFACTURER`';
		}
		if ($this->isColumnModified(Oops_Db_ManufacturerPeer::NAME)) {
			$modifiedColumns[':p' . $index++]  = '`NAME`';
		}
		if ($this->isColumnModified(Oops_Db_ManufacturerPeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}
		if ($this->isColumnModified(Oops_Db_ManufacturerPeer::DATE_UPD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_UPD`';
		}
		if ($this->isColumnModified(Oops_Db_ManufacturerPeer::ACTIVE)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_ManufacturerPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_ManufacturerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
	{
		...
		$alreadyDumpedObjects['Oops_Db_Manufacturer'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_ManufacturerPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_ManufacturerPeer::ID_MANUFACTURER)) $criteria->add(Oops_Db_ManufacturerPeer::ID_MANUFACTURER, $this->id_manufacturer);
		if ($this->isColumnModified(Oops_Db_ManufacturerPeer::NAME)) $criteria->add(Oops_Db_ManufacturerPeer::NAME, $this->name);
		if ($this->isColumnModified(Oops_Db_ManufacturerPeer::DATE_ADD)) $criteria->add(Oops_Db_ManufacturerPeer::DATE_ADD, $this->date_add);
		if ($this->isColumnModified(Oops_Db_ManufacturerPeer::DATE_UPD)) $criteria->add(Oops_Db_ManufacturerPeer::DATE_UPD, $this->date_upd);
		if ($this->isColumnModified(Oops_Db_ManufacturerPeer::ACTIVE)) $criteria->add(Oops_Db_ManufacturerPeer::ACTIVE, $this->active);
	...
	{
		$criteria = new Criteria(Oops_Db_ManufacturerPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_ManufacturerPeer::ID_MANUFACTURER, $this->id_manufacturer);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_Manufacturer (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_Manufacturer Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_ManufacturerPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_ManufacturerPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_ManufacturerPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_Manufacturer
