 ...
 */
abstract class Oops_Db_Propel_TaxRule extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_TaxRulePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_TaxRulePeer
	 */
	 ...
	 * @return     Oops_Db_TaxRule The current object (for fluent API support)
	 */
	public function setIdTaxRule($v)
	{
		...
		if ($this->id_tax_rule !== $v) {
			$this->id_tax_rule = $v;
			$this->modifiedColumns[] = Oops_Db_TaxRulePeer::ID_TAX_RULE;
		}
	...
	public function setIdTaxRulesGroup($v)
	{
		...
		if ($this->id_tax_rules_group !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_TaxRulePeer::ID_TAX_RULES_GROUP;
		}
	...
	public function setIdCountry($v)
	{
		...
		if ($this->id_country !== $v) {
			$this->id_country = $v;
			$this->modifiedColumns[] = Oops_Db_TaxRulePeer::ID_COUNTRY;
		}
	...
	public function setIdState($v)
	{
		...
		if ($this->id_state !== $v) {
			$this->id_state = $v;
			$this->modifiedColumns[] = Oops_Db_TaxRulePeer::ID_STATE;
		}
	...
	public function setIdCounty($v)
	{
		...
		if ($this->id_county !== $v) {
			$this->id_county = $v;
			$this->modifiedColumns[] = Oops_Db_TaxRulePeer::ID_COUNTY;
		}
	...
	public function setIdTax($v)
	{
		...
		if ($this->id_tax !== $v) {
			$this->id_tax = $v;
			$this->modifiedColumns[] = Oops_Db_TaxRulePeer::ID_TAX;
		}
	...
	public function setStateBehavior($v)
	{
		...
		if ($this->state_behavior !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_TaxRulePeer::STATE_BEHAVIOR;
		}
	...
	public function setCountyBehavior($v)
	{
		...
		if ($this->county_behavior !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_TaxRulePeer::COUNTY_BEHAVIOR;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = Oops_Db_TaxRulePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_TaxRule object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_TaxRulePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_TaxRuleQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_TaxRulePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::ID_TAX_RULE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_TAX_RULE`';
		}
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::ID_TAX_RULES_GROUP)) {
			$modifiedColumns[':p' . $index++]  = '`ID_TAX_RULES_GROUP`';
		}
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::ID_COUNTRY)) {
			$modifiedColumns[':p' . $index++]  = '`ID_COUNTRY`';
		}
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::ID_STATE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_STATE`';
		}
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::ID_COUNTY)) {
			$modifiedColumns[':p' . $index++]  = '`ID_COUNTY`';
		}
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::ID_TAX)) {
			$modifiedColumns[':p' . $index++]  = '`ID_TAX`';
		}
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::STATE_BEHAVIOR)) {
			$modifiedColumns[':p' . $index++]  = '`STATE_BEHAVIOR`';
		}
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::COUNTY_BEHAVIOR)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_TaxRulePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_TaxRulePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_TaxRule'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_TaxRule'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_TaxRulePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::ID_TAX_RULE)) $criteria->add(Oops_Db_TaxRulePeer::ID_TAX_RULE, $this->id_tax_rule);
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::ID_TAX_RULES_GROUP)) $criteria->add(Oops_Db_TaxRulePeer::ID_TAX_RULES_GROUP, $this->id_tax_rules_group);
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::ID_COUNTRY)) $criteria->add(Oops_Db_TaxRulePeer::ID_COUNTRY, $this->id_country);
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::ID_STATE)) $criteria->add(Oops_Db_TaxRulePeer::ID_STATE, $this->id_state);
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::ID_COUNTY)) $criteria->add(Oops_Db_TaxRulePeer::ID_COUNTY, $this->id_county);
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::ID_TAX)) $criteria->add(Oops_Db_TaxRulePeer::ID_TAX, $this->id_tax);
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::STATE_BEHAVIOR)) $criteria->add(Oops_Db_TaxRulePeer::STATE_BEHAVIOR, $this->state_behavior);
		if ($this->isColumnModified(Oops_Db_TaxRulePeer::COUNTY_BEHAVIOR)) $criteria->add(Oops_Db_TaxRulePeer::COUNTY_BEHAVIOR, $this->county_behavior);
	...
	{
		$criteria = new Criteria(Oops_Db_TaxRulePeer::DATABASE_NAME);
		$criteria->add(Oops_Db_TaxRulePeer::ID_TAX_RULE, $this->id_tax_rule);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_TaxRule (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_TaxRule Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_TaxRulePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_TaxRulePeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_TaxRulePeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_TaxRule
