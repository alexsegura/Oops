 ...
 */
abstract class Oops_Db_Propel_StockMvt extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_StockMvtPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_StockMvtPeer
	 */
	...
	/**
	 * @var        array Oops_Db_StockMvtReason[] Collection to store aggregation of Oops_Db_StockMvtReason objects.
	 */
	 ...
	 * @return     Oops_Db_StockMvt The current object (for fluent API support)
	 */
	public function setIdStockMvt($v)
	{
		...
		if ($this->id_stock_mvt !== $v) {
			$this->id_stock_mvt = $v;
			$this->modifiedColumns[] = Oops_Db_StockMvtPeer::ID_STOCK_MVT;
		}
	...
	public function setIdProduct($v)
	{
		...
		if ($this->id_product !== $v) {
			$this->id_product = $v;
			$this->modifiedColumns[] = Oops_Db_StockMvtPeer::ID_PRODUCT;
		}
	...
	public function setIdProductAttribute($v)
	{
		...
		if ($this->id_product_attribute !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_StockMvtPeer::ID_PRODUCT_ATTRIBUTE;
		}
	...
	public function setIdOrder($v)
	{
		...
		if ($this->id_order !== $v) {
			$this->id_order = $v;
			$this->modifiedColumns[] = Oops_Db_StockMvtPeer::ID_ORDER;
		}
	...
	public function setIdStockMvtReason($v)
	{
		...
		if ($this->id_stock_mvt_reason !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_StockMvtPeer::ID_STOCK_MVT_REASON;
		}
	...
	public function setIdEmployee($v)
	{
		...
		if ($this->id_employee !== $v) {
			$this->id_employee = $v;
			$this->modifiedColumns[] = Oops_Db_StockMvtPeer::ID_EMPLOYEE;
		}
	...
	public function setQuantity($v)
	{
		...
		if ($this->quantity !== $v) {
			$this->quantity = $v;
			$this->modifiedColumns[] = Oops_Db_StockMvtPeer::QUANTITY;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_StockMvtPeer::DATE_ADD;
			}
	...
	public function setDateUpd($v)
	{
		...
		if ($this->date_upd !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_StockMvtPeer::DATE_UPD;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 9; // 9 = Oops_Db_StockMvtPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_StockMvt object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_StockMvtPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_StockMvtQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_StockMvtPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->stockMvtReasonsScheduledForDeletion !== null) {
				if (!$this->stockMvtReasonsScheduledForDeletion->isEmpty()) {
					Oops_Db_StockMvtReasonQuery::create()
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::ID_STOCK_MVT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_STOCK_MVT`';
		}
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::ID_PRODUCT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PRODUCT`';
		}
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::ID_PRODUCT_ATTRIBUTE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PRODUCT_ATTRIBUTE`';
		}
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::ID_ORDER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ORDER`';
		}
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::ID_STOCK_MVT_REASON)) {
			$modifiedColumns[':p' . $index++]  = '`ID_STOCK_MVT_REASON`';
		}
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::ID_EMPLOYEE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_EMPLOYEE`';
		}
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::QUANTITY)) {
			$modifiedColumns[':p' . $index++]  = '`QUANTITY`';
		}
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::DATE_UPD)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_StockMvtPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_StockMvtPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_StockMvt'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_StockMvt'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_StockMvtPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::ID_STOCK_MVT)) $criteria->add(Oops_Db_StockMvtPeer::ID_STOCK_MVT, $this->id_stock_mvt);
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::ID_PRODUCT)) $criteria->add(Oops_Db_StockMvtPeer::ID_PRODUCT, $this->id_product);
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::ID_PRODUCT_ATTRIBUTE)) $criteria->add(Oops_Db_StockMvtPeer::ID_PRODUCT_ATTRIBUTE, $this->id_product_attribute);
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::ID_ORDER)) $criteria->add(Oops_Db_StockMvtPeer::ID_ORDER, $this->id_order);
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::ID_STOCK_MVT_REASON)) $criteria->add(Oops_Db_StockMvtPeer::ID_STOCK_MVT_REASON, $this->id_stock_mvt_reason);
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::ID_EMPLOYEE)) $criteria->add(Oops_Db_StockMvtPeer::ID_EMPLOYEE, $this->id_employee);
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::QUANTITY)) $criteria->add(Oops_Db_StockMvtPeer::QUANTITY, $this->quantity);
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::DATE_ADD)) $criteria->add(Oops_Db_StockMvtPeer::DATE_ADD, $this->date_add);
		if ($this->isColumnModified(Oops_Db_StockMvtPeer::DATE_UPD)) $criteria->add(Oops_Db_StockMvtPeer::DATE_UPD, $this->date_upd);
	...
	{
		$criteria = new Criteria(Oops_Db_StockMvtPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_StockMvtPeer::ID_STOCK_MVT, $this->id_stock_mvt);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_StockMvt (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_StockMvt Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_StockMvtPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_StockMvtPeer();
		}
		return self::$peer;
	}
	...
	public function initStockMvtReasons($overrideExisting = true)
	{
		...
		$this->collStockMvtReasons->setModel('Oops_Db_StockMvtReason');
	}

	/**
	 * Gets an array of Oops_Db_StockMvtReason objects which contain a foreign key that references this object.
	 *
	 * If the $criteria is not null, it is used to always fetch the results from the database.
	 * Otherwise the results are fetched from the database the first time, then cached.
	 * Next time the same method is called without $criteria, the cached collection is returned.
	 * If this Oops_Db_StockMvt is new, it will return
	 * an empty collection or the current collection; the criteria is ignored on a new object.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array Oops_Db_StockMvtReason[] List of Oops_Db_StockMvtReason objects
	 * @throws     PropelException
	 */
	public function getStockMvtReasons($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collStockMvtReasons || null !== $criteria) {
			if ($this->isNew() && null === $this->collStockMvtReasons) {
				...
				$collStockMvtReasons = Oops_Db_StockMvtReasonQuery::create(null, $criteria)
	...
	/**
	 * Returns the number of related Oops_Db_StockMvtReason objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Oops_Db_StockMvtReason objects.
	 * @throws     PropelException
	 */
	public function countStockMvtReasons(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collStockMvtReasons || null !== $criteria) {
			if ($this->isNew() && null === $this->collStockMvtReasons) {
				...
				$query = Oops_Db_StockMvtReasonQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
	...
	/**
	 * Method called to associate a Oops_Db_StockMvtReason object to this object
	 * through the Oops_Db_StockMvtReason foreign key attribute.
	 *
	 * @param      Oops_Db_StockMvtReason $l Oops_Db_StockMvtReason
	 * @return     Oops_Db_StockMvt The current object (for fluent API support)
	 */
	public function addStockMvtReason(Oops_Db_StockMvtReason $l)
	{
		if ($this->collStockMvtReasons === null) {
			$this->initStockMvtReasons();
		}
	...
	{
		return (string) $this->exportTo(Oops_Db_StockMvtPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_StockMvt
