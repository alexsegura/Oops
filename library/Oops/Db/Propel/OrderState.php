 ...
 */
abstract class Oops_Db_Propel_OrderState extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_OrderStatePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_OrderStatePeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_OrderState object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Db_OrderState The current object (for fluent API support)
	 */
	public function setIdOrderState($v)
	{
		...
		if ($this->id_order_state !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_OrderStatePeer::ID_ORDER_STATE;
		}
	...
	public function setInvoice($v)
	{
		...
		if ($this->invoice !== $v) {
			$this->invoice = $v;
			$this->modifiedColumns[] = Oops_Db_OrderStatePeer::INVOICE;
		}
	...
	public function setSendEmail($v)
	{
		...
		if ($this->send_email !== $v) {
			$this->send_email = $v;
			$this->modifiedColumns[] = Oops_Db_OrderStatePeer::SEND_EMAIL;
		}
	...
	public function setColor($v)
	{
		...
		if ($this->color !== $v) {
			$this->color = $v;
			$this->modifiedColumns[] = Oops_Db_OrderStatePeer::COLOR;
		}
	...
	public function setUnremovable($v)
	{
		...
		if ($this->unremovable !== $v) {
			$this->unremovable = $v;
			$this->modifiedColumns[] = Oops_Db_OrderStatePeer::UNREMOVABLE;
		}
	...
	public function setHidden($v)
	{
		...
		if ($this->hidden !== $v) {
			$this->hidden = $v;
			$this->modifiedColumns[] = Oops_Db_OrderStatePeer::HIDDEN;
		}
	...
	public function setLogable($v)
	{
		...
		if ($this->logable !== $v) {
			$this->logable = $v;
			$this->modifiedColumns[] = Oops_Db_OrderStatePeer::LOGABLE;
		}
	...
	public function setDelivery($v)
	{
		...
		if ($this->delivery !== $v) {
			$this->delivery = $v;
			$this->modifiedColumns[] = Oops_Db_OrderStatePeer::DELIVERY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = Oops_Db_OrderStatePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_OrderState object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_OrderStatePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_OrderStateQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_OrderStatePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::ID_ORDER_STATE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ORDER_STATE`';
		}
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::INVOICE)) {
			$modifiedColumns[':p' . $index++]  = '`INVOICE`';
		}
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::SEND_EMAIL)) {
			$modifiedColumns[':p' . $index++]  = '`SEND_EMAIL`';
		}
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::COLOR)) {
			$modifiedColumns[':p' . $index++]  = '`COLOR`';
		}
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::UNREMOVABLE)) {
			$modifiedColumns[':p' . $index++]  = '`UNREMOVABLE`';
		}
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::HIDDEN)) {
			$modifiedColumns[':p' . $index++]  = '`HIDDEN`';
		}
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::LOGABLE)) {
			$modifiedColumns[':p' . $index++]  = '`LOGABLE`';
		}
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::DELIVERY)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_OrderStatePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_OrderStatePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_OrderState'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_OrderState'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_OrderStatePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::ID_ORDER_STATE)) $criteria->add(Oops_Db_OrderStatePeer::ID_ORDER_STATE, $this->id_order_state);
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::INVOICE)) $criteria->add(Oops_Db_OrderStatePeer::INVOICE, $this->invoice);
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::SEND_EMAIL)) $criteria->add(Oops_Db_OrderStatePeer::SEND_EMAIL, $this->send_email);
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::COLOR)) $criteria->add(Oops_Db_OrderStatePeer::COLOR, $this->color);
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::UNREMOVABLE)) $criteria->add(Oops_Db_OrderStatePeer::UNREMOVABLE, $this->unremovable);
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::HIDDEN)) $criteria->add(Oops_Db_OrderStatePeer::HIDDEN, $this->hidden);
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::LOGABLE)) $criteria->add(Oops_Db_OrderStatePeer::LOGABLE, $this->logable);
		if ($this->isColumnModified(Oops_Db_OrderStatePeer::DELIVERY)) $criteria->add(Oops_Db_OrderStatePeer::DELIVERY, $this->delivery);
	...
	{
		$criteria = new Criteria(Oops_Db_OrderStatePeer::DATABASE_NAME);
		$criteria->add(Oops_Db_OrderStatePeer::ID_ORDER_STATE, $this->id_order_state);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_OrderState (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_OrderState Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_OrderStatePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_OrderStatePeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_OrderStatePeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_OrderState
