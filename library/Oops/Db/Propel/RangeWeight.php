 ...
 */
abstract class Oops_Db_Propel_RangeWeight extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_RangeWeightPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_RangeWeightPeer
	 */
	 ...
	 * @return     Oops_Db_RangeWeight The current object (for fluent API support)
	 */
	public function setIdRangeWeight($v)
	{
		...
		if ($this->id_range_weight !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_RangeWeightPeer::ID_RANGE_WEIGHT;
		}
	...
	public function setIdCarrier($v)
	{
		...
		if ($this->id_carrier !== $v) {
			$this->id_carrier = $v;
			$this->modifiedColumns[] = Oops_Db_RangeWeightPeer::ID_CARRIER;
		}
	...
	public function setDelimiter1($v)
	{
		...
		if ($this->delimiter1 !== $v) {
			$this->delimiter1 = $v;
			$this->modifiedColumns[] = Oops_Db_RangeWeightPeer::DELIMITER1;
		}
	...
	public function setDelimiter2($v)
	{
		...
		if ($this->delimiter2 !== $v) {
			$this->delimiter2 = $v;
			$this->modifiedColumns[] = Oops_Db_RangeWeightPeer::DELIMITER2;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = Oops_Db_RangeWeightPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_RangeWeight object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_RangeWeightPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_RangeWeightQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_RangeWeightPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_RangeWeightPeer::ID_RANGE_WEIGHT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_RANGE_WEIGHT`';
		}
		if ($this->isColumnModified(Oops_Db_RangeWeightPeer::ID_CARRIER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CARRIER`';
		}
		if ($this->isColumnModified(Oops_Db_RangeWeightPeer::DELIMITER1)) {
			$modifiedColumns[':p' . $index++]  = '`DELIMITER1`';
		}
		if ($this->isColumnModified(Oops_Db_RangeWeightPeer::DELIMITER2)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_RangeWeightPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_RangeWeightPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_RangeWeight'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_RangeWeight'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_RangeWeightPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_RangeWeightPeer::ID_RANGE_WEIGHT)) $criteria->add(Oops_Db_RangeWeightPeer::ID_RANGE_WEIGHT, $this->id_range_weight);
		if ($this->isColumnModified(Oops_Db_RangeWeightPeer::ID_CARRIER)) $criteria->add(Oops_Db_RangeWeightPeer::ID_CARRIER, $this->id_carrier);
		if ($this->isColumnModified(Oops_Db_RangeWeightPeer::DELIMITER1)) $criteria->add(Oops_Db_RangeWeightPeer::DELIMITER1, $this->delimiter1);
		if ($this->isColumnModified(Oops_Db_RangeWeightPeer::DELIMITER2)) $criteria->add(Oops_Db_RangeWeightPeer::DELIMITER2, $this->delimiter2);
	...
	{
		$criteria = new Criteria(Oops_Db_RangeWeightPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_RangeWeightPeer::ID_RANGE_WEIGHT, $this->id_range_weight);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_RangeWeight (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_RangeWeight Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_RangeWeightPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_RangeWeightPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_RangeWeightPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_RangeWeight
