 ...
 */
abstract class Oops_Db_Propel_ProductAttribute extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_ProductAttributePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_ProductAttributePeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_ProductAttribute object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Db_ProductAttribute The current object (for fluent API support)
	 */
	public function setIdProductAttribute($v)
	{
		...
		if ($this->id_product_attribute !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::ID_PRODUCT_ATTRIBUTE;
		}
	...
	public function setIdProduct($v)
	{
		...
		if ($this->id_product !== $v) {
			$this->id_product = $v;
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::ID_PRODUCT;
		}
	...
	public function setReference($v)
	{
		...
		if ($this->reference !== $v) {
			$this->reference = $v;
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::REFERENCE;
		}
	...
	public function setSupplierReference($v)
	{
		...
		if ($this->supplier_reference !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::SUPPLIER_REFERENCE;
		}
	...
	public function setLocation($v)
	{
		...
		if ($this->location !== $v) {
			$this->location = $v;
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::LOCATION;
		}
	...
	public function setEan13($v)
	{
		...
		if ($this->ean13 !== $v) {
			$this->ean13 = $v;
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::EAN13;
		}
	...
	public function setUpc($v)
	{
		...
		if ($this->upc !== $v) {
			$this->upc = $v;
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::UPC;
		}
	...
	public function setWholesalePrice($v)
	{
		...
		if ($this->wholesale_price !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::WHOLESALE_PRICE;
		}
	...
	public function setPrice($v)
	{
		...
		if ($this->price !== $v) {
			$this->price = $v;
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::PRICE;
		}
	...
	public function setEcotax($v)
	{
		...
		if ($this->ecotax !== $v) {
			$this->ecotax = $v;
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::ECOTAX;
		}
	...
	public function setQuantity($v)
	{
		...
		if ($this->quantity !== $v) {
			$this->quantity = $v;
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::QUANTITY;
		}
	...
	public function setWeight($v)
	{
		...
		if ($this->weight !== $v) {
			$this->weight = $v;
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::WEIGHT;
		}
	...
	public function setUnitPriceImpact($v)
	{
		...
		if ($this->unit_price_impact !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::UNIT_PRICE_IMPACT;
		}
	...
	public function setDefaultOn($v)
	{
		...
		if ($this->default_on !== $v) {
			$this->default_on = $v;
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::DEFAULT_ON;
		}
	...
	public function setMinimalQuantity($v)
	{
		...
		if ($this->minimal_quantity !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ProductAttributePeer::MINIMAL_QUANTITY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 15; // 15 = Oops_Db_ProductAttributePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_ProductAttribute object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_ProductAttributePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_ProductAttributeQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_ProductAttributePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::ID_PRODUCT_ATTRIBUTE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PRODUCT_ATTRIBUTE`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::ID_PRODUCT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PRODUCT`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::REFERENCE)) {
			$modifiedColumns[':p' . $index++]  = '`REFERENCE`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::SUPPLIER_REFERENCE)) {
			$modifiedColumns[':p' . $index++]  = '`SUPPLIER_REFERENCE`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::LOCATION)) {
			$modifiedColumns[':p' . $index++]  = '`LOCATION`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::EAN13)) {
			$modifiedColumns[':p' . $index++]  = '`EAN13`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::UPC)) {
			$modifiedColumns[':p' . $index++]  = '`UPC`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::WHOLESALE_PRICE)) {
			$modifiedColumns[':p' . $index++]  = '`WHOLESALE_PRICE`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::PRICE)) {
			$modifiedColumns[':p' . $index++]  = '`PRICE`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::ECOTAX)) {
			$modifiedColumns[':p' . $index++]  = '`ECOTAX`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::QUANTITY)) {
			$modifiedColumns[':p' . $index++]  = '`QUANTITY`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::WEIGHT)) {
			$modifiedColumns[':p' . $index++]  = '`WEIGHT`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::UNIT_PRICE_IMPACT)) {
			$modifiedColumns[':p' . $index++]  = '`UNIT_PRICE_IMPACT`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::DEFAULT_ON)) {
			$modifiedColumns[':p' . $index++]  = '`DEFAULT_ON`';
		}
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::MINIMAL_QUANTITY)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_ProductAttributePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_ProductAttributePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_ProductAttribute'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_ProductAttribute'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_ProductAttributePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::ID_PRODUCT_ATTRIBUTE)) $criteria->add(Oops_Db_ProductAttributePeer::ID_PRODUCT_ATTRIBUTE, $this->id_product_attribute);
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::ID_PRODUCT)) $criteria->add(Oops_Db_ProductAttributePeer::ID_PRODUCT, $this->id_product);
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::REFERENCE)) $criteria->add(Oops_Db_ProductAttributePeer::REFERENCE, $this->reference);
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::SUPPLIER_REFERENCE)) $criteria->add(Oops_Db_ProductAttributePeer::SUPPLIER_REFERENCE, $this->supplier_reference);
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::LOCATION)) $criteria->add(Oops_Db_ProductAttributePeer::LOCATION, $this->location);
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::EAN13)) $criteria->add(Oops_Db_ProductAttributePeer::EAN13, $this->ean13);
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::UPC)) $criteria->add(Oops_Db_ProductAttributePeer::UPC, $this->upc);
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::WHOLESALE_PRICE)) $criteria->add(Oops_Db_ProductAttributePeer::WHOLESALE_PRICE, $this->wholesale_price);
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::PRICE)) $criteria->add(Oops_Db_ProductAttributePeer::PRICE, $this->price);
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::ECOTAX)) $criteria->add(Oops_Db_ProductAttributePeer::ECOTAX, $this->ecotax);
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::QUANTITY)) $criteria->add(Oops_Db_ProductAttributePeer::QUANTITY, $this->quantity);
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::WEIGHT)) $criteria->add(Oops_Db_ProductAttributePeer::WEIGHT, $this->weight);
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::UNIT_PRICE_IMPACT)) $criteria->add(Oops_Db_ProductAttributePeer::UNIT_PRICE_IMPACT, $this->unit_price_impact);
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::DEFAULT_ON)) $criteria->add(Oops_Db_ProductAttributePeer::DEFAULT_ON, $this->default_on);
		if ($this->isColumnModified(Oops_Db_ProductAttributePeer::MINIMAL_QUANTITY)) $criteria->add(Oops_Db_ProductAttributePeer::MINIMAL_QUANTITY, $this->minimal_quantity);
	...
	{
		$criteria = new Criteria(Oops_Db_ProductAttributePeer::DATABASE_NAME);
		$criteria->add(Oops_Db_ProductAttributePeer::ID_PRODUCT_ATTRIBUTE, $this->id_product_attribute);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_ProductAttribute (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_ProductAttribute Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_ProductAttributePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_ProductAttributePeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_ProductAttributePeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_ProductAttribute
