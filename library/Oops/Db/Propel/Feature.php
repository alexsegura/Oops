 ...
 */
abstract class Oops_Db_Propel_Feature extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_FeaturePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_FeaturePeer
	 */
	...
	/**
	 * @var        array Oops_Db_FeatureValue[] Collection to store aggregation of Oops_Db_FeatureValue objects.
	 */
	protected $collFeatureValues;

	/**
	 * @var        array Oops_Db_FeatureLang[] Collection to store aggregation of Oops_Db_FeatureLang objects.
	 */
	 ...
	 * @return     Oops_Db_Feature The current object (for fluent API support)
	 */
	public function setIdFeature($v)
	{
		...
		if ($this->id_feature !== $v) {
			$this->id_feature = $v;
			$this->modifiedColumns[] = Oops_Db_FeaturePeer::ID_FEATURE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 1; // 1 = Oops_Db_FeaturePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_Feature object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_FeaturePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_FeatureQuery::create()
			...
			if ($ret) {
				...
				Oops_Db_FeatureLangQuery::create()
					->filterByOops_Db_Feature($this)
					->delete($con);
				$con->commit();
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_FeaturePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_FeaturePeer::ID_FEATURE)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_FeaturePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_FeaturePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_Feature'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_Feature'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_FeaturePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_FeaturePeer::ID_FEATURE)) $criteria->add(Oops_Db_FeaturePeer::ID_FEATURE, $this->id_feature);
	...
	{
		$criteria = new Criteria(Oops_Db_FeaturePeer::DATABASE_NAME);
		$criteria->add(Oops_Db_FeaturePeer::ID_FEATURE, $this->id_feature);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_Feature (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_Feature Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_FeaturePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_FeaturePeer();
		}
		return self::$peer;
	}
	 ...
	 * If this Oops_Db_Feature is new, it will return
	...
	public function initFeatureValues($overrideExisting = true)
	{
		...
		$this->collFeatureValues->setModel('Oops_Db_FeatureValue');
	}

	/**
	 * Gets an array of Oops_Db_FeatureValue objects which contain a foreign key that references this object.
	 *
	 * If the $criteria is not null, it is used to always fetch the results from the database.
	 * Otherwise the results are fetched from the database the first time, then cached.
	 * Next time the same method is called without $criteria, the cached collection is returned.
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array Oops_Db_FeatureValue[] List of Oops_Db_FeatureValue objects
	 * @throws     PropelException
	 */
	public function getFeatureValues($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collFeatureValues || null !== $criteria) {
			if ($this->isNew() && null === $this->collFeatureValues) {
				...
				$collFeatureValues = Oops_Db_FeatureValueQuery::create(null, $criteria)
					->filterByFeature($this)
					->find($con);
				if (null !== $criteria) {
	...
	/**
	 * Returns the number of related Oops_Db_FeatureValue objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Oops_Db_FeatureValue objects.
	 * @throws     PropelException
	 */
	public function countFeatureValues(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collFeatureValues || null !== $criteria) {
			if ($this->isNew() && null === $this->collFeatureValues) {
				...
				$query = Oops_Db_FeatureValueQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
	...
	/**
	 * Method called to associate a Oops_Db_FeatureValue object to this object
	 * through the Oops_Db_FeatureValue foreign key attribute.
	 *
	 * @param      Oops_Db_FeatureValue $l Oops_Db_FeatureValue
	 * @return     Oops_Db_Feature The current object (for fluent API support)
	 */
	public function addFeatureValue(Oops_Db_FeatureValue $l)
	{
		if ($this->collFeatureValues === null) {
			$this->initFeatureValues();
		}
	...
	public function initFeatureLangs($overrideExisting = true)
	{
		...
		$this->collFeatureLangs->setModel('Oops_Db_FeatureLang');
	}

	/**
	 * Gets an array of Oops_Db_FeatureLang objects which contain a foreign key that references this object.
	 *
	 * If the $criteria is not null, it is used to always fetch the results from the database.
	 * Otherwise the results are fetched from the database the first time, then cached.
	 * Next time the same method is called without $criteria, the cached collection is returned.
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array Oops_Db_FeatureLang[] List of Oops_Db_FeatureLang objects
	 * @throws     PropelException
	 */
	public function getFeatureLangs($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collFeatureLangs || null !== $criteria) {
			if ($this->isNew() && null === $this->collFeatureLangs) {
				...
				$collFeatureLangs = Oops_Db_FeatureLangQuery::create(null, $criteria)
					->filterByFeature($this)
					->find($con);
				if (null !== $criteria) {
	...
	/**
	 * Returns the number of related Oops_Db_FeatureLang objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related Oops_Db_FeatureLang objects.
	 * @throws     PropelException
	 */
	public function countFeatureLangs(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if(null === $this->collFeatureLangs || null !== $criteria) {
			if ($this->isNew() && null === $this->collFeatureLangs) {
				...
				$query = Oops_Db_FeatureLangQuery::create(null, $criteria);
				if($distinct) {
					$query->distinct();
				}
				return $query
	...
	/**
	 * Method called to associate a Oops_Db_FeatureLang object to this object
	 * through the Oops_Db_FeatureLang foreign key attribute.
	 *
	 * @param      Oops_Db_FeatureLang $l Oops_Db_FeatureLang
	 * @return     Oops_Db_Feature The current object (for fluent API support)
	 */
	public function addFeatureLang(Oops_Db_FeatureLang $l)
	{
		if ($this->collFeatureLangs === null) {
			$this->initFeatureLangs();
		}
	...
	public function setProducts(PropelCollection $products, PropelPDO $con = null)
	{
		...
		$this->productsScheduledForDeletion = $this->getFeatureProducts()->diff($oops_Db_FeatureProducts);
	 ...
	 *
	 * @param      Oops_Db_Product $product The Oops_Db_FeatureProduct object to relate
	 * @return     void
	 */
	...
	{
		return (string) $this->exportTo(Oops_Db_FeaturePeer::DEFAULT_STRING_FORMAT);
	}
	...
	public function getTranslation($locale = '1', PropelPDO $con = null)
	{
		if (!isset($this->currentTranslations[$locale])) {
			...
			if ($this->isNew()) {
				$translation = new Oops_Db_FeatureLang();
				$translation->setIdLang($locale);
			} else {
				$translation = Oops_Db_FeatureLangQuery::create()
