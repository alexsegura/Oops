 ...
 */
abstract class Oops_Db_Propel_Access extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_AccessPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_AccessPeer
	 */
	 ...
	 * @return     Oops_Db_Access The current object (for fluent API support)
	 */
	public function setIdProfile($v)
	{
		...
		if ($this->id_profile !== $v) {
			$this->id_profile = $v;
			$this->modifiedColumns[] = Oops_Db_AccessPeer::ID_PROFILE;
		}
	...
	public function setIdTab($v)
	{
		...
		if ($this->id_tab !== $v) {
			$this->id_tab = $v;
			$this->modifiedColumns[] = Oops_Db_AccessPeer::ID_TAB;
		}
	...
	public function setView($v)
	{
		...
		if ($this->view !== $v) {
			$this->view = $v;
			$this->modifiedColumns[] = Oops_Db_AccessPeer::VIEW;
		}
	...
	public function setAdd($v)
	{
		...
		if ($this->add !== $v) {
			$this->add = $v;
			$this->modifiedColumns[] = Oops_Db_AccessPeer::ADD;
		}
	...
	public function setEdit($v)
	{
		...
		if ($this->edit !== $v) {
			$this->edit = $v;
			$this->modifiedColumns[] = Oops_Db_AccessPeer::EDIT;
		}
	...
	public function setDelete($v)
	{
		...
		if ($this->delete !== $v) {
			$this->delete = $v;
			$this->modifiedColumns[] = Oops_Db_AccessPeer::DELETE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = Oops_Db_AccessPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_Access object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_AccessPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_AccessQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_AccessPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_AccessPeer::ID_PROFILE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PROFILE`';
		}
		if ($this->isColumnModified(Oops_Db_AccessPeer::ID_TAB)) {
			$modifiedColumns[':p' . $index++]  = '`ID_TAB`';
		}
		if ($this->isColumnModified(Oops_Db_AccessPeer::VIEW)) {
			$modifiedColumns[':p' . $index++]  = '`VIEW`';
		}
		if ($this->isColumnModified(Oops_Db_AccessPeer::ADD)) {
			$modifiedColumns[':p' . $index++]  = '`ADD`';
		}
		if ($this->isColumnModified(Oops_Db_AccessPeer::EDIT)) {
			$modifiedColumns[':p' . $index++]  = '`EDIT`';
		}
		if ($this->isColumnModified(Oops_Db_AccessPeer::DELETE)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_AccessPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_AccessPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_Access'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_Access'][serialize($this->getPrimaryKey())] = true;
		$keys = Oops_Db_AccessPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_AccessPeer::ID_PROFILE)) $criteria->add(Oops_Db_AccessPeer::ID_PROFILE, $this->id_profile);
		if ($this->isColumnModified(Oops_Db_AccessPeer::ID_TAB)) $criteria->add(Oops_Db_AccessPeer::ID_TAB, $this->id_tab);
		if ($this->isColumnModified(Oops_Db_AccessPeer::VIEW)) $criteria->add(Oops_Db_AccessPeer::VIEW, $this->view);
		if ($this->isColumnModified(Oops_Db_AccessPeer::ADD)) $criteria->add(Oops_Db_AccessPeer::ADD, $this->add);
		if ($this->isColumnModified(Oops_Db_AccessPeer::EDIT)) $criteria->add(Oops_Db_AccessPeer::EDIT, $this->edit);
		if ($this->isColumnModified(Oops_Db_AccessPeer::DELETE)) $criteria->add(Oops_Db_AccessPeer::DELETE, $this->delete);
	...
	{
		$criteria = new Criteria(Oops_Db_AccessPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_AccessPeer::ID_PROFILE, $this->id_profile);
		$criteria->add(Oops_Db_AccessPeer::ID_TAB, $this->id_tab);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_Access (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_Access Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_AccessPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_AccessPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_AccessPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_Access
