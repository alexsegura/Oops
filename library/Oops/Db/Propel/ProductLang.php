 ...
 */
abstract class Oops_Db_Propel_ProductLang extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_ProductLangPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_ProductLangPeer
	 */
	 ...
	 * @return     Oops_Db_ProductLang The current object (for fluent API support)
	 */
	public function setIdProduct($v)
	{
		...
		if ($this->id_product !== $v) {
			$this->id_product = $v;
			$this->modifiedColumns[] = Oops_Db_ProductLangPeer::ID_PRODUCT;
		}
	...
	public function setIdLang($v)
	{
		...
		if ($this->id_lang !== $v) {
			$this->id_lang = $v;
			$this->modifiedColumns[] = Oops_Db_ProductLangPeer::ID_LANG;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = Oops_Db_ProductLangPeer::DESCRIPTION;
		}
	...
	public function setDescriptionShort($v)
	{
		...
		if ($this->description_short !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ProductLangPeer::DESCRIPTION_SHORT;
		}
	...
	public function setLinkRewrite($v)
	{
		...
		if ($this->link_rewrite !== $v) {
			$this->link_rewrite = $v;
			$this->modifiedColumns[] = Oops_Db_ProductLangPeer::LINK_REWRITE;
		}
	...
	public function setMetaDescription($v)
	{
		...
		if ($this->meta_description !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ProductLangPeer::META_DESCRIPTION;
		}
	...
	public function setMetaKeywords($v)
	{
		...
		if ($this->meta_keywords !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ProductLangPeer::META_KEYWORDS;
		}
	...
	public function setMetaTitle($v)
	{
		...
		if ($this->meta_title !== $v) {
			$this->meta_title = $v;
			$this->modifiedColumns[] = Oops_Db_ProductLangPeer::META_TITLE;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = Oops_Db_ProductLangPeer::NAME;
		}
	...
	public function setAvailableNow($v)
	{
		...
		if ($this->available_now !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ProductLangPeer::AVAILABLE_NOW;
		}
	...
	public function setAvailableLater($v)
	{
		...
		if ($this->available_later !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ProductLangPeer::AVAILABLE_LATER;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 11; // 11 = Oops_Db_ProductLangPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_ProductLang object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_ProductLangPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_ProductLangQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_ProductLangPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::ID_PRODUCT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PRODUCT`';
		}
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::ID_LANG)) {
			$modifiedColumns[':p' . $index++]  = '`ID_LANG`';
		}
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::DESCRIPTION)) {
			$modifiedColumns[':p' . $index++]  = '`DESCRIPTION`';
		}
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::DESCRIPTION_SHORT)) {
			$modifiedColumns[':p' . $index++]  = '`DESCRIPTION_SHORT`';
		}
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::LINK_REWRITE)) {
			$modifiedColumns[':p' . $index++]  = '`LINK_REWRITE`';
		}
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::META_DESCRIPTION)) {
			$modifiedColumns[':p' . $index++]  = '`META_DESCRIPTION`';
		}
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::META_KEYWORDS)) {
			$modifiedColumns[':p' . $index++]  = '`META_KEYWORDS`';
		}
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::META_TITLE)) {
			$modifiedColumns[':p' . $index++]  = '`META_TITLE`';
		}
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::NAME)) {
			$modifiedColumns[':p' . $index++]  = '`NAME`';
		}
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::AVAILABLE_NOW)) {
			$modifiedColumns[':p' . $index++]  = '`AVAILABLE_NOW`';
		}
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::AVAILABLE_LATER)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_ProductLangPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_ProductLangPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_ProductLang'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_ProductLang'][serialize($this->getPrimaryKey())] = true;
		$keys = Oops_Db_ProductLangPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::ID_PRODUCT)) $criteria->add(Oops_Db_ProductLangPeer::ID_PRODUCT, $this->id_product);
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::ID_LANG)) $criteria->add(Oops_Db_ProductLangPeer::ID_LANG, $this->id_lang);
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::DESCRIPTION)) $criteria->add(Oops_Db_ProductLangPeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::DESCRIPTION_SHORT)) $criteria->add(Oops_Db_ProductLangPeer::DESCRIPTION_SHORT, $this->description_short);
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::LINK_REWRITE)) $criteria->add(Oops_Db_ProductLangPeer::LINK_REWRITE, $this->link_rewrite);
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::META_DESCRIPTION)) $criteria->add(Oops_Db_ProductLangPeer::META_DESCRIPTION, $this->meta_description);
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::META_KEYWORDS)) $criteria->add(Oops_Db_ProductLangPeer::META_KEYWORDS, $this->meta_keywords);
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::META_TITLE)) $criteria->add(Oops_Db_ProductLangPeer::META_TITLE, $this->meta_title);
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::NAME)) $criteria->add(Oops_Db_ProductLangPeer::NAME, $this->name);
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::AVAILABLE_NOW)) $criteria->add(Oops_Db_ProductLangPeer::AVAILABLE_NOW, $this->available_now);
		if ($this->isColumnModified(Oops_Db_ProductLangPeer::AVAILABLE_LATER)) $criteria->add(Oops_Db_ProductLangPeer::AVAILABLE_LATER, $this->available_later);
	...
	{
		$criteria = new Criteria(Oops_Db_ProductLangPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_ProductLangPeer::ID_PRODUCT, $this->id_product);
		$criteria->add(Oops_Db_ProductLangPeer::ID_LANG, $this->id_lang);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_ProductLang (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_ProductLang Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_ProductLangPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_ProductLangPeer();
		}
		return self::$peer;
	}
	...
	/**
	 * Declares an association between this object and a Oops_Db_Lang object.
	 *
	 * @param      Oops_Db_Lang $v
	 * @return     Oops_Db_ProductLang The current object (for fluent API support)
	 * @throws     PropelException
	 */
	public function setLang(Oops_Db_Lang $v = null)
	{
		if ($v === null) {
			$this->setIdLang(NULL);
		} else {
		...
		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Oops_Db_Lang object, it will not be re-added.
		if ($v !== null) {
			$v->addProductLang($this);
		}
	...
	/**
	 * Get the associated Oops_Db_Lang object
	 *
	 * @param      PropelPDO Optional Connection object.
	 * @return     Oops_Db_Lang The associated Oops_Db_Lang object.
	 * @throws     PropelException
	 */
	public function getLang(PropelPDO $con = null)
	{
		if ($this->aLang === null && ($this->id_lang !== null)) {
			$this->aLang = Oops_Db_LangQuery::create()->findPk($this->id_lang, $con);
			/* The following can be used additionally to
				guarantee the related object contains a reference
				to this object.  This level of coupling may, however, be
				undesirable since it could result in an only partially populated collection
	...
	{
		return (string) $this->exportTo(Oops_Db_ProductLangPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_ProductLang
