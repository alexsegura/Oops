 ...
 */
abstract class Oops_Db_Propel_Discount extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_DiscountPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_DiscountPeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_Discount object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Db_Discount The current object (for fluent API support)
	 */
	public function setIdDiscount($v)
	{
		...
		if ($this->id_discount !== $v) {
			$this->id_discount = $v;
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::ID_DISCOUNT;
		}
	...
	public function setIdDiscountType($v)
	{
		...
		if ($this->id_discount_type !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::ID_DISCOUNT_TYPE;
		}
	...
	public function setBehaviorNotExhausted($v)
	{
		...
		if ($this->behavior_not_exhausted !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::BEHAVIOR_NOT_EXHAUSTED;
		}
	...
	public function setIdCustomer($v)
	{
		...
		if ($this->id_customer !== $v) {
			$this->id_customer = $v;
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::ID_CUSTOMER;
		}
	...
	public function setIdGroup($v)
	{
		...
		if ($this->id_group !== $v) {
			$this->id_group = $v;
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::ID_GROUP;
		}
	...
	public function setIdCurrency($v)
	{
		...
		if ($this->id_currency !== $v) {
			$this->id_currency = $v;
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::ID_CURRENCY;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::NAME;
		}
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v) {
			$this->value = $v;
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::VALUE;
		}
	...
	public function setQuantity($v)
	{
		...
		if ($this->quantity !== $v) {
			$this->quantity = $v;
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::QUANTITY;
		}
	...
	public function setQuantityPerUser($v)
	{
		...
		if ($this->quantity_per_user !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::QUANTITY_PER_USER;
		}
	...
	public function setCumulable($v)
	{
		...
		if ($this->cumulable !== $v) {
			$this->cumulable = $v;
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::CUMULABLE;
		}
	...
	public function setCumulableReduction($v)
	{
		...
		if ($this->cumulable_reduction !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::CUMULABLE_REDUCTION;
		}
	...
	public function setDateFrom($v)
	{
		...
		if ($this->date_from !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_DiscountPeer::DATE_FROM;
			}
	...
	public function setDateTo($v)
	{
		...
		if ($this->date_to !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_DiscountPeer::DATE_TO;
			}
		} // if either are not null
	...
	public function setMinimal($v)
	{
		...
		if ($this->minimal !== $v) {
			$this->minimal = $v;
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::MINIMAL;
		}
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v) {
			$this->active = $v;
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::ACTIVE;
		}
	...
	public function setCartDisplay($v)
	{
		...
		if ($this->cart_display !== $v) {
			$this->cart_display = $v;
			$this->modifiedColumns[] = Oops_Db_DiscountPeer::CART_DISPLAY;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_DiscountPeer::DATE_ADD;
			}
		} // if either are not null
	...
	public function setDateUpd($v)
	{
		...
		if ($this->date_upd !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_DiscountPeer::DATE_UPD;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 19; // 19 = Oops_Db_DiscountPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_Discount object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_DiscountPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_DiscountQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_DiscountPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_DiscountPeer::ID_DISCOUNT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_DISCOUNT`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::ID_DISCOUNT_TYPE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_DISCOUNT_TYPE`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::BEHAVIOR_NOT_EXHAUSTED)) {
			$modifiedColumns[':p' . $index++]  = '`BEHAVIOR_NOT_EXHAUSTED`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::ID_CUSTOMER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CUSTOMER`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::ID_GROUP)) {
			$modifiedColumns[':p' . $index++]  = '`ID_GROUP`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::ID_CURRENCY)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CURRENCY`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::NAME)) {
			$modifiedColumns[':p' . $index++]  = '`NAME`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::VALUE)) {
			$modifiedColumns[':p' . $index++]  = '`VALUE`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::QUANTITY)) {
			$modifiedColumns[':p' . $index++]  = '`QUANTITY`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::QUANTITY_PER_USER)) {
			$modifiedColumns[':p' . $index++]  = '`QUANTITY_PER_USER`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::CUMULABLE)) {
			$modifiedColumns[':p' . $index++]  = '`CUMULABLE`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::CUMULABLE_REDUCTION)) {
			$modifiedColumns[':p' . $index++]  = '`CUMULABLE_REDUCTION`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::DATE_FROM)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_FROM`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::DATE_TO)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_TO`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::MINIMAL)) {
			$modifiedColumns[':p' . $index++]  = '`MINIMAL`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::ACTIVE)) {
			$modifiedColumns[':p' . $index++]  = '`ACTIVE`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::CART_DISPLAY)) {
			$modifiedColumns[':p' . $index++]  = '`CART_DISPLAY`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}
		if ($this->isColumnModified(Oops_Db_DiscountPeer::DATE_UPD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_UPD`';
		}

		$sql = sprintf(
			'INSERT INTO `' .  _DB_PREFIX_ . 'discount` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_DiscountPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_DiscountPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_Discount'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_Discount'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_DiscountPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_DiscountPeer::ID_DISCOUNT)) $criteria->add(Oops_Db_DiscountPeer::ID_DISCOUNT, $this->id_discount);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::ID_DISCOUNT_TYPE)) $criteria->add(Oops_Db_DiscountPeer::ID_DISCOUNT_TYPE, $this->id_discount_type);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::BEHAVIOR_NOT_EXHAUSTED)) $criteria->add(Oops_Db_DiscountPeer::BEHAVIOR_NOT_EXHAUSTED, $this->behavior_not_exhausted);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::ID_CUSTOMER)) $criteria->add(Oops_Db_DiscountPeer::ID_CUSTOMER, $this->id_customer);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::ID_GROUP)) $criteria->add(Oops_Db_DiscountPeer::ID_GROUP, $this->id_group);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::ID_CURRENCY)) $criteria->add(Oops_Db_DiscountPeer::ID_CURRENCY, $this->id_currency);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::NAME)) $criteria->add(Oops_Db_DiscountPeer::NAME, $this->name);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::VALUE)) $criteria->add(Oops_Db_DiscountPeer::VALUE, $this->value);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::QUANTITY)) $criteria->add(Oops_Db_DiscountPeer::QUANTITY, $this->quantity);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::QUANTITY_PER_USER)) $criteria->add(Oops_Db_DiscountPeer::QUANTITY_PER_USER, $this->quantity_per_user);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::CUMULABLE)) $criteria->add(Oops_Db_DiscountPeer::CUMULABLE, $this->cumulable);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::CUMULABLE_REDUCTION)) $criteria->add(Oops_Db_DiscountPeer::CUMULABLE_REDUCTION, $this->cumulable_reduction);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::DATE_FROM)) $criteria->add(Oops_Db_DiscountPeer::DATE_FROM, $this->date_from);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::DATE_TO)) $criteria->add(Oops_Db_DiscountPeer::DATE_TO, $this->date_to);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::MINIMAL)) $criteria->add(Oops_Db_DiscountPeer::MINIMAL, $this->minimal);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::ACTIVE)) $criteria->add(Oops_Db_DiscountPeer::ACTIVE, $this->active);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::CART_DISPLAY)) $criteria->add(Oops_Db_DiscountPeer::CART_DISPLAY, $this->cart_display);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::DATE_ADD)) $criteria->add(Oops_Db_DiscountPeer::DATE_ADD, $this->date_add);
		if ($this->isColumnModified(Oops_Db_DiscountPeer::DATE_UPD)) $criteria->add(Oops_Db_DiscountPeer::DATE_UPD, $this->date_upd);
	...
	{
		$criteria = new Criteria(Oops_Db_DiscountPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_DiscountPeer::ID_DISCOUNT, $this->id_discount);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_Discount (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_Discount Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_DiscountPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_DiscountPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_DiscountPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_Discount
