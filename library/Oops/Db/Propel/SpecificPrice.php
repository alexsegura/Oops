...
/**
 * Base class that represents a row from the 'specific_price' table.
 *
 * 
 *
 * @package    propel.generator.prestashop.om
 */
abstract class Oops_Db_Propel_SpecificPrice extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_SpecificPricePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_SpecificPricePeer
	 */
	 ...
	 * @return     Oops_Db_SpecificPrice The current object (for fluent API support)
	 */
	public function setIdSpecificPrice($v)
	{
		...
		if ($this->id_specific_price !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_SpecificPricePeer::ID_SPECIFIC_PRICE;
		}
	...
	public function setIdProduct($v)
	{
		...
		if ($this->id_product !== $v) {
			$this->id_product = $v;
			$this->modifiedColumns[] = Oops_Db_SpecificPricePeer::ID_PRODUCT;
		}
	...
	public function setIdShop($v)
	{
		...
		if ($this->id_shop !== $v) {
			$this->id_shop = $v;
			$this->modifiedColumns[] = Oops_Db_SpecificPricePeer::ID_SHOP;
		}
	...
	public function setIdCurrency($v)
	{
		...
		if ($this->id_currency !== $v) {
			$this->id_currency = $v;
			$this->modifiedColumns[] = Oops_Db_SpecificPricePeer::ID_CURRENCY;
		}
	...
	public function setIdCountry($v)
	{
		...
		if ($this->id_country !== $v) {
			$this->id_country = $v;
			$this->modifiedColumns[] = Oops_Db_SpecificPricePeer::ID_COUNTRY;
		}
	...
	public function setIdGroup($v)
	{
		...
		if ($this->id_group !== $v) {
			$this->id_group = $v;
			$this->modifiedColumns[] = Oops_Db_SpecificPricePeer::ID_GROUP;
		}
	...
	public function setPrice($v)
	{
		...
		if ($this->price !== $v) {
			$this->price = $v;
			$this->modifiedColumns[] = Oops_Db_SpecificPricePeer::PRICE;
		}
	...
	public function setFromQuantity($v)
	{
		...
		if ($this->from_quantity !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_SpecificPricePeer::FROM_QUANTITY;
		}
	...
	public function setReduction($v)
	{
		...
		if ($this->reduction !== $v) {
			$this->reduction = $v;
			$this->modifiedColumns[] = Oops_Db_SpecificPricePeer::REDUCTION;
		}
	...
	public function setReductionType($v)
	{
		...
		if ($this->reduction_type !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_SpecificPricePeer::REDUCTION_TYPE;
		}
	...
	public function setFrom($v)
	{
		...
		if ($this->from !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_SpecificPricePeer::FROM;
			}
	...
	public function setTo($v)
	{
		...
		if ($this->to !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_SpecificPricePeer::TO;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 12; // 12 = Oops_Db_SpecificPricePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_SpecificPrice object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_SpecificPricePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_SpecificPriceQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_SpecificPricePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::ID_SPECIFIC_PRICE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_SPECIFIC_PRICE`';
		}
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::ID_PRODUCT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PRODUCT`';
		}
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::ID_SHOP)) {
			$modifiedColumns[':p' . $index++]  = '`ID_SHOP`';
		}
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::ID_CURRENCY)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CURRENCY`';
		}
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::ID_COUNTRY)) {
			$modifiedColumns[':p' . $index++]  = '`ID_COUNTRY`';
		}
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::ID_GROUP)) {
			$modifiedColumns[':p' . $index++]  = '`ID_GROUP`';
		}
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::PRICE)) {
			$modifiedColumns[':p' . $index++]  = '`PRICE`';
		}
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::FROM_QUANTITY)) {
			$modifiedColumns[':p' . $index++]  = '`FROM_QUANTITY`';
		}
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::REDUCTION)) {
			$modifiedColumns[':p' . $index++]  = '`REDUCTION`';
		}
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::REDUCTION_TYPE)) {
			$modifiedColumns[':p' . $index++]  = '`REDUCTION_TYPE`';
		}
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::FROM)) {
			$modifiedColumns[':p' . $index++]  = '`FROM`';
		}
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::TO)) {
			$modifiedColumns[':p' . $index++]  = '`TO`';
		}

		$sql = sprintf(
			'INSERT INTO `' .  _DB_PREFIX_ . 'specific_price` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_SpecificPricePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_SpecificPricePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_SpecificPrice'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_SpecificPrice'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_SpecificPricePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::ID_SPECIFIC_PRICE)) $criteria->add(Oops_Db_SpecificPricePeer::ID_SPECIFIC_PRICE, $this->id_specific_price);
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::ID_PRODUCT)) $criteria->add(Oops_Db_SpecificPricePeer::ID_PRODUCT, $this->id_product);
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::ID_SHOP)) $criteria->add(Oops_Db_SpecificPricePeer::ID_SHOP, $this->id_shop);
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::ID_CURRENCY)) $criteria->add(Oops_Db_SpecificPricePeer::ID_CURRENCY, $this->id_currency);
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::ID_COUNTRY)) $criteria->add(Oops_Db_SpecificPricePeer::ID_COUNTRY, $this->id_country);
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::ID_GROUP)) $criteria->add(Oops_Db_SpecificPricePeer::ID_GROUP, $this->id_group);
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::PRICE)) $criteria->add(Oops_Db_SpecificPricePeer::PRICE, $this->price);
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::FROM_QUANTITY)) $criteria->add(Oops_Db_SpecificPricePeer::FROM_QUANTITY, $this->from_quantity);
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::REDUCTION)) $criteria->add(Oops_Db_SpecificPricePeer::REDUCTION, $this->reduction);
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::REDUCTION_TYPE)) $criteria->add(Oops_Db_SpecificPricePeer::REDUCTION_TYPE, $this->reduction_type);
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::FROM)) $criteria->add(Oops_Db_SpecificPricePeer::FROM, $this->from);
		if ($this->isColumnModified(Oops_Db_SpecificPricePeer::TO)) $criteria->add(Oops_Db_SpecificPricePeer::TO, $this->to);
	...
	{
		$criteria = new Criteria(Oops_Db_SpecificPricePeer::DATABASE_NAME);
		$criteria->add(Oops_Db_SpecificPricePeer::ID_SPECIFIC_PRICE, $this->id_specific_price);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_SpecificPrice (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_SpecificPrice Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_SpecificPricePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_SpecificPricePeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_SpecificPricePeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_SpecificPrice
