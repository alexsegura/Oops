...
/**
 * Base class that represents a row from the 'customer_thread' table.
 *
 * 
 *
 * @package    propel.generator.prestashop.om
 */
abstract class Oops_Db_Propel_CustomerThread extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_CustomerThreadPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_CustomerThreadPeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_CustomerThread object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Db_CustomerThread The current object (for fluent API support)
	 */
	public function setIdCustomerThread($v)
	{
		...
		if ($this->id_customer_thread !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CustomerThreadPeer::ID_CUSTOMER_THREAD;
		}
	...
	public function setIdLang($v)
	{
		...
		if ($this->id_lang !== $v) {
			$this->id_lang = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerThreadPeer::ID_LANG;
		}
	...
	public function setIdContact($v)
	{
		...
		if ($this->id_contact !== $v) {
			$this->id_contact = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerThreadPeer::ID_CONTACT;
		}
	...
	public function setIdCustomer($v)
	{
		...
		if ($this->id_customer !== $v) {
			$this->id_customer = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerThreadPeer::ID_CUSTOMER;
		}
	...
	public function setIdOrder($v)
	{
		...
		if ($this->id_order !== $v) {
			$this->id_order = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerThreadPeer::ID_ORDER;
		}
	...
	public function setIdProduct($v)
	{
		...
		if ($this->id_product !== $v) {
			$this->id_product = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerThreadPeer::ID_PRODUCT;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerThreadPeer::STATUS;
		}
	...
	public function setEmail($v)
	{
		...
		if ($this->email !== $v) {
			$this->email = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerThreadPeer::EMAIL;
		}
	...
	public function setToken($v)
	{
		...
		if ($this->token !== $v) {
			$this->token = $v;
			$this->modifiedColumns[] = Oops_Db_CustomerThreadPeer::TOKEN;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_CustomerThreadPeer::DATE_ADD;
			}
	...
	public function setDateUpd($v)
	{
		...
		if ($this->date_upd !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_CustomerThreadPeer::DATE_UPD;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 11; // 11 = Oops_Db_CustomerThreadPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_CustomerThread object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_CustomerThreadPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_CustomerThreadQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_CustomerThreadPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::ID_CUSTOMER_THREAD)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CUSTOMER_THREAD`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::ID_LANG)) {
			$modifiedColumns[':p' . $index++]  = '`ID_LANG`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::ID_CONTACT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CONTACT`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::ID_CUSTOMER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CUSTOMER`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::ID_ORDER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ORDER`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::ID_PRODUCT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PRODUCT`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::STATUS)) {
			$modifiedColumns[':p' . $index++]  = '`STATUS`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::EMAIL)) {
			$modifiedColumns[':p' . $index++]  = '`EMAIL`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::TOKEN)) {
			$modifiedColumns[':p' . $index++]  = '`TOKEN`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::DATE_UPD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_UPD`';
		}

		$sql = sprintf(
			'INSERT INTO `' .  _DB_PREFIX_ . 'customer_thread` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_CustomerThreadPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_CustomerThreadPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_CustomerThread'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_CustomerThread'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_CustomerThreadPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::ID_CUSTOMER_THREAD)) $criteria->add(Oops_Db_CustomerThreadPeer::ID_CUSTOMER_THREAD, $this->id_customer_thread);
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::ID_LANG)) $criteria->add(Oops_Db_CustomerThreadPeer::ID_LANG, $this->id_lang);
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::ID_CONTACT)) $criteria->add(Oops_Db_CustomerThreadPeer::ID_CONTACT, $this->id_contact);
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::ID_CUSTOMER)) $criteria->add(Oops_Db_CustomerThreadPeer::ID_CUSTOMER, $this->id_customer);
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::ID_ORDER)) $criteria->add(Oops_Db_CustomerThreadPeer::ID_ORDER, $this->id_order);
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::ID_PRODUCT)) $criteria->add(Oops_Db_CustomerThreadPeer::ID_PRODUCT, $this->id_product);
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::STATUS)) $criteria->add(Oops_Db_CustomerThreadPeer::STATUS, $this->status);
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::EMAIL)) $criteria->add(Oops_Db_CustomerThreadPeer::EMAIL, $this->email);
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::TOKEN)) $criteria->add(Oops_Db_CustomerThreadPeer::TOKEN, $this->token);
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::DATE_ADD)) $criteria->add(Oops_Db_CustomerThreadPeer::DATE_ADD, $this->date_add);
		if ($this->isColumnModified(Oops_Db_CustomerThreadPeer::DATE_UPD)) $criteria->add(Oops_Db_CustomerThreadPeer::DATE_UPD, $this->date_upd);
	...
	{
		$criteria = new Criteria(Oops_Db_CustomerThreadPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_CustomerThreadPeer::ID_CUSTOMER_THREAD, $this->id_customer_thread);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_CustomerThread (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_CustomerThread Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_CustomerThreadPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_CustomerThreadPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_CustomerThreadPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_CustomerThread
