 ...
 */
abstract class Oops_Db_Propel_ConnectionsSource extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_ConnectionsSourcePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_ConnectionsSourcePeer
	 */
	 ...
	 * @return     Oops_Db_ConnectionsSource The current object (for fluent API support)
	 */
	public function setIdConnectionsSource($v)
	{
		...
		if ($this->id_connections_source !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ConnectionsSourcePeer::ID_CONNECTIONS_SOURCE;
		}
	...
	public function setIdConnections($v)
	{
		...
		if ($this->id_connections !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ConnectionsSourcePeer::ID_CONNECTIONS;
		}
	...
	public function setHttpReferer($v)
	{
		...
		if ($this->http_referer !== $v) {
			$this->http_referer = $v;
			$this->modifiedColumns[] = Oops_Db_ConnectionsSourcePeer::HTTP_REFERER;
		}
	...
	public function setRequestUri($v)
	{
		...
		if ($this->request_uri !== $v) {
			$this->request_uri = $v;
			$this->modifiedColumns[] = Oops_Db_ConnectionsSourcePeer::REQUEST_URI;
		}
	...
	public function setKeywords($v)
	{
		...
		if ($this->keywords !== $v) {
			$this->keywords = $v;
			$this->modifiedColumns[] = Oops_Db_ConnectionsSourcePeer::KEYWORDS;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_ConnectionsSourcePeer::DATE_ADD;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = Oops_Db_ConnectionsSourcePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_ConnectionsSource object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_ConnectionsSourcePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_ConnectionsSourceQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_ConnectionsSourcePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_ConnectionsSourcePeer::ID_CONNECTIONS_SOURCE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CONNECTIONS_SOURCE`';
		}
		if ($this->isColumnModified(Oops_Db_ConnectionsSourcePeer::ID_CONNECTIONS)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CONNECTIONS`';
		}
		if ($this->isColumnModified(Oops_Db_ConnectionsSourcePeer::HTTP_REFERER)) {
			$modifiedColumns[':p' . $index++]  = '`HTTP_REFERER`';
		}
		if ($this->isColumnModified(Oops_Db_ConnectionsSourcePeer::REQUEST_URI)) {
			$modifiedColumns[':p' . $index++]  = '`REQUEST_URI`';
		}
		if ($this->isColumnModified(Oops_Db_ConnectionsSourcePeer::KEYWORDS)) {
			$modifiedColumns[':p' . $index++]  = '`KEYWORDS`';
		}
		if ($this->isColumnModified(Oops_Db_ConnectionsSourcePeer::DATE_ADD)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_ConnectionsSourcePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_ConnectionsSourcePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_ConnectionsSource'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_ConnectionsSource'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_ConnectionsSourcePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_ConnectionsSourcePeer::ID_CONNECTIONS_SOURCE)) $criteria->add(Oops_Db_ConnectionsSourcePeer::ID_CONNECTIONS_SOURCE, $this->id_connections_source);
		if ($this->isColumnModified(Oops_Db_ConnectionsSourcePeer::ID_CONNECTIONS)) $criteria->add(Oops_Db_ConnectionsSourcePeer::ID_CONNECTIONS, $this->id_connections);
		if ($this->isColumnModified(Oops_Db_ConnectionsSourcePeer::HTTP_REFERER)) $criteria->add(Oops_Db_ConnectionsSourcePeer::HTTP_REFERER, $this->http_referer);
		if ($this->isColumnModified(Oops_Db_ConnectionsSourcePeer::REQUEST_URI)) $criteria->add(Oops_Db_ConnectionsSourcePeer::REQUEST_URI, $this->request_uri);
		if ($this->isColumnModified(Oops_Db_ConnectionsSourcePeer::KEYWORDS)) $criteria->add(Oops_Db_ConnectionsSourcePeer::KEYWORDS, $this->keywords);
		if ($this->isColumnModified(Oops_Db_ConnectionsSourcePeer::DATE_ADD)) $criteria->add(Oops_Db_ConnectionsSourcePeer::DATE_ADD, $this->date_add);
	...
	{
		$criteria = new Criteria(Oops_Db_ConnectionsSourcePeer::DATABASE_NAME);
		$criteria->add(Oops_Db_ConnectionsSourcePeer::ID_CONNECTIONS_SOURCE, $this->id_connections_source);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_ConnectionsSource (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_ConnectionsSource Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_ConnectionsSourcePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_ConnectionsSourcePeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_ConnectionsSourcePeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_ConnectionsSource
