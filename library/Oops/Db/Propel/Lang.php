 ...
 */
abstract class Oops_Db_Propel_Lang extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_LangPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_LangPeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_Lang object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Db_Lang The current object (for fluent API support)
	 */
	public function setIdLang($v)
	{
		...
		if ($this->id_lang !== $v) {
			$this->id_lang = $v;
			$this->modifiedColumns[] = Oops_Db_LangPeer::ID_LANG;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = Oops_Db_LangPeer::NAME;
		}
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v) {
			$this->active = $v;
			$this->modifiedColumns[] = Oops_Db_LangPeer::ACTIVE;
		}
	...
	public function setIsoCode($v)
	{
		...
		if ($this->iso_code !== $v) {
			$this->iso_code = $v;
			$this->modifiedColumns[] = Oops_Db_LangPeer::ISO_CODE;
		}
	...
	public function setLanguageCode($v)
	{
		...
		if ($this->language_code !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_LangPeer::LANGUAGE_CODE;
		}
	...
	public function setIsRtl($v)
	{
		...
		if ($this->is_rtl !== $v) {
			$this->is_rtl = $v;
			$this->modifiedColumns[] = Oops_Db_LangPeer::IS_RTL;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = Oops_Db_LangPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_Lang object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_LangPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_LangQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_LangPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_LangPeer::ID_LANG)) {
			$modifiedColumns[':p' . $index++]  = '`ID_LANG`';
		}
		if ($this->isColumnModified(Oops_Db_LangPeer::NAME)) {
			$modifiedColumns[':p' . $index++]  = '`NAME`';
		}
		if ($this->isColumnModified(Oops_Db_LangPeer::ACTIVE)) {
			$modifiedColumns[':p' . $index++]  = '`ACTIVE`';
		}
		if ($this->isColumnModified(Oops_Db_LangPeer::ISO_CODE)) {
			$modifiedColumns[':p' . $index++]  = '`ISO_CODE`';
		}
		if ($this->isColumnModified(Oops_Db_LangPeer::LANGUAGE_CODE)) {
			$modifiedColumns[':p' . $index++]  = '`LANGUAGE_CODE`';
		}
		if ($this->isColumnModified(Oops_Db_LangPeer::IS_RTL)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_LangPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_LangPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_Lang'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_Lang'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_LangPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_LangPeer::ID_LANG)) $criteria->add(Oops_Db_LangPeer::ID_LANG, $this->id_lang);
		if ($this->isColumnModified(Oops_Db_LangPeer::NAME)) $criteria->add(Oops_Db_LangPeer::NAME, $this->name);
		if ($this->isColumnModified(Oops_Db_LangPeer::ACTIVE)) $criteria->add(Oops_Db_LangPeer::ACTIVE, $this->active);
		if ($this->isColumnModified(Oops_Db_LangPeer::ISO_CODE)) $criteria->add(Oops_Db_LangPeer::ISO_CODE, $this->iso_code);
		if ($this->isColumnModified(Oops_Db_LangPeer::LANGUAGE_CODE)) $criteria->add(Oops_Db_LangPeer::LANGUAGE_CODE, $this->language_code);
		if ($this->isColumnModified(Oops_Db_LangPeer::IS_RTL)) $criteria->add(Oops_Db_LangPeer::IS_RTL, $this->is_rtl);
	...
	{
		$criteria = new Criteria(Oops_Db_LangPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_LangPeer::ID_LANG, $this->id_lang);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_Lang (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_Lang Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_LangPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_LangPeer();
		}
		return self::$peer;
	}
	 ...
	 * If this Oops_Db_Lang is new, it will return
	...
	public function setCategories(PropelCollection $categories, PropelPDO $con = null)
	{
		...
		$this->categoriesScheduledForDeletion = $this->getCategoryLangs()->diff($oops_Db_CategoryLangs);
	 ...
	 *
	 * @param      Oops_Db_Category $category The Oops_Db_CategoryLang object to relate
	 * @return     void
	 */
	...
	{
		return (string) $this->exportTo(Oops_Db_LangPeer::DEFAULT_STRING_FORMAT);
	}
