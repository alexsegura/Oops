 ...
 */
abstract class Oops_Db_Propel_Carrier extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_CarrierPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_CarrierPeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_Carrier object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Db_Carrier The current object (for fluent API support)
	 */
	public function setIdCarrier($v)
	{
		...
		if ($this->id_carrier !== $v) {
			$this->id_carrier = $v;
			$this->modifiedColumns[] = Oops_Db_CarrierPeer::ID_CARRIER;
		}
	...
	public function setIdTaxRulesGroup($v)
	{
		...
		if ($this->id_tax_rules_group !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CarrierPeer::ID_TAX_RULES_GROUP;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = Oops_Db_CarrierPeer::NAME;
		}
	...
	public function setUrl($v)
	{
		...
		if ($this->url !== $v) {
			$this->url = $v;
			$this->modifiedColumns[] = Oops_Db_CarrierPeer::URL;
		}
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v) {
			$this->active = $v;
			$this->modifiedColumns[] = Oops_Db_CarrierPeer::ACTIVE;
		}
	...
	public function setDeleted($v)
	{
		...
		if ($this->deleted !== $v) {
			$this->deleted = $v;
			$this->modifiedColumns[] = Oops_Db_CarrierPeer::DELETED;
		}
	...
	public function setShippingHandling($v)
	{
		...
		if ($this->shipping_handling !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CarrierPeer::SHIPPING_HANDLING;
		}
	...
	public function setRangeBehavior($v)
	{
		...
		if ($this->range_behavior !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CarrierPeer::RANGE_BEHAVIOR;
		}
	...
	public function setIsModule($v)
	{
		...
		if ($this->is_module !== $v) {
			$this->is_module = $v;
			$this->modifiedColumns[] = Oops_Db_CarrierPeer::IS_MODULE;
		}
	...
	public function setIsFree($v)
	{
		...
		if ($this->is_free !== $v) {
			$this->is_free = $v;
			$this->modifiedColumns[] = Oops_Db_CarrierPeer::IS_FREE;
		}
	...
	public function setShippingExternal($v)
	{
		...
		if ($this->shipping_external !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CarrierPeer::SHIPPING_EXTERNAL;
		}
	...
	public function setNeedRange($v)
	{
		...
		if ($this->need_range !== $v) {
			$this->need_range = $v;
			$this->modifiedColumns[] = Oops_Db_CarrierPeer::NEED_RANGE;
		}
	...
	public function setExternalModuleName($v)
	{
		...
		if ($this->external_module_name !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CarrierPeer::EXTERNAL_MODULE_NAME;
		}
	...
	public function setShippingMethod($v)
	{
		...
		if ($this->shipping_method !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_CarrierPeer::SHIPPING_METHOD;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 14; // 14 = Oops_Db_CarrierPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_Carrier object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_CarrierPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_CarrierQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_CarrierPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_CarrierPeer::ID_CARRIER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CARRIER`';
		}
		if ($this->isColumnModified(Oops_Db_CarrierPeer::ID_TAX_RULES_GROUP)) {
			$modifiedColumns[':p' . $index++]  = '`ID_TAX_RULES_GROUP`';
		}
		if ($this->isColumnModified(Oops_Db_CarrierPeer::NAME)) {
			$modifiedColumns[':p' . $index++]  = '`NAME`';
		}
		if ($this->isColumnModified(Oops_Db_CarrierPeer::URL)) {
			$modifiedColumns[':p' . $index++]  = '`URL`';
		}
		if ($this->isColumnModified(Oops_Db_CarrierPeer::ACTIVE)) {
			$modifiedColumns[':p' . $index++]  = '`ACTIVE`';
		}
		if ($this->isColumnModified(Oops_Db_CarrierPeer::DELETED)) {
			$modifiedColumns[':p' . $index++]  = '`DELETED`';
		}
		if ($this->isColumnModified(Oops_Db_CarrierPeer::SHIPPING_HANDLING)) {
			$modifiedColumns[':p' . $index++]  = '`SHIPPING_HANDLING`';
		}
		if ($this->isColumnModified(Oops_Db_CarrierPeer::RANGE_BEHAVIOR)) {
			$modifiedColumns[':p' . $index++]  = '`RANGE_BEHAVIOR`';
		}
		if ($this->isColumnModified(Oops_Db_CarrierPeer::IS_MODULE)) {
			$modifiedColumns[':p' . $index++]  = '`IS_MODULE`';
		}
		if ($this->isColumnModified(Oops_Db_CarrierPeer::IS_FREE)) {
			$modifiedColumns[':p' . $index++]  = '`IS_FREE`';
		}
		if ($this->isColumnModified(Oops_Db_CarrierPeer::SHIPPING_EXTERNAL)) {
			$modifiedColumns[':p' . $index++]  = '`SHIPPING_EXTERNAL`';
		}
		if ($this->isColumnModified(Oops_Db_CarrierPeer::NEED_RANGE)) {
			$modifiedColumns[':p' . $index++]  = '`NEED_RANGE`';
		}
		if ($this->isColumnModified(Oops_Db_CarrierPeer::EXTERNAL_MODULE_NAME)) {
			$modifiedColumns[':p' . $index++]  = '`EXTERNAL_MODULE_NAME`';
		}
		if ($this->isColumnModified(Oops_Db_CarrierPeer::SHIPPING_METHOD)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_CarrierPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_CarrierPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_Carrier'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_Carrier'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_CarrierPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_CarrierPeer::ID_CARRIER)) $criteria->add(Oops_Db_CarrierPeer::ID_CARRIER, $this->id_carrier);
		if ($this->isColumnModified(Oops_Db_CarrierPeer::ID_TAX_RULES_GROUP)) $criteria->add(Oops_Db_CarrierPeer::ID_TAX_RULES_GROUP, $this->id_tax_rules_group);
		if ($this->isColumnModified(Oops_Db_CarrierPeer::NAME)) $criteria->add(Oops_Db_CarrierPeer::NAME, $this->name);
		if ($this->isColumnModified(Oops_Db_CarrierPeer::URL)) $criteria->add(Oops_Db_CarrierPeer::URL, $this->url);
		if ($this->isColumnModified(Oops_Db_CarrierPeer::ACTIVE)) $criteria->add(Oops_Db_CarrierPeer::ACTIVE, $this->active);
		if ($this->isColumnModified(Oops_Db_CarrierPeer::DELETED)) $criteria->add(Oops_Db_CarrierPeer::DELETED, $this->deleted);
		if ($this->isColumnModified(Oops_Db_CarrierPeer::SHIPPING_HANDLING)) $criteria->add(Oops_Db_CarrierPeer::SHIPPING_HANDLING, $this->shipping_handling);
		if ($this->isColumnModified(Oops_Db_CarrierPeer::RANGE_BEHAVIOR)) $criteria->add(Oops_Db_CarrierPeer::RANGE_BEHAVIOR, $this->range_behavior);
		if ($this->isColumnModified(Oops_Db_CarrierPeer::IS_MODULE)) $criteria->add(Oops_Db_CarrierPeer::IS_MODULE, $this->is_module);
		if ($this->isColumnModified(Oops_Db_CarrierPeer::IS_FREE)) $criteria->add(Oops_Db_CarrierPeer::IS_FREE, $this->is_free);
		if ($this->isColumnModified(Oops_Db_CarrierPeer::SHIPPING_EXTERNAL)) $criteria->add(Oops_Db_CarrierPeer::SHIPPING_EXTERNAL, $this->shipping_external);
		if ($this->isColumnModified(Oops_Db_CarrierPeer::NEED_RANGE)) $criteria->add(Oops_Db_CarrierPeer::NEED_RANGE, $this->need_range);
		if ($this->isColumnModified(Oops_Db_CarrierPeer::EXTERNAL_MODULE_NAME)) $criteria->add(Oops_Db_CarrierPeer::EXTERNAL_MODULE_NAME, $this->external_module_name);
		if ($this->isColumnModified(Oops_Db_CarrierPeer::SHIPPING_METHOD)) $criteria->add(Oops_Db_CarrierPeer::SHIPPING_METHOD, $this->shipping_method);
	...
	{
		$criteria = new Criteria(Oops_Db_CarrierPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_CarrierPeer::ID_CARRIER, $this->id_carrier);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_Carrier (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_Carrier Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_CarrierPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_CarrierPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_CarrierPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_Carrier
