...
/**
 * Base class that represents a row from the 'feature_lang' table.
 *
 * 
 *
 * @package    propel.generator.prestashop.om
 */
abstract class Oops_Db_Propel_FeatureLang extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_FeatureLangPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_FeatureLangPeer
	 */
	 ...
	 * @return     Oops_Db_FeatureLang The current object (for fluent API support)
	 */
	public function setIdFeature($v)
	{
		...
		if ($this->id_feature !== $v) {
			$this->id_feature = $v;
			$this->modifiedColumns[] = Oops_Db_FeatureLangPeer::ID_FEATURE;
		}
	...
	public function setIdLang($v)
	{
		...
		if ($this->id_lang !== $v) {
			$this->id_lang = $v;
			$this->modifiedColumns[] = Oops_Db_FeatureLangPeer::ID_LANG;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = Oops_Db_FeatureLangPeer::NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = Oops_Db_FeatureLangPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_FeatureLang object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_FeatureLangPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_FeatureLangQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_FeatureLangPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_FeatureLangPeer::ID_FEATURE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_FEATURE`';
		}
		if ($this->isColumnModified(Oops_Db_FeatureLangPeer::ID_LANG)) {
			$modifiedColumns[':p' . $index++]  = '`ID_LANG`';
		}
		if ($this->isColumnModified(Oops_Db_FeatureLangPeer::NAME)) {
			$modifiedColumns[':p' . $index++]  = '`NAME`';
		}

		$sql = sprintf(
			'INSERT INTO `' .  _DB_PREFIX_ . 'feature_lang` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_FeatureLangPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_FeatureLangPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_FeatureLang'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_FeatureLang'][serialize($this->getPrimaryKey())] = true;
		$keys = Oops_Db_FeatureLangPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_FeatureLangPeer::ID_FEATURE)) $criteria->add(Oops_Db_FeatureLangPeer::ID_FEATURE, $this->id_feature);
		if ($this->isColumnModified(Oops_Db_FeatureLangPeer::ID_LANG)) $criteria->add(Oops_Db_FeatureLangPeer::ID_LANG, $this->id_lang);
		if ($this->isColumnModified(Oops_Db_FeatureLangPeer::NAME)) $criteria->add(Oops_Db_FeatureLangPeer::NAME, $this->name);
	...
	{
		$criteria = new Criteria(Oops_Db_FeatureLangPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_FeatureLangPeer::ID_FEATURE, $this->id_feature);
		$criteria->add(Oops_Db_FeatureLangPeer::ID_LANG, $this->id_lang);
	...
	{
		return (null === $this->getIdFeature()) && (null === $this->getIdLang());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_FeatureLang (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_FeatureLang Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_FeatureLangPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_FeatureLangPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_FeatureLangPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_FeatureLang
