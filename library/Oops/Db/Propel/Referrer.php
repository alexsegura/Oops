 ...
 */
abstract class Oops_Db_Propel_Referrer extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Db_ReferrerPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Db_ReferrerPeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Db_Propel_Referrer object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Db_Referrer The current object (for fluent API support)
	 */
	public function setIdReferrer($v)
	{
		...
		if ($this->id_referrer !== $v) {
			$this->id_referrer = $v;
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::ID_REFERRER;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::NAME;
		}
	...
	public function setPasswd($v)
	{
		...
		if ($this->passwd !== $v) {
			$this->passwd = $v;
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::PASSWD;
		}
	...
	public function setHttpRefererRegexp($v)
	{
		...
		if ($this->http_referer_regexp !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::HTTP_REFERER_REGEXP;
		}
	...
	public function setHttpRefererLike($v)
	{
		...
		if ($this->http_referer_like !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::HTTP_REFERER_LIKE;
		}
	...
	public function setRequestUriRegexp($v)
	{
		...
		if ($this->request_uri_regexp !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::REQUEST_URI_REGEXP;
		}
	...
	public function setRequestUriLike($v)
	{
		...
		if ($this->request_uri_like !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::REQUEST_URI_LIKE;
		}
	...
	public function setHttpRefererRegexpNot($v)
	{
		...
		if ($this->http_referer_regexp_not !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::HTTP_REFERER_REGEXP_NOT;
		}
	...
	public function setHttpRefererLikeNot($v)
	{
		...
		if ($this->http_referer_like_not !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::HTTP_REFERER_LIKE_NOT;
		}
	...
	public function setRequestUriRegexpNot($v)
	{
		...
		if ($this->request_uri_regexp_not !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::REQUEST_URI_REGEXP_NOT;
		}
	...
	public function setRequestUriLikeNot($v)
	{
		...
		if ($this->request_uri_like_not !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::REQUEST_URI_LIKE_NOT;
		}
	...
	public function setBaseFee($v)
	{
		...
		if ($this->base_fee !== $v) {
			$this->base_fee = $v;
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::BASE_FEE;
		}
	...
	public function setPercentFee($v)
	{
		...
		if ($this->percent_fee !== $v) {
			$this->percent_fee = $v;
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::PERCENT_FEE;
		}
	...
	public function setClickFee($v)
	{
		...
		if ($this->click_fee !== $v) {
			$this->click_fee = $v;
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::CLICK_FEE;
		}
	...
	public function setCacheVisitors($v)
	{
		...
		if ($this->cache_visitors !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::CACHE_VISITORS;
		}
	...
	public function setCacheVisits($v)
	{
		...
		if ($this->cache_visits !== $v) {
			$this->cache_visits = $v;
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::CACHE_VISITS;
		}
	...
	public function setCachePages($v)
	{
		...
		if ($this->cache_pages !== $v) {
			$this->cache_pages = $v;
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::CACHE_PAGES;
		}
	...
	public function setCacheRegistrations($v)
	{
		...
		if ($this->cache_registrations !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::CACHE_REGISTRATIONS;
		}
	...
	public function setCacheOrders($v)
	{
		...
		if ($this->cache_orders !== $v) {
			$this->cache_orders = $v;
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::CACHE_ORDERS;
		}
	...
	public function setCacheSales($v)
	{
		...
		if ($this->cache_sales !== $v) {
			$this->cache_sales = $v;
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::CACHE_SALES;
		}
	...
	public function setCacheRegRate($v)
	{
		...
		if ($this->cache_reg_rate !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::CACHE_REG_RATE;
		}
	...
	public function setCacheOrderRate($v)
	{
		...
		if ($this->cache_order_rate !== $v) {
			...
			$this->modifiedColumns[] = Oops_Db_ReferrerPeer::CACHE_ORDER_RATE;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Db_ReferrerPeer::DATE_ADD;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 23; // 23 = Oops_Db_ReferrerPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Db_Referrer object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Db_ReferrerPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Db_ReferrerQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Db_ReferrerPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::ID_REFERRER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_REFERRER`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::NAME)) {
			$modifiedColumns[':p' . $index++]  = '`NAME`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::PASSWD)) {
			$modifiedColumns[':p' . $index++]  = '`PASSWD`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::HTTP_REFERER_REGEXP)) {
			$modifiedColumns[':p' . $index++]  = '`HTTP_REFERER_REGEXP`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::HTTP_REFERER_LIKE)) {
			$modifiedColumns[':p' . $index++]  = '`HTTP_REFERER_LIKE`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::REQUEST_URI_REGEXP)) {
			$modifiedColumns[':p' . $index++]  = '`REQUEST_URI_REGEXP`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::REQUEST_URI_LIKE)) {
			$modifiedColumns[':p' . $index++]  = '`REQUEST_URI_LIKE`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::HTTP_REFERER_REGEXP_NOT)) {
			$modifiedColumns[':p' . $index++]  = '`HTTP_REFERER_REGEXP_NOT`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::HTTP_REFERER_LIKE_NOT)) {
			$modifiedColumns[':p' . $index++]  = '`HTTP_REFERER_LIKE_NOT`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::REQUEST_URI_REGEXP_NOT)) {
			$modifiedColumns[':p' . $index++]  = '`REQUEST_URI_REGEXP_NOT`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::REQUEST_URI_LIKE_NOT)) {
			$modifiedColumns[':p' . $index++]  = '`REQUEST_URI_LIKE_NOT`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::BASE_FEE)) {
			$modifiedColumns[':p' . $index++]  = '`BASE_FEE`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::PERCENT_FEE)) {
			$modifiedColumns[':p' . $index++]  = '`PERCENT_FEE`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CLICK_FEE)) {
			$modifiedColumns[':p' . $index++]  = '`CLICK_FEE`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_VISITORS)) {
			$modifiedColumns[':p' . $index++]  = '`CACHE_VISITORS`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_VISITS)) {
			$modifiedColumns[':p' . $index++]  = '`CACHE_VISITS`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_PAGES)) {
			$modifiedColumns[':p' . $index++]  = '`CACHE_PAGES`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_REGISTRATIONS)) {
			$modifiedColumns[':p' . $index++]  = '`CACHE_REGISTRATIONS`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_ORDERS)) {
			$modifiedColumns[':p' . $index++]  = '`CACHE_ORDERS`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_SALES)) {
			$modifiedColumns[':p' . $index++]  = '`CACHE_SALES`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_REG_RATE)) {
			$modifiedColumns[':p' . $index++]  = '`CACHE_REG_RATE`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_ORDER_RATE)) {
			$modifiedColumns[':p' . $index++]  = '`CACHE_ORDER_RATE`';
		}
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::DATE_ADD)) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Db_ReferrerPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Db_ReferrerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Db_Referrer'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Db_Referrer'][$this->getPrimaryKey()] = true;
		$keys = Oops_Db_ReferrerPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::ID_REFERRER)) $criteria->add(Oops_Db_ReferrerPeer::ID_REFERRER, $this->id_referrer);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::NAME)) $criteria->add(Oops_Db_ReferrerPeer::NAME, $this->name);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::PASSWD)) $criteria->add(Oops_Db_ReferrerPeer::PASSWD, $this->passwd);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::HTTP_REFERER_REGEXP)) $criteria->add(Oops_Db_ReferrerPeer::HTTP_REFERER_REGEXP, $this->http_referer_regexp);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::HTTP_REFERER_LIKE)) $criteria->add(Oops_Db_ReferrerPeer::HTTP_REFERER_LIKE, $this->http_referer_like);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::REQUEST_URI_REGEXP)) $criteria->add(Oops_Db_ReferrerPeer::REQUEST_URI_REGEXP, $this->request_uri_regexp);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::REQUEST_URI_LIKE)) $criteria->add(Oops_Db_ReferrerPeer::REQUEST_URI_LIKE, $this->request_uri_like);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::HTTP_REFERER_REGEXP_NOT)) $criteria->add(Oops_Db_ReferrerPeer::HTTP_REFERER_REGEXP_NOT, $this->http_referer_regexp_not);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::HTTP_REFERER_LIKE_NOT)) $criteria->add(Oops_Db_ReferrerPeer::HTTP_REFERER_LIKE_NOT, $this->http_referer_like_not);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::REQUEST_URI_REGEXP_NOT)) $criteria->add(Oops_Db_ReferrerPeer::REQUEST_URI_REGEXP_NOT, $this->request_uri_regexp_not);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::REQUEST_URI_LIKE_NOT)) $criteria->add(Oops_Db_ReferrerPeer::REQUEST_URI_LIKE_NOT, $this->request_uri_like_not);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::BASE_FEE)) $criteria->add(Oops_Db_ReferrerPeer::BASE_FEE, $this->base_fee);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::PERCENT_FEE)) $criteria->add(Oops_Db_ReferrerPeer::PERCENT_FEE, $this->percent_fee);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CLICK_FEE)) $criteria->add(Oops_Db_ReferrerPeer::CLICK_FEE, $this->click_fee);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_VISITORS)) $criteria->add(Oops_Db_ReferrerPeer::CACHE_VISITORS, $this->cache_visitors);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_VISITS)) $criteria->add(Oops_Db_ReferrerPeer::CACHE_VISITS, $this->cache_visits);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_PAGES)) $criteria->add(Oops_Db_ReferrerPeer::CACHE_PAGES, $this->cache_pages);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_REGISTRATIONS)) $criteria->add(Oops_Db_ReferrerPeer::CACHE_REGISTRATIONS, $this->cache_registrations);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_ORDERS)) $criteria->add(Oops_Db_ReferrerPeer::CACHE_ORDERS, $this->cache_orders);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_SALES)) $criteria->add(Oops_Db_ReferrerPeer::CACHE_SALES, $this->cache_sales);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_REG_RATE)) $criteria->add(Oops_Db_ReferrerPeer::CACHE_REG_RATE, $this->cache_reg_rate);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::CACHE_ORDER_RATE)) $criteria->add(Oops_Db_ReferrerPeer::CACHE_ORDER_RATE, $this->cache_order_rate);
		if ($this->isColumnModified(Oops_Db_ReferrerPeer::DATE_ADD)) $criteria->add(Oops_Db_ReferrerPeer::DATE_ADD, $this->date_add);
	...
	{
		$criteria = new Criteria(Oops_Db_ReferrerPeer::DATABASE_NAME);
		$criteria->add(Oops_Db_ReferrerPeer::ID_REFERRER, $this->id_referrer);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Db_Referrer (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Db_Referrer Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Db_ReferrerPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Db_ReferrerPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Db_ReferrerPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Db_Propel_Referrer
