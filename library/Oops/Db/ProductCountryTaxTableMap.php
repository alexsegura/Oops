 ...
 */
class Oops_Db_ProductCountryTaxTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_ProductCountryTaxTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_ProductCountryTax');
...
} // Oops_Db_ProductCountryTaxTableMap
