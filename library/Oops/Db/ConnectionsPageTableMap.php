 ...
 */
class Oops_Db_ConnectionsPageTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_ConnectionsPageTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_ConnectionsPage');
...
} // Oops_Db_ConnectionsPageTableMap
