 ...
 */
class Oops_Db_TaxRuleTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_TaxRuleTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'tax_rule');
		$this->setPhpName('TaxRule');
		$this->setClassname('Oops_Db_TaxRule');
