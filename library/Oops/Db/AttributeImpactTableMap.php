 ...
 */
class Oops_Db_AttributeImpactTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Db_AttributeImpactTableMap';
	...
	public function initialize()
	{
		...
		$this->setClassname('Oops_Db_AttributeImpact');
...
} // Oops_Db_AttributeImpactTableMap
