 ...
 */
class Oops_Model_ProductAttributeCombinationTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_ProductAttributeCombinationTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_product_attribute_combination');
...
} // Oops_Model_ProductAttributeCombinationTableMap
