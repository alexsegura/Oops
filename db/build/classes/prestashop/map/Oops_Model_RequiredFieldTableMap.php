 ...
 */
class Oops_Model_RequiredFieldTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_RequiredFieldTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_required_field');
...
} // Oops_Model_RequiredFieldTableMap
