 ...
 */
class Oops_Model_SubdomainTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_SubdomainTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_subdomain');
