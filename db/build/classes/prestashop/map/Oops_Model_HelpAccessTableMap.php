 ...
 */
class Oops_Model_HelpAccessTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_HelpAccessTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_help_access');
