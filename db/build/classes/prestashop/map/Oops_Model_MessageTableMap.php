 ...
 */
class Oops_Model_MessageTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_MessageTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_message');
