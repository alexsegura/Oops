...
/**
 * This class defines the structure of the 'djland_connections_source' table.
 *
 *
 *
 ...
 */
class Oops_Model_ConnectionsSourceTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_ConnectionsSourceTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_connections_source');
		$this->setPhpName('ConnectionsSource');
		$this->setClassname('Oops_Model_ConnectionsSource');
...
} // Oops_Model_ConnectionsSourceTableMap
