 ...
 */
class Oops_Model_ProfileLangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_ProfileLangTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_profile_lang');
...
} // Oops_Model_ProfileLangTableMap
