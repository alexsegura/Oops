 ...
 */
class Oops_Model_WebBrowserTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_WebBrowserTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_web_browser');
