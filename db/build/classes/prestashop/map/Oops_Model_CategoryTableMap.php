 ...
 */
class Oops_Model_CategoryTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_CategoryTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_category');
	...
	{
		$this->addRelation('CategoryLang', 'Oops_Model_CategoryLang', RelationMap::ONE_TO_MANY, array('id_category' => 'id_category', ), null, null, 'CategoryLangs');
		$this->addRelation('CategoryProduct', 'Oops_Model_CategoryProduct', RelationMap::ONE_TO_MANY, array('id_category' => 'id_category', ), null, null, 'CategoryProducts');
		$this->addRelation('Lang', 'Oops_Model_Lang', RelationMap::MANY_TO_MANY, array(), null, null, 'Langs');
		$this->addRelation('Product', 'Oops_Model_Product', RelationMap::MANY_TO_MANY, array(), null, null, 'Products');
	} // buildRelations()
