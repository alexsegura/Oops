 ...
 */
class Oops_Model_CompareProductTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_CompareProductTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_compare_product');
...
} // Oops_Model_CompareProductTableMap
