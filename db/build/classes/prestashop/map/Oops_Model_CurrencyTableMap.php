...
/**
 * This class defines the structure of the 'djland_currency' table.
 *
 *
 *
 ...
 */
class Oops_Model_CurrencyTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_CurrencyTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_currency');
		$this->setPhpName('Currency');
		$this->setClassname('Oops_Model_Currency');
