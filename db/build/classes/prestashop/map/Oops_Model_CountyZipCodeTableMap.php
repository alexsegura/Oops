 ...
 */
class Oops_Model_CountyZipCodeTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_CountyZipCodeTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_county_zip_code');
...
} // Oops_Model_CountyZipCodeTableMap
