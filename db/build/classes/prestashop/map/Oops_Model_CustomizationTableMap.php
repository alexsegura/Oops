...
/**
 * This class defines the structure of the 'djland_customization' table.
 *
 *
 *
 ...
 */
class Oops_Model_CustomizationTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_CustomizationTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_customization');
		$this->setPhpName('Customization');
		$this->setClassname('Oops_Model_Customization');
...
} // Oops_Model_CustomizationTableMap
