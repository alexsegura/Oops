 ...
 */
class Oops_Model_ManufacturerLangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_ManufacturerLangTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_manufacturer_lang');
...
} // Oops_Model_ManufacturerLangTableMap
