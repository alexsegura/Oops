...
/**
 * This class defines the structure of the 'djland_orders' table.
 *
 *
 *
 ...
 */
class Oops_Model_OrdersTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_OrdersTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_orders');
		$this->setPhpName('Orders');
		$this->setClassname('Oops_Model_Orders');
