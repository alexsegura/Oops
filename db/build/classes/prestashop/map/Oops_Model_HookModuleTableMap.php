 ...
 */
class Oops_Model_HookModuleTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_HookModuleTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_hook_module');
		...
		$this->addColumn('POSITION', 'Position', 'TINYINT', true, 2, null);
		// validators
	} // initialize()
