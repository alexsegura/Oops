 ...
 */
class Oops_Model_ModuleTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_ModuleTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_module');
