 ...
 */
class Oops_Model_ProductGroupReductionCacheTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_ProductGroupReductionCacheTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_product_group_reduction_cache');
...
} // Oops_Model_ProductGroupReductionCacheTableMap
