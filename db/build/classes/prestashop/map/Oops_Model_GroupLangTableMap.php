 ...
 */
class Oops_Model_GroupLangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_GroupLangTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_group_lang');
