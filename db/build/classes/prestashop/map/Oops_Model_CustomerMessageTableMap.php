 ...
 */
class Oops_Model_CustomerMessageTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_CustomerMessageTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_customer_message');
...
} // Oops_Model_CustomerMessageTableMap
