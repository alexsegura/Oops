...
/**
 * This class defines the structure of the 'djland_order_history' table.
 *
 *
 *
 ...
 */
class Oops_Model_OrderHistoryTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_OrderHistoryTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_order_history');
		$this->setPhpName('OrderHistory');
		$this->setClassname('Oops_Model_OrderHistory');
...
} // Oops_Model_OrderHistoryTableMap
