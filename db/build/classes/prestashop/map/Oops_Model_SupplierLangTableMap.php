...
/**
 * This class defines the structure of the 'djland_supplier_lang' table.
 *
 *
 *
 ...
 */
class Oops_Model_SupplierLangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_SupplierLangTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_supplier_lang');
		$this->setPhpName('SupplierLang');
		$this->setClassname('Oops_Model_SupplierLang');
...
} // Oops_Model_SupplierLangTableMap
