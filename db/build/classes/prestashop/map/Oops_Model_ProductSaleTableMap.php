 ...
 */
class Oops_Model_ProductSaleTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_ProductSaleTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_product_sale');
...
} // Oops_Model_ProductSaleTableMap
