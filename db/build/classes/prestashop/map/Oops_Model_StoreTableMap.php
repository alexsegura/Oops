...
/**
 * This class defines the structure of the 'djland_store' table.
 *
 *
 *
 ...
 */
class Oops_Model_StoreTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_StoreTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_store');
		$this->setPhpName('Store');
		$this->setClassname('Oops_Model_Store');
