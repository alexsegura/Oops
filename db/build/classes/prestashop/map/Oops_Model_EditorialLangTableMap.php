...
/**
 * This class defines the structure of the 'djland_editorial_lang' table.
 *
 *
 *
 ...
 */
class Oops_Model_EditorialLangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_EditorialLangTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_editorial_lang');
		$this->setPhpName('EditorialLang');
		$this->setClassname('Oops_Model_EditorialLang');
...
} // Oops_Model_EditorialLangTableMap
