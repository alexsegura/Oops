 ...
 */
class Oops_Model_CarrierLangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_CarrierLangTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_carrier_lang');
...
} // Oops_Model_CarrierLangTableMap
