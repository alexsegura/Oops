 ...
 */
class Oops_Model_SceneLangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_SceneLangTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_scene_lang');
