...
/**
 * This class defines the structure of the 'djland_category_lang' table.
 *
 *
 *
 ...
 */
class Oops_Model_CategoryLangTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_CategoryLangTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_category_lang');
		$this->setPhpName('CategoryLang');
		$this->setClassname('Oops_Model_CategoryLang');
...
} // Oops_Model_CategoryLangTableMap
