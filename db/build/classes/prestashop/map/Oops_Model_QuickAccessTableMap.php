 ...
 */
class Oops_Model_QuickAccessTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_QuickAccessTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_quick_access');
		...
		$this->addColumn('NEW_WINDOW', 'NewWindow', 'BOOLEAN', true, 1, false);
...
} // Oops_Model_QuickAccessTableMap
