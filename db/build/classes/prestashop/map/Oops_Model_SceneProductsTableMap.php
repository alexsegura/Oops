 ...
 */
class Oops_Model_SceneProductsTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_SceneProductsTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_scene_products');
...
} // Oops_Model_SceneProductsTableMap
