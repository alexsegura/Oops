 ...
 */
class Oops_Model_WebserviceAccountTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_WebserviceAccountTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_webservice_account');
...
} // Oops_Model_WebserviceAccountTableMap
