 ...
 */
class Oops_Model_CustomerTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_CustomerTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_customer');
