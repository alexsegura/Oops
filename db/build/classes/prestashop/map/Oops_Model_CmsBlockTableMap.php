...
/**
 * This class defines the structure of the 'djland_cms_block' table.
 *
 *
 *
 ...
 */
class Oops_Model_CmsBlockTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_CmsBlockTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_cms_block');
		$this->setPhpName('CmsBlock');
		$this->setClassname('Oops_Model_CmsBlock');
