 ...
 */
class Oops_Model_StockMvtReasonTableMap extends TableMap
{

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'prestashop.map.Oops_Model_StockMvtReasonTableMap';
	...
	{
		// attributes
		$this->setName(_DB_PREFIX_ . 'djland_stock_mvt_reason');
	...
	{
		$this->addRelation('StockMvt', 'Oops_Model_StockMvt', RelationMap::MANY_TO_ONE, array('id_stock_mvt_reason' => 'id_stock_mvt_reason', ), null, null);
	} // buildRelations()

} // Oops_Model_StockMvtReasonTableMap
