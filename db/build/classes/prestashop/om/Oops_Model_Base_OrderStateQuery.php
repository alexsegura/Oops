...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_order_state' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_OrderStateQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_ORDER_STATE`, `INVOICE`, `SEND_EMAIL`, `COLOR`, `UNREMOVABLE`, `HIDDEN`, `LOGABLE`, `DELIVERY` FROM `' . _DB_PREFIX_ . 'djland_order_state` WHERE `ID_ORDER_STATE` = :p0';
		try {
