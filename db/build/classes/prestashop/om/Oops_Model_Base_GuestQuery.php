...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_guest' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_GuestQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_GUEST`, `ID_OPERATING_SYSTEM`, `ID_WEB_BROWSER`, `ID_CUSTOMER`, `JAVASCRIPT`, `SCREEN_RESOLUTION_X`, `SCREEN_RESOLUTION_Y`, `SCREEN_COLOR`, `SUN_JAVA`, `ADOBE_FLASH`, `ADOBE_DIRECTOR`, `APPLE_QUICKTIME`, `REAL_PLAYER`, `WINDOWS_MEDIA`, `ACCEPT_LANGUAGE` FROM `' . _DB_PREFIX_ . 'djland_guest` WHERE `ID_GUEST` = :p0';
		try {
