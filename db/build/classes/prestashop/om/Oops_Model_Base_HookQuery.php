...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_hook' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_HookQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_HOOK`, `NAME`, `TITLE`, `DESCRIPTION`, `POSITION`, `LIVE_EDIT` FROM `' . _DB_PREFIX_ . 'djland_hook` WHERE `ID_HOOK` = :p0';
		try {
