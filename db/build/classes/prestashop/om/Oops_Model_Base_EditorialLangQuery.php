...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_editorial_lang' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_EditorialLangQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_EDITORIAL`, `ID_LANG`, `BODY_TITLE`, `BODY_SUBHEADING`, `BODY_PARAGRAPH`, `BODY_LOGO_SUBHEADING` FROM `' . _DB_PREFIX_ . 'djland_editorial_lang` WHERE `ID_EDITORIAL` = :p0 AND `ID_LANG` = :p1';
		try {
