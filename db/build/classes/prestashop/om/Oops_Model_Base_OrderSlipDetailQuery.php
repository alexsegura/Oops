...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_order_slip_detail' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_OrderSlipDetailQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_ORDER_SLIP`, `ID_ORDER_DETAIL`, `PRODUCT_QUANTITY` FROM `' . _DB_PREFIX_ . 'djland_order_slip_detail` WHERE `ID_ORDER_SLIP` = :p0 AND `ID_ORDER_DETAIL` = :p1';
		try {
