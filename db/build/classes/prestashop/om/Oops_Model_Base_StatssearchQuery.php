...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_statssearch' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_StatssearchQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_STATSSEARCH`, `KEYWORDS`, `RESULTS`, `DATE_ADD` FROM `' . _DB_PREFIX_ . 'djland_statssearch` WHERE `ID_STATSSEARCH` = :p0';
		try {
