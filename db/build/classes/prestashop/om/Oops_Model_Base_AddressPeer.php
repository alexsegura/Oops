...
abstract class Oops_Model_Base_AddressPeer {
	...
	const TABLE_NAME = _DB_PREFIX_ . 'djland_address';
	...
	const ID_ADDRESS = _DB_PREFIX_ . 'djland_address.ID_ADDRESS';

	/** the column name for the ID_COUNTRY field */
	const ID_COUNTRY = _DB_PREFIX_ . 'djland_address.ID_COUNTRY';

	/** the column name for the ID_STATE field */
	const ID_STATE = _DB_PREFIX_ . 'djland_address.ID_STATE';

	/** the column name for the ID_CUSTOMER field */
	const ID_CUSTOMER = _DB_PREFIX_ . 'djland_address.ID_CUSTOMER';

	/** the column name for the ID_MANUFACTURER field */
	const ID_MANUFACTURER = _DB_PREFIX_ . 'djland_address.ID_MANUFACTURER';

	/** the column name for the ID_SUPPLIER field */
	const ID_SUPPLIER = _DB_PREFIX_ . 'djland_address.ID_SUPPLIER';

	/** the column name for the ALIAS field */
	const ALIAS = _DB_PREFIX_ . 'djland_address.ALIAS';

	/** the column name for the COMPANY field */
	const COMPANY = _DB_PREFIX_ . 'djland_address.COMPANY';

	/** the column name for the LASTNAME field */
	const LASTNAME = _DB_PREFIX_ . 'djland_address.LASTNAME';

	/** the column name for the FIRSTNAME field */
	const FIRSTNAME = _DB_PREFIX_ . 'djland_address.FIRSTNAME';

	/** the column name for the ADDRESS1 field */
	const ADDRESS1 = _DB_PREFIX_ . 'djland_address.ADDRESS1';

	/** the column name for the ADDRESS2 field */
	const ADDRESS2 = _DB_PREFIX_ . 'djland_address.ADDRESS2';

	/** the column name for the POSTCODE field */
	const POSTCODE = _DB_PREFIX_ . 'djland_address.POSTCODE';

	/** the column name for the CITY field */
	const CITY = _DB_PREFIX_ . 'djland_address.CITY';

	/** the column name for the OTHER field */
	const OTHER = _DB_PREFIX_ . 'djland_address.OTHER';

	/** the column name for the PHONE field */
	const PHONE = _DB_PREFIX_ . 'djland_address.PHONE';

	/** the column name for the PHONE_MOBILE field */
	const PHONE_MOBILE = _DB_PREFIX_ . 'djland_address.PHONE_MOBILE';

	/** the column name for the VAT_NUMBER field */
	const VAT_NUMBER = _DB_PREFIX_ . 'djland_address.VAT_NUMBER';

	/** the column name for the DNI field */
	const DNI = _DB_PREFIX_ . 'djland_address.DNI';

	/** the column name for the DATE_ADD field */
	const DATE_ADD = _DB_PREFIX_ . 'djland_address.DATE_ADD';

	/** the column name for the DATE_UPD field */
	const DATE_UPD = _DB_PREFIX_ . 'djland_address.DATE_UPD';

	/** the column name for the ACTIVE field */
	const ACTIVE = _DB_PREFIX_ . 'djland_address.ACTIVE';

	/** the column name for the DELETED field */
	const DELETED = _DB_PREFIX_ . 'djland_address.DELETED';
