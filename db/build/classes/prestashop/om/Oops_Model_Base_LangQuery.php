...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_lang' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_LangQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_LANG`, `NAME`, `ACTIVE`, `ISO_CODE`, `LANGUAGE_CODE`, `IS_RTL` FROM `' . _DB_PREFIX_ . 'djland_lang` WHERE `ID_LANG` = :p0';
		try {
