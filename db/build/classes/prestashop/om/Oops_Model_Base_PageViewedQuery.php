...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_page_viewed' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_PageViewedQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_PAGE`, `ID_DATE_RANGE`, `COUNTER` FROM `' . _DB_PREFIX_ . 'djland_page_viewed` WHERE `ID_PAGE` = :p0 AND `ID_DATE_RANGE` = :p1';
		try {
