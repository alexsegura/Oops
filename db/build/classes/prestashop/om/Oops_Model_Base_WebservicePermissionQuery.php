...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_webservice_permission' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_WebservicePermissionQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_WEBSERVICE_PERMISSION`, `RESOURCE`, `METHOD`, `ID_WEBSERVICE_ACCOUNT` FROM `' . _DB_PREFIX_ . 'djland_webservice_permission` WHERE `ID_WEBSERVICE_PERMISSION` = :p0';
		try {
