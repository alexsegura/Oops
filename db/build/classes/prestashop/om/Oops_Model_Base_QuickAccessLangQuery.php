...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_quick_access_lang' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_QuickAccessLangQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_QUICK_ACCESS`, `ID_LANG`, `NAME` FROM `' . _DB_PREFIX_ . 'djland_quick_access_lang` WHERE `ID_QUICK_ACCESS` = :p0 AND `ID_LANG` = :p1';
		try {
