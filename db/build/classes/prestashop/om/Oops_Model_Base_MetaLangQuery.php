...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_meta_lang' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_MetaLangQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_META`, `ID_LANG`, `TITLE`, `DESCRIPTION`, `KEYWORDS`, `URL_REWRITE` FROM `' . _DB_PREFIX_ . 'djland_meta_lang` WHERE `ID_META` = :p0 AND `ID_LANG` = :p1';
		try {
