 ...
 */
abstract class Oops_Model_Base_Pagenotfound extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Model_PagenotfoundPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Model_PagenotfoundPeer
	 */
	 ...
	 * @return     Oops_Model_Pagenotfound The current object (for fluent API support)
	 */
	public function setIdPagenotfound($v)
	{
		...
		if ($this->id_pagenotfound !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_PagenotfoundPeer::ID_PAGENOTFOUND;
		}
	...
	public function setRequestUri($v)
	{
		...
		if ($this->request_uri !== $v) {
			$this->request_uri = $v;
			$this->modifiedColumns[] = Oops_Model_PagenotfoundPeer::REQUEST_URI;
		}
	...
	public function setHttpReferer($v)
	{
		...
		if ($this->http_referer !== $v) {
			$this->http_referer = $v;
			$this->modifiedColumns[] = Oops_Model_PagenotfoundPeer::HTTP_REFERER;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Model_PagenotfoundPeer::DATE_ADD;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = Oops_Model_PagenotfoundPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Model_Pagenotfound object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Model_PagenotfoundPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Model_PagenotfoundQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Model_PagenotfoundPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Model_PagenotfoundPeer::ID_PAGENOTFOUND)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PAGENOTFOUND`';
		}
		if ($this->isColumnModified(Oops_Model_PagenotfoundPeer::REQUEST_URI)) {
			$modifiedColumns[':p' . $index++]  = '`REQUEST_URI`';
		}
		if ($this->isColumnModified(Oops_Model_PagenotfoundPeer::HTTP_REFERER)) {
			$modifiedColumns[':p' . $index++]  = '`HTTP_REFERER`';
		}
		if ($this->isColumnModified(Oops_Model_PagenotfoundPeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}

		$sql = sprintf(
			'INSERT INTO `' . _DB_PREFIX_ . 'djland_pagenotfound` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Model_PagenotfoundPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Model_PagenotfoundPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Model_Pagenotfound'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Model_Pagenotfound'][$this->getPrimaryKey()] = true;
		$keys = Oops_Model_PagenotfoundPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Model_PagenotfoundPeer::ID_PAGENOTFOUND)) $criteria->add(Oops_Model_PagenotfoundPeer::ID_PAGENOTFOUND, $this->id_pagenotfound);
		if ($this->isColumnModified(Oops_Model_PagenotfoundPeer::REQUEST_URI)) $criteria->add(Oops_Model_PagenotfoundPeer::REQUEST_URI, $this->request_uri);
		if ($this->isColumnModified(Oops_Model_PagenotfoundPeer::HTTP_REFERER)) $criteria->add(Oops_Model_PagenotfoundPeer::HTTP_REFERER, $this->http_referer);
		if ($this->isColumnModified(Oops_Model_PagenotfoundPeer::DATE_ADD)) $criteria->add(Oops_Model_PagenotfoundPeer::DATE_ADD, $this->date_add);
	...
	{
		$criteria = new Criteria(Oops_Model_PagenotfoundPeer::DATABASE_NAME);
		$criteria->add(Oops_Model_PagenotfoundPeer::ID_PAGENOTFOUND, $this->id_pagenotfound);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Model_Pagenotfound (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Model_Pagenotfound Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Model_PagenotfoundPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Model_PagenotfoundPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Model_PagenotfoundPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Model_Base_Pagenotfound
