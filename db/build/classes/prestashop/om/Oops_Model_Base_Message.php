...
/**
 * Base class that represents a row from the 'djland_message' table.
 *
 * 
 *
 * @package    propel.generator.prestashop.om
 */
abstract class Oops_Model_Base_Message extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Model_MessagePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Model_MessagePeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Model_Base_Message object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Model_Message The current object (for fluent API support)
	 */
	public function setIdMessage($v)
	{
		...
		if ($this->id_message !== $v) {
			$this->id_message = $v;
			$this->modifiedColumns[] = Oops_Model_MessagePeer::ID_MESSAGE;
		}
	...
	public function setIdCart($v)
	{
		...
		if ($this->id_cart !== $v) {
			$this->id_cart = $v;
			$this->modifiedColumns[] = Oops_Model_MessagePeer::ID_CART;
		}
	...
	public function setIdCustomer($v)
	{
		...
		if ($this->id_customer !== $v) {
			$this->id_customer = $v;
			$this->modifiedColumns[] = Oops_Model_MessagePeer::ID_CUSTOMER;
		}
	...
	public function setIdEmployee($v)
	{
		...
		if ($this->id_employee !== $v) {
			$this->id_employee = $v;
			$this->modifiedColumns[] = Oops_Model_MessagePeer::ID_EMPLOYEE;
		}
	...
	public function setIdOrder($v)
	{
		...
		if ($this->id_order !== $v) {
			$this->id_order = $v;
			$this->modifiedColumns[] = Oops_Model_MessagePeer::ID_ORDER;
		}
	...
	public function setMessage($v)
	{
		...
		if ($this->message !== $v) {
			$this->message = $v;
			$this->modifiedColumns[] = Oops_Model_MessagePeer::MESSAGE;
		}
	...
	public function setPrivate($v)
	{
		...
		if ($this->private !== $v) {
			$this->private = $v;
			$this->modifiedColumns[] = Oops_Model_MessagePeer::ISPRIVATE;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Model_MessagePeer::DATE_ADD;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 8; // 8 = Oops_Model_MessagePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Model_Message object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Model_MessagePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Model_MessageQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Model_MessagePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Model_MessagePeer::ID_MESSAGE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_MESSAGE`';
		}
		if ($this->isColumnModified(Oops_Model_MessagePeer::ID_CART)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CART`';
		}
		if ($this->isColumnModified(Oops_Model_MessagePeer::ID_CUSTOMER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CUSTOMER`';
		}
		if ($this->isColumnModified(Oops_Model_MessagePeer::ID_EMPLOYEE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_EMPLOYEE`';
		}
		if ($this->isColumnModified(Oops_Model_MessagePeer::ID_ORDER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ORDER`';
		}
		if ($this->isColumnModified(Oops_Model_MessagePeer::MESSAGE)) {
			$modifiedColumns[':p' . $index++]  = '`MESSAGE`';
		}
		if ($this->isColumnModified(Oops_Model_MessagePeer::ISPRIVATE)) {
			$modifiedColumns[':p' . $index++]  = '`PRIVATE`';
		}
		if ($this->isColumnModified(Oops_Model_MessagePeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}

		$sql = sprintf(
			'INSERT INTO `' . _DB_PREFIX_ . 'djland_message` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Model_MessagePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Model_MessagePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Model_Message'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Model_Message'][$this->getPrimaryKey()] = true;
		$keys = Oops_Model_MessagePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Model_MessagePeer::ID_MESSAGE)) $criteria->add(Oops_Model_MessagePeer::ID_MESSAGE, $this->id_message);
		if ($this->isColumnModified(Oops_Model_MessagePeer::ID_CART)) $criteria->add(Oops_Model_MessagePeer::ID_CART, $this->id_cart);
		if ($this->isColumnModified(Oops_Model_MessagePeer::ID_CUSTOMER)) $criteria->add(Oops_Model_MessagePeer::ID_CUSTOMER, $this->id_customer);
		if ($this->isColumnModified(Oops_Model_MessagePeer::ID_EMPLOYEE)) $criteria->add(Oops_Model_MessagePeer::ID_EMPLOYEE, $this->id_employee);
		if ($this->isColumnModified(Oops_Model_MessagePeer::ID_ORDER)) $criteria->add(Oops_Model_MessagePeer::ID_ORDER, $this->id_order);
		if ($this->isColumnModified(Oops_Model_MessagePeer::MESSAGE)) $criteria->add(Oops_Model_MessagePeer::MESSAGE, $this->message);
		if ($this->isColumnModified(Oops_Model_MessagePeer::ISPRIVATE)) $criteria->add(Oops_Model_MessagePeer::ISPRIVATE, $this->private);
		if ($this->isColumnModified(Oops_Model_MessagePeer::DATE_ADD)) $criteria->add(Oops_Model_MessagePeer::DATE_ADD, $this->date_add);
	...
	{
		$criteria = new Criteria(Oops_Model_MessagePeer::DATABASE_NAME);
		$criteria->add(Oops_Model_MessagePeer::ID_MESSAGE, $this->id_message);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Model_Message (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Model_Message Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Model_MessagePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Model_MessagePeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Model_MessagePeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Model_Base_Message
