...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_pagenotfound' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_PagenotfoundQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_PAGENOTFOUND`, `REQUEST_URI`, `HTTP_REFERER`, `DATE_ADD` FROM `' . _DB_PREFIX_ . 'djland_pagenotfound` WHERE `ID_PAGENOTFOUND` = :p0';
		try {
