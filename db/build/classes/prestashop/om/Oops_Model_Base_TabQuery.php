...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_tab' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_TabQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_TAB`, `ID_PARENT`, `CLASS_NAME`, `MODULE`, `POSITION` FROM `' . _DB_PREFIX_ . 'djland_tab` WHERE `ID_TAB` = :p0';
		try {
