...
abstract class Oops_Model_Base_PaymentCcPeer {
	...
	const TABLE_NAME = _DB_PREFIX_ . 'djland_payment_cc';
	...
	const ID_PAYMENT_CC = _DB_PREFIX_ . 'djland_payment_cc.ID_PAYMENT_CC';

	/** the column name for the ID_ORDER field */
	const ID_ORDER = _DB_PREFIX_ . 'djland_payment_cc.ID_ORDER';

	/** the column name for the ID_CURRENCY field */
	const ID_CURRENCY = _DB_PREFIX_ . 'djland_payment_cc.ID_CURRENCY';

	/** the column name for the AMOUNT field */
	const AMOUNT = _DB_PREFIX_ . 'djland_payment_cc.AMOUNT';

	/** the column name for the TRANSACTION_ID field */
	const TRANSACTION_ID = _DB_PREFIX_ . 'djland_payment_cc.TRANSACTION_ID';

	/** the column name for the CARD_NUMBER field */
	const CARD_NUMBER = _DB_PREFIX_ . 'djland_payment_cc.CARD_NUMBER';

	/** the column name for the CARD_BRAND field */
	const CARD_BRAND = _DB_PREFIX_ . 'djland_payment_cc.CARD_BRAND';

	/** the column name for the CARD_EXPIRATION field */
	const CARD_EXPIRATION = _DB_PREFIX_ . 'djland_payment_cc.CARD_EXPIRATION';

	/** the column name for the CARD_HOLDER field */
	const CARD_HOLDER = _DB_PREFIX_ . 'djland_payment_cc.CARD_HOLDER';

	/** the column name for the DATE_ADD field */
	const DATE_ADD = _DB_PREFIX_ . 'djland_payment_cc.DATE_ADD';
