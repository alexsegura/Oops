...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_group' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_GroupQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_GROUP`, `REDUCTION`, `PRICE_DISPLAY_METHOD`, `DATE_ADD`, `DATE_UPD` FROM `' . _DB_PREFIX_ . 'djland_group` WHERE `ID_GROUP` = :p0';
		try {
