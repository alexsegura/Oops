...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_county' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_CountyQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_COUNTY`, `NAME`, `ID_STATE`, `ACTIVE` FROM `' . _DB_PREFIX_ . 'djland_county` WHERE `ID_COUNTY` = :p0';
		try {
