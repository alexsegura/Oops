...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_message' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_MessageQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_MESSAGE`, `ID_CART`, `ID_CUSTOMER`, `ID_EMPLOYEE`, `ID_ORDER`, `MESSAGE`, `PRIVATE`, `DATE_ADD` FROM `' . _DB_PREFIX_ . 'djland_message` WHERE `ID_MESSAGE` = :p0';
		try {
