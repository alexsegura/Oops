...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_country_lang' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_CountryLangQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_COUNTRY`, `ID_LANG`, `NAME` FROM `' . _DB_PREFIX_ . 'djland_country_lang` WHERE `ID_COUNTRY` = :p0';
		try {
