...
/**
 * Base class that represents a row from the 'djland_employee' table.
 *
 * 
 *
 * @package    propel.generator.prestashop.om
 */
abstract class Oops_Model_Base_Employee extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Model_EmployeePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Model_EmployeePeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Model_Base_Employee object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Model_Employee The current object (for fluent API support)
	 */
	public function setIdEmployee($v)
	{
		...
		if ($this->id_employee !== $v) {
			$this->id_employee = $v;
			$this->modifiedColumns[] = Oops_Model_EmployeePeer::ID_EMPLOYEE;
		}
	...
	public function setIdProfile($v)
	{
		...
		if ($this->id_profile !== $v) {
			$this->id_profile = $v;
			$this->modifiedColumns[] = Oops_Model_EmployeePeer::ID_PROFILE;
		}
	...
	public function setIdLang($v)
	{
		...
		if ($this->id_lang !== $v) {
			$this->id_lang = $v;
			$this->modifiedColumns[] = Oops_Model_EmployeePeer::ID_LANG;
		}
	...
	public function setLastname($v)
	{
		...
		if ($this->lastname !== $v) {
			$this->lastname = $v;
			$this->modifiedColumns[] = Oops_Model_EmployeePeer::LASTNAME;
		}
	...
	public function setFirstname($v)
	{
		...
		if ($this->firstname !== $v) {
			$this->firstname = $v;
			$this->modifiedColumns[] = Oops_Model_EmployeePeer::FIRSTNAME;
		}
	...
	public function setEmail($v)
	{
		...
		if ($this->email !== $v) {
			$this->email = $v;
			$this->modifiedColumns[] = Oops_Model_EmployeePeer::EMAIL;
		}
	...
	public function setPasswd($v)
	{
		...
		if ($this->passwd !== $v) {
			$this->passwd = $v;
			$this->modifiedColumns[] = Oops_Model_EmployeePeer::PASSWD;
		}
	...
	public function setLastPasswdGen($v)
	{
		...
		if ($this->last_passwd_gen !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Model_EmployeePeer::LAST_PASSWD_GEN;
			}
	...
	public function setStatsDateFrom($v)
	{
		...
		if ($this->stats_date_from !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Model_EmployeePeer::STATS_DATE_FROM;
			}
		} // if either are not null
	...
	public function setStatsDateTo($v)
	{
		...
		if ($this->stats_date_to !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Model_EmployeePeer::STATS_DATE_TO;
			}
		} // if either are not null
	...
	public function setBoColor($v)
	{
		...
		if ($this->bo_color !== $v) {
			$this->bo_color = $v;
			$this->modifiedColumns[] = Oops_Model_EmployeePeer::BO_COLOR;
		}
	...
	public function setBoTheme($v)
	{
		...
		if ($this->bo_theme !== $v) {
			$this->bo_theme = $v;
			$this->modifiedColumns[] = Oops_Model_EmployeePeer::BO_THEME;
		}
	...
	public function setBoUimode($v)
	{
		...
		if ($this->bo_uimode !== $v) {
			$this->bo_uimode = $v;
			$this->modifiedColumns[] = Oops_Model_EmployeePeer::BO_UIMODE;
		}
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v) {
			$this->active = $v;
			$this->modifiedColumns[] = Oops_Model_EmployeePeer::ACTIVE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 14; // 14 = Oops_Model_EmployeePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Model_Employee object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Model_EmployeePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Model_EmployeeQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Model_EmployeePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Model_EmployeePeer::ID_EMPLOYEE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_EMPLOYEE`';
		}
		if ($this->isColumnModified(Oops_Model_EmployeePeer::ID_PROFILE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PROFILE`';
		}
		if ($this->isColumnModified(Oops_Model_EmployeePeer::ID_LANG)) {
			$modifiedColumns[':p' . $index++]  = '`ID_LANG`';
		}
		if ($this->isColumnModified(Oops_Model_EmployeePeer::LASTNAME)) {
			$modifiedColumns[':p' . $index++]  = '`LASTNAME`';
		}
		if ($this->isColumnModified(Oops_Model_EmployeePeer::FIRSTNAME)) {
			$modifiedColumns[':p' . $index++]  = '`FIRSTNAME`';
		}
		if ($this->isColumnModified(Oops_Model_EmployeePeer::EMAIL)) {
			$modifiedColumns[':p' . $index++]  = '`EMAIL`';
		}
		if ($this->isColumnModified(Oops_Model_EmployeePeer::PASSWD)) {
			$modifiedColumns[':p' . $index++]  = '`PASSWD`';
		}
		if ($this->isColumnModified(Oops_Model_EmployeePeer::LAST_PASSWD_GEN)) {
			$modifiedColumns[':p' . $index++]  = '`LAST_PASSWD_GEN`';
		}
		if ($this->isColumnModified(Oops_Model_EmployeePeer::STATS_DATE_FROM)) {
			$modifiedColumns[':p' . $index++]  = '`STATS_DATE_FROM`';
		}
		if ($this->isColumnModified(Oops_Model_EmployeePeer::STATS_DATE_TO)) {
			$modifiedColumns[':p' . $index++]  = '`STATS_DATE_TO`';
		}
		if ($this->isColumnModified(Oops_Model_EmployeePeer::BO_COLOR)) {
			$modifiedColumns[':p' . $index++]  = '`BO_COLOR`';
		}
		if ($this->isColumnModified(Oops_Model_EmployeePeer::BO_THEME)) {
			$modifiedColumns[':p' . $index++]  = '`BO_THEME`';
		}
		if ($this->isColumnModified(Oops_Model_EmployeePeer::BO_UIMODE)) {
			$modifiedColumns[':p' . $index++]  = '`BO_UIMODE`';
		}
		if ($this->isColumnModified(Oops_Model_EmployeePeer::ACTIVE)) {
			$modifiedColumns[':p' . $index++]  = '`ACTIVE`';
		}

		$sql = sprintf(
			'INSERT INTO `' . _DB_PREFIX_ . 'djland_employee` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Model_EmployeePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Model_EmployeePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Model_Employee'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Model_Employee'][$this->getPrimaryKey()] = true;
		$keys = Oops_Model_EmployeePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Model_EmployeePeer::ID_EMPLOYEE)) $criteria->add(Oops_Model_EmployeePeer::ID_EMPLOYEE, $this->id_employee);
		if ($this->isColumnModified(Oops_Model_EmployeePeer::ID_PROFILE)) $criteria->add(Oops_Model_EmployeePeer::ID_PROFILE, $this->id_profile);
		if ($this->isColumnModified(Oops_Model_EmployeePeer::ID_LANG)) $criteria->add(Oops_Model_EmployeePeer::ID_LANG, $this->id_lang);
		if ($this->isColumnModified(Oops_Model_EmployeePeer::LASTNAME)) $criteria->add(Oops_Model_EmployeePeer::LASTNAME, $this->lastname);
		if ($this->isColumnModified(Oops_Model_EmployeePeer::FIRSTNAME)) $criteria->add(Oops_Model_EmployeePeer::FIRSTNAME, $this->firstname);
		if ($this->isColumnModified(Oops_Model_EmployeePeer::EMAIL)) $criteria->add(Oops_Model_EmployeePeer::EMAIL, $this->email);
		if ($this->isColumnModified(Oops_Model_EmployeePeer::PASSWD)) $criteria->add(Oops_Model_EmployeePeer::PASSWD, $this->passwd);
		if ($this->isColumnModified(Oops_Model_EmployeePeer::LAST_PASSWD_GEN)) $criteria->add(Oops_Model_EmployeePeer::LAST_PASSWD_GEN, $this->last_passwd_gen);
		if ($this->isColumnModified(Oops_Model_EmployeePeer::STATS_DATE_FROM)) $criteria->add(Oops_Model_EmployeePeer::STATS_DATE_FROM, $this->stats_date_from);
		if ($this->isColumnModified(Oops_Model_EmployeePeer::STATS_DATE_TO)) $criteria->add(Oops_Model_EmployeePeer::STATS_DATE_TO, $this->stats_date_to);
		if ($this->isColumnModified(Oops_Model_EmployeePeer::BO_COLOR)) $criteria->add(Oops_Model_EmployeePeer::BO_COLOR, $this->bo_color);
		if ($this->isColumnModified(Oops_Model_EmployeePeer::BO_THEME)) $criteria->add(Oops_Model_EmployeePeer::BO_THEME, $this->bo_theme);
		if ($this->isColumnModified(Oops_Model_EmployeePeer::BO_UIMODE)) $criteria->add(Oops_Model_EmployeePeer::BO_UIMODE, $this->bo_uimode);
		if ($this->isColumnModified(Oops_Model_EmployeePeer::ACTIVE)) $criteria->add(Oops_Model_EmployeePeer::ACTIVE, $this->active);
	...
	{
		$criteria = new Criteria(Oops_Model_EmployeePeer::DATABASE_NAME);
		$criteria->add(Oops_Model_EmployeePeer::ID_EMPLOYEE, $this->id_employee);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Model_Employee (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Model_Employee Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Model_EmployeePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Model_EmployeePeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Model_EmployeePeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Model_Base_Employee
