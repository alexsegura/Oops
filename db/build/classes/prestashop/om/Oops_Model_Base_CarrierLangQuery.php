...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_carrier_lang' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_CarrierLangQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_CARRIER`, `ID_LANG`, `DELAY` FROM `' . _DB_PREFIX_ . 'djland_carrier_lang` WHERE `ID_CARRIER` = :p0';
		try {
