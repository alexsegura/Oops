...
/**
 * Base class that represents a row from the 'djland_feature_product' table.
 *
 * 
 *
 * @package    propel.generator.prestashop.om
 */
abstract class Oops_Model_Base_FeatureProduct extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Model_FeatureProductPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Model_FeatureProductPeer
	 */
	...
	public function setIdFeatureValue($v)
	{
		...
		if ($this->id_feature_value !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_FeatureProductPeer::ID_FEATURE_VALUE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = Oops_Model_FeatureProductPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Model_FeatureProduct object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Model_FeatureProductPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Model_FeatureProductQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Model_FeatureProductPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Model_FeatureProductPeer::ID_FEATURE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_FEATURE`';
		}
		if ($this->isColumnModified(Oops_Model_FeatureProductPeer::ID_PRODUCT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PRODUCT`';
		}
		if ($this->isColumnModified(Oops_Model_FeatureProductPeer::ID_FEATURE_VALUE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_FEATURE_VALUE`';
		}

		$sql = sprintf(
			'INSERT INTO `' . _DB_PREFIX_ . 'djland_feature_product` (%s) VALUES (%s)',
	...
	{
		$pos = Oops_Model_FeatureProductPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
	{
		...
		$alreadyDumpedObjects['Oops_Model_FeatureProduct'][serialize($this->getPrimaryKey())] = true;
		$keys = Oops_Model_FeatureProductPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Model_FeatureProductPeer::ID_FEATURE)) $criteria->add(Oops_Model_FeatureProductPeer::ID_FEATURE, $this->id_feature);
		if ($this->isColumnModified(Oops_Model_FeatureProductPeer::ID_PRODUCT)) $criteria->add(Oops_Model_FeatureProductPeer::ID_PRODUCT, $this->id_product);
		if ($this->isColumnModified(Oops_Model_FeatureProductPeer::ID_FEATURE_VALUE)) $criteria->add(Oops_Model_FeatureProductPeer::ID_FEATURE_VALUE, $this->id_feature_value);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Model_FeatureProduct (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Model_FeatureProduct Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Model_FeatureProductPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Model_FeatureProductPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Model_FeatureProductPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Model_Base_FeatureProduct
