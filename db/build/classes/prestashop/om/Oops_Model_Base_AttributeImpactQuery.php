...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_attribute_impact' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_AttributeImpactQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_ATTRIBUTE_IMPACT`, `ID_PRODUCT`, `ID_ATTRIBUTE`, `WEIGHT`, `PRICE` FROM `' . _DB_PREFIX_ . 'djland_attribute_impact` WHERE `ID_ATTRIBUTE_IMPACT` = :p0';
		try {
