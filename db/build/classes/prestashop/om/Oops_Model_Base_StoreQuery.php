...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_store' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_StoreQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_STORE`, `ID_COUNTRY`, `ID_STATE`, `NAME`, `ADDRESS1`, `ADDRESS2`, `CITY`, `POSTCODE`, `LATITUDE`, `LONGITUDE`, `HOURS`, `PHONE`, `FAX`, `EMAIL`, `NOTE`, `ACTIVE`, `DATE_ADD`, `DATE_UPD` FROM `' . _DB_PREFIX_ . 'djland_store` WHERE `ID_STORE` = :p0';
		try {
