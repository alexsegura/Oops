...
/**
 * Base static class for performing query and update operations on the 'djland_hook_module_exceptions' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_HookModuleExceptionsPeer {
	...
	const TABLE_NAME = _DB_PREFIX_ . 'djland_hook_module_exceptions';
	...
	const ID_HOOK_MODULE_EXCEPTIONS = _DB_PREFIX_ . 'djland_hook_module_exceptions.ID_HOOK_MODULE_EXCEPTIONS';

	/** the column name for the ID_MODULE field */
	const ID_MODULE = _DB_PREFIX_ . 'djland_hook_module_exceptions.ID_MODULE';

	/** the column name for the ID_HOOK field */
	const ID_HOOK = _DB_PREFIX_ . 'djland_hook_module_exceptions.ID_HOOK';

	/** the column name for the FILE_NAME field */
	const FILE_NAME = _DB_PREFIX_ . 'djland_hook_module_exceptions.FILE_NAME';
	...
	/**
	 * Method to invalidate the instance pool of all tables related to djland_hook_module_exceptions
	...
	/**
	 * Deletes all rows from the djland_hook_module_exceptions table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
