 ...
 */
abstract class Oops_Model_Base_CompareProduct extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Model_CompareProductPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Model_CompareProductPeer
	 */
	 ...
	 * @return     Oops_Model_CompareProduct The current object (for fluent API support)
	 */
	public function setIdCompareProduct($v)
	{
		...
		if ($this->id_compare_product !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_CompareProductPeer::ID_COMPARE_PRODUCT;
		}
	...
	public function setIdProduct($v)
	{
		...
		if ($this->id_product !== $v) {
			$this->id_product = $v;
			$this->modifiedColumns[] = Oops_Model_CompareProductPeer::ID_PRODUCT;
		}
	...
	public function setIdGuest($v)
	{
		...
		if ($this->id_guest !== $v) {
			$this->id_guest = $v;
			$this->modifiedColumns[] = Oops_Model_CompareProductPeer::ID_GUEST;
		}
	...
	public function setIdCustomer($v)
	{
		...
		if ($this->id_customer !== $v) {
			$this->id_customer = $v;
			$this->modifiedColumns[] = Oops_Model_CompareProductPeer::ID_CUSTOMER;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Model_CompareProductPeer::DATE_ADD;
			}
	...
	public function setDateUpd($v)
	{
		...
		if ($this->date_upd !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Model_CompareProductPeer::DATE_UPD;
			}
		} // if either are not null
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 6; // 6 = Oops_Model_CompareProductPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Model_CompareProduct object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Model_CompareProductPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Model_CompareProductQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Model_CompareProductPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Model_CompareProductPeer::ID_COMPARE_PRODUCT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_COMPARE_PRODUCT`';
		}
		if ($this->isColumnModified(Oops_Model_CompareProductPeer::ID_PRODUCT)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PRODUCT`';
		}
		if ($this->isColumnModified(Oops_Model_CompareProductPeer::ID_GUEST)) {
			$modifiedColumns[':p' . $index++]  = '`ID_GUEST`';
		}
		if ($this->isColumnModified(Oops_Model_CompareProductPeer::ID_CUSTOMER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CUSTOMER`';
		}
		if ($this->isColumnModified(Oops_Model_CompareProductPeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}
		if ($this->isColumnModified(Oops_Model_CompareProductPeer::DATE_UPD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_UPD`';
		}

		$sql = sprintf(
			'INSERT INTO `' . _DB_PREFIX_ . 'djland_compare_product` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Model_CompareProductPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Model_CompareProductPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Model_CompareProduct'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Model_CompareProduct'][$this->getPrimaryKey()] = true;
		$keys = Oops_Model_CompareProductPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Model_CompareProductPeer::ID_COMPARE_PRODUCT)) $criteria->add(Oops_Model_CompareProductPeer::ID_COMPARE_PRODUCT, $this->id_compare_product);
		if ($this->isColumnModified(Oops_Model_CompareProductPeer::ID_PRODUCT)) $criteria->add(Oops_Model_CompareProductPeer::ID_PRODUCT, $this->id_product);
		if ($this->isColumnModified(Oops_Model_CompareProductPeer::ID_GUEST)) $criteria->add(Oops_Model_CompareProductPeer::ID_GUEST, $this->id_guest);
		if ($this->isColumnModified(Oops_Model_CompareProductPeer::ID_CUSTOMER)) $criteria->add(Oops_Model_CompareProductPeer::ID_CUSTOMER, $this->id_customer);
		if ($this->isColumnModified(Oops_Model_CompareProductPeer::DATE_ADD)) $criteria->add(Oops_Model_CompareProductPeer::DATE_ADD, $this->date_add);
		if ($this->isColumnModified(Oops_Model_CompareProductPeer::DATE_UPD)) $criteria->add(Oops_Model_CompareProductPeer::DATE_UPD, $this->date_upd);
	...
	{
		$criteria = new Criteria(Oops_Model_CompareProductPeer::DATABASE_NAME);
		$criteria->add(Oops_Model_CompareProductPeer::ID_COMPARE_PRODUCT, $this->id_compare_product);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Model_CompareProduct (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Model_CompareProduct Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Model_CompareProductPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Model_CompareProductPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Model_CompareProductPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Model_Base_CompareProduct
