...
abstract class Oops_Model_Base_OrderDetailPeer {
	...
	const TABLE_NAME = _DB_PREFIX_ . 'djland_order_detail';
	...
	const ID_ORDER_DETAIL = _DB_PREFIX_ . 'djland_order_detail.ID_ORDER_DETAIL';

	/** the column name for the ID_ORDER field */
	const ID_ORDER = _DB_PREFIX_ . 'djland_order_detail.ID_ORDER';

	/** the column name for the PRODUCT_ID field */
	const PRODUCT_ID = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_ID';

	/** the column name for the PRODUCT_ATTRIBUTE_ID field */
	const PRODUCT_ATTRIBUTE_ID = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_ATTRIBUTE_ID';

	/** the column name for the PRODUCT_NAME field */
	const PRODUCT_NAME = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_NAME';

	/** the column name for the PRODUCT_QUANTITY field */
	const PRODUCT_QUANTITY = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_QUANTITY';

	/** the column name for the PRODUCT_QUANTITY_IN_STOCK field */
	const PRODUCT_QUANTITY_IN_STOCK = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_QUANTITY_IN_STOCK';

	/** the column name for the PRODUCT_QUANTITY_REFUNDED field */
	const PRODUCT_QUANTITY_REFUNDED = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_QUANTITY_REFUNDED';

	/** the column name for the PRODUCT_QUANTITY_RETURN field */
	const PRODUCT_QUANTITY_RETURN = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_QUANTITY_RETURN';

	/** the column name for the PRODUCT_QUANTITY_REINJECTED field */
	const PRODUCT_QUANTITY_REINJECTED = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_QUANTITY_REINJECTED';

	/** the column name for the PRODUCT_PRICE field */
	const PRODUCT_PRICE = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_PRICE';

	/** the column name for the REDUCTION_PERCENT field */
	const REDUCTION_PERCENT = _DB_PREFIX_ . 'djland_order_detail.REDUCTION_PERCENT';

	/** the column name for the REDUCTION_AMOUNT field */
	const REDUCTION_AMOUNT = _DB_PREFIX_ . 'djland_order_detail.REDUCTION_AMOUNT';

	/** the column name for the GROUP_REDUCTION field */
	const GROUP_REDUCTION = _DB_PREFIX_ . 'djland_order_detail.GROUP_REDUCTION';

	/** the column name for the PRODUCT_QUANTITY_DISCOUNT field */
	const PRODUCT_QUANTITY_DISCOUNT = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_QUANTITY_DISCOUNT';

	/** the column name for the PRODUCT_EAN13 field */
	const PRODUCT_EAN13 = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_EAN13';

	/** the column name for the PRODUCT_UPC field */
	const PRODUCT_UPC = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_UPC';

	/** the column name for the PRODUCT_REFERENCE field */
	const PRODUCT_REFERENCE = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_REFERENCE';

	/** the column name for the PRODUCT_SUPPLIER_REFERENCE field */
	const PRODUCT_SUPPLIER_REFERENCE = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_SUPPLIER_REFERENCE';

	/** the column name for the PRODUCT_WEIGHT field */
	const PRODUCT_WEIGHT = _DB_PREFIX_ . 'djland_order_detail.PRODUCT_WEIGHT';

	/** the column name for the TAX_NAME field */
	const TAX_NAME = _DB_PREFIX_ . 'djland_order_detail.TAX_NAME';

	/** the column name for the TAX_RATE field */
	const TAX_RATE = _DB_PREFIX_ . 'djland_order_detail.TAX_RATE';

	/** the column name for the ECOTAX field */
	const ECOTAX = _DB_PREFIX_ . 'djland_order_detail.ECOTAX';

	/** the column name for the ECOTAX_TAX_RATE field */
	const ECOTAX_TAX_RATE = _DB_PREFIX_ . 'djland_order_detail.ECOTAX_TAX_RATE';

	/** the column name for the DISCOUNT_QUANTITY_APPLIED field */
	const DISCOUNT_QUANTITY_APPLIED = _DB_PREFIX_ . 'djland_order_detail.DISCOUNT_QUANTITY_APPLIED';

	/** the column name for the DOWNLOAD_HASH field */
	const DOWNLOAD_HASH = _DB_PREFIX_ . 'djland_order_detail.DOWNLOAD_HASH';

	/** the column name for the DOWNLOAD_NB field */
	const DOWNLOAD_NB = _DB_PREFIX_ . 'djland_order_detail.DOWNLOAD_NB';

	/** the column name for the DOWNLOAD_DEADLINE field */
	const DOWNLOAD_DEADLINE = _DB_PREFIX_ . 'djland_order_detail.DOWNLOAD_DEADLINE';
