...
abstract class Oops_Model_Base_EmployeePeer {
	...
	const TABLE_NAME = _DB_PREFIX_ . 'djland_employee';
	...
	const ID_EMPLOYEE = _DB_PREFIX_ . 'djland_employee.ID_EMPLOYEE';

	/** the column name for the ID_PROFILE field */
	const ID_PROFILE = _DB_PREFIX_ . 'djland_employee.ID_PROFILE';

	/** the column name for the ID_LANG field */
	const ID_LANG = _DB_PREFIX_ . 'djland_employee.ID_LANG';

	/** the column name for the LASTNAME field */
	const LASTNAME = _DB_PREFIX_ . 'djland_employee.LASTNAME';

	/** the column name for the FIRSTNAME field */
	const FIRSTNAME = _DB_PREFIX_ . 'djland_employee.FIRSTNAME';

	/** the column name for the EMAIL field */
	const EMAIL = _DB_PREFIX_ . 'djland_employee.EMAIL';

	/** the column name for the PASSWD field */
	const PASSWD = _DB_PREFIX_ . 'djland_employee.PASSWD';

	/** the column name for the LAST_PASSWD_GEN field */
	const LAST_PASSWD_GEN = _DB_PREFIX_ . 'djland_employee.LAST_PASSWD_GEN';

	/** the column name for the STATS_DATE_FROM field */
	const STATS_DATE_FROM = _DB_PREFIX_ . 'djland_employee.STATS_DATE_FROM';

	/** the column name for the STATS_DATE_TO field */
	const STATS_DATE_TO = _DB_PREFIX_ . 'djland_employee.STATS_DATE_TO';

	/** the column name for the BO_COLOR field */
	const BO_COLOR = _DB_PREFIX_ . 'djland_employee.BO_COLOR';

	/** the column name for the BO_THEME field */
	const BO_THEME = _DB_PREFIX_ . 'djland_employee.BO_THEME';

	/** the column name for the BO_UIMODE field */
	const BO_UIMODE = _DB_PREFIX_ . 'djland_employee.BO_UIMODE';

	/** the column name for the ACTIVE field */
	const ACTIVE = _DB_PREFIX_ . 'djland_employee.ACTIVE';
