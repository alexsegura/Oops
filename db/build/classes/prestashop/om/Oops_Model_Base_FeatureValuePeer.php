...
abstract class Oops_Model_Base_FeatureValuePeer {
	...
	const TABLE_NAME = _DB_PREFIX_ . 'djland_feature_value';
	...
	const ID_FEATURE_VALUE = _DB_PREFIX_ . 'djland_feature_value.ID_FEATURE_VALUE';

	/** the column name for the ID_FEATURE field */
	const ID_FEATURE = _DB_PREFIX_ . 'djland_feature_value.ID_FEATURE';

	/** the column name for the CUSTOM field */
	const CUSTOM = _DB_PREFIX_ . 'djland_feature_value.CUSTOM';
