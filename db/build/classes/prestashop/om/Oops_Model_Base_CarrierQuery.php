...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_carrier' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_CarrierQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_CARRIER`, `ID_TAX_RULES_GROUP`, `NAME`, `URL`, `ACTIVE`, `DELETED`, `SHIPPING_HANDLING`, `RANGE_BEHAVIOR`, `IS_MODULE`, `IS_FREE`, `SHIPPING_EXTERNAL`, `NEED_RANGE`, `EXTERNAL_MODULE_NAME`, `SHIPPING_METHOD` FROM `' . _DB_PREFIX_ . 'djland_carrier` WHERE `ID_CARRIER` = :p0';
		try {
