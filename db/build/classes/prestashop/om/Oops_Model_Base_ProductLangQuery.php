...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_product_lang' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_ProductLangQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_PRODUCT`, `ID_LANG`, `DESCRIPTION`, `DESCRIPTION_SHORT`, `LINK_REWRITE`, `META_DESCRIPTION`, `META_KEYWORDS`, `META_TITLE`, `NAME`, `AVAILABLE_NOW`, `AVAILABLE_LATER` FROM `' . _DB_PREFIX_ . 'djland_product_lang` WHERE `ID_PRODUCT` = :p0 AND `ID_LANG` = :p1';
		try {
