...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_tab_lang' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_TabLangQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_TAB`, `ID_LANG`, `NAME` FROM `' . _DB_PREFIX_ . 'djland_tab_lang` WHERE `ID_TAB` = :p0 AND `ID_LANG` = :p1';
		try {
