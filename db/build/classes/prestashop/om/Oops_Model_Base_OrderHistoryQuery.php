...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_order_history' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_OrderHistoryQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_ORDER_HISTORY`, `ID_EMPLOYEE`, `ID_ORDER`, `ID_ORDER_STATE`, `DATE_ADD` FROM `' . _DB_PREFIX_ . 'djland_order_history` WHERE `ID_ORDER_HISTORY` = :p0';
		try {
