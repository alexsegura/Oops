...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_search_engine' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_SearchEngineQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_SEARCH_ENGINE`, `SERVER`, `GETVAR` FROM `' . _DB_PREFIX_ . 'djland_search_engine` WHERE `ID_SEARCH_ENGINE` = :p0';
		try {
