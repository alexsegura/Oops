...
abstract class Oops_Model_Base_CustomerThreadPeer {
	...
	const TABLE_NAME = _DB_PREFIX_ . 'djland_customer_thread';
	...
	const ID_CUSTOMER_THREAD = _DB_PREFIX_ . 'djland_customer_thread.ID_CUSTOMER_THREAD';

	/** the column name for the ID_LANG field */
	const ID_LANG = _DB_PREFIX_ . 'djland_customer_thread.ID_LANG';

	/** the column name for the ID_CONTACT field */
	const ID_CONTACT = _DB_PREFIX_ . 'djland_customer_thread.ID_CONTACT';

	/** the column name for the ID_CUSTOMER field */
	const ID_CUSTOMER = _DB_PREFIX_ . 'djland_customer_thread.ID_CUSTOMER';

	/** the column name for the ID_ORDER field */
	const ID_ORDER = _DB_PREFIX_ . 'djland_customer_thread.ID_ORDER';

	/** the column name for the ID_PRODUCT field */
	const ID_PRODUCT = _DB_PREFIX_ . 'djland_customer_thread.ID_PRODUCT';

	/** the column name for the STATUS field */
	const STATUS = _DB_PREFIX_ . 'djland_customer_thread.STATUS';

	/** the column name for the EMAIL field */
	const EMAIL = _DB_PREFIX_ . 'djland_customer_thread.EMAIL';

	/** the column name for the TOKEN field */
	const TOKEN = _DB_PREFIX_ . 'djland_customer_thread.TOKEN';

	/** the column name for the DATE_ADD field */
	const DATE_ADD = _DB_PREFIX_ . 'djland_customer_thread.DATE_ADD';

	/** the column name for the DATE_UPD field */
	const DATE_UPD = _DB_PREFIX_ . 'djland_customer_thread.DATE_UPD';
