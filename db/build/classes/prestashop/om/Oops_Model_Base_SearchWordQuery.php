...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_search_word' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_SearchWordQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_WORD`, `ID_LANG`, `WORD` FROM `' . _DB_PREFIX_ . 'djland_search_word` WHERE `ID_WORD` = :p0';
		try {
