...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_cms_category_lang' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_CmsCategoryLangQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_CMS_CATEGORY`, `ID_LANG`, `NAME`, `DESCRIPTION`, `LINK_REWRITE`, `META_TITLE`, `META_KEYWORDS`, `META_DESCRIPTION` FROM `' . _DB_PREFIX_ . 'djland_cms_category_lang` WHERE `ID_CMS_CATEGORY` = :p0';
		try {
