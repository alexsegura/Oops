...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_subdomain' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_SubdomainQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_SUBDOMAIN`, `NAME` FROM `' . _DB_PREFIX_ . 'djland_subdomain` WHERE `ID_SUBDOMAIN` = :p0';
		try {
