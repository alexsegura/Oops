...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_cms_block' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_CmsBlockQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_CMS_BLOCK`, `ID_CMS_CATEGORY`, `NAME`, `LOCATION`, `POSITION`, `DISPLAY_STORE` FROM `' . _DB_PREFIX_ . 'djland_cms_block` WHERE `ID_CMS_BLOCK` = :p0';
		try {
