...
/**
 * Base class that represents a row from the 'djland_payment_cc' table.
 *
 * 
 *
 * @package    propel.generator.prestashop.om
 */
abstract class Oops_Model_Base_PaymentCc extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Model_PaymentCcPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Model_PaymentCcPeer
	 */
	 ...
	 * @return     Oops_Model_PaymentCc The current object (for fluent API support)
	 */
	public function setIdPaymentCc($v)
	{
		...
		if ($this->id_payment_cc !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_PaymentCcPeer::ID_PAYMENT_CC;
		}
	...
	public function setIdOrder($v)
	{
		...
		if ($this->id_order !== $v) {
			$this->id_order = $v;
			$this->modifiedColumns[] = Oops_Model_PaymentCcPeer::ID_ORDER;
		}
	...
	public function setIdCurrency($v)
	{
		...
		if ($this->id_currency !== $v) {
			$this->id_currency = $v;
			$this->modifiedColumns[] = Oops_Model_PaymentCcPeer::ID_CURRENCY;
		}
	...
	public function setAmount($v)
	{
		...
		if ($this->amount !== $v) {
			$this->amount = $v;
			$this->modifiedColumns[] = Oops_Model_PaymentCcPeer::AMOUNT;
		}
	...
	public function setTransactionId($v)
	{
		...
		if ($this->transaction_id !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_PaymentCcPeer::TRANSACTION_ID;
		}
	...
	public function setCardNumber($v)
	{
		...
		if ($this->card_number !== $v) {
			$this->card_number = $v;
			$this->modifiedColumns[] = Oops_Model_PaymentCcPeer::CARD_NUMBER;
		}
	...
	public function setCardBrand($v)
	{
		...
		if ($this->card_brand !== $v) {
			$this->card_brand = $v;
			$this->modifiedColumns[] = Oops_Model_PaymentCcPeer::CARD_BRAND;
		}
	...
	public function setCardExpiration($v)
	{
		...
		if ($this->card_expiration !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_PaymentCcPeer::CARD_EXPIRATION;
		}
	...
	public function setCardHolder($v)
	{
		...
		if ($this->card_holder !== $v) {
			$this->card_holder = $v;
			$this->modifiedColumns[] = Oops_Model_PaymentCcPeer::CARD_HOLDER;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Model_PaymentCcPeer::DATE_ADD;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 10; // 10 = Oops_Model_PaymentCcPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Model_PaymentCc object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Model_PaymentCcPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Model_PaymentCcQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Model_PaymentCcPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::ID_PAYMENT_CC)) {
			$modifiedColumns[':p' . $index++]  = '`ID_PAYMENT_CC`';
		}
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::ID_ORDER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ORDER`';
		}
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::ID_CURRENCY)) {
			$modifiedColumns[':p' . $index++]  = '`ID_CURRENCY`';
		}
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::AMOUNT)) {
			$modifiedColumns[':p' . $index++]  = '`AMOUNT`';
		}
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::TRANSACTION_ID)) {
			$modifiedColumns[':p' . $index++]  = '`TRANSACTION_ID`';
		}
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::CARD_NUMBER)) {
			$modifiedColumns[':p' . $index++]  = '`CARD_NUMBER`';
		}
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::CARD_BRAND)) {
			$modifiedColumns[':p' . $index++]  = '`CARD_BRAND`';
		}
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::CARD_EXPIRATION)) {
			$modifiedColumns[':p' . $index++]  = '`CARD_EXPIRATION`';
		}
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::CARD_HOLDER)) {
			$modifiedColumns[':p' . $index++]  = '`CARD_HOLDER`';
		}
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}

		$sql = sprintf(
			'INSERT INTO `' . _DB_PREFIX_ . 'djland_payment_cc` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Model_PaymentCcPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Model_PaymentCcPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Model_PaymentCc'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Model_PaymentCc'][$this->getPrimaryKey()] = true;
		$keys = Oops_Model_PaymentCcPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::ID_PAYMENT_CC)) $criteria->add(Oops_Model_PaymentCcPeer::ID_PAYMENT_CC, $this->id_payment_cc);
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::ID_ORDER)) $criteria->add(Oops_Model_PaymentCcPeer::ID_ORDER, $this->id_order);
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::ID_CURRENCY)) $criteria->add(Oops_Model_PaymentCcPeer::ID_CURRENCY, $this->id_currency);
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::AMOUNT)) $criteria->add(Oops_Model_PaymentCcPeer::AMOUNT, $this->amount);
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::TRANSACTION_ID)) $criteria->add(Oops_Model_PaymentCcPeer::TRANSACTION_ID, $this->transaction_id);
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::CARD_NUMBER)) $criteria->add(Oops_Model_PaymentCcPeer::CARD_NUMBER, $this->card_number);
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::CARD_BRAND)) $criteria->add(Oops_Model_PaymentCcPeer::CARD_BRAND, $this->card_brand);
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::CARD_EXPIRATION)) $criteria->add(Oops_Model_PaymentCcPeer::CARD_EXPIRATION, $this->card_expiration);
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::CARD_HOLDER)) $criteria->add(Oops_Model_PaymentCcPeer::CARD_HOLDER, $this->card_holder);
		if ($this->isColumnModified(Oops_Model_PaymentCcPeer::DATE_ADD)) $criteria->add(Oops_Model_PaymentCcPeer::DATE_ADD, $this->date_add);
	...
	{
		$criteria = new Criteria(Oops_Model_PaymentCcPeer::DATABASE_NAME);
		$criteria->add(Oops_Model_PaymentCcPeer::ID_PAYMENT_CC, $this->id_payment_cc);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Model_PaymentCc (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Model_PaymentCc Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Model_PaymentCcPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Model_PaymentCcPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Model_PaymentCcPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Model_Base_PaymentCc
