...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_product_attribute' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_ProductAttributeQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_PRODUCT_ATTRIBUTE`, `ID_PRODUCT`, `REFERENCE`, `SUPPLIER_REFERENCE`, `LOCATION`, `EAN13`, `UPC`, `WHOLESALE_PRICE`, `PRICE`, `ECOTAX`, `QUANTITY`, `WEIGHT`, `UNIT_PRICE_IMPACT`, `DEFAULT_ON`, `MINIMAL_QUANTITY` FROM `' . _DB_PREFIX_ . 'djland_product_attribute` WHERE `ID_PRODUCT_ATTRIBUTE` = :p0';
		try {
