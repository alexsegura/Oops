 ...
 */
abstract class Oops_Model_Base_OrderHistory extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Model_OrderHistoryPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Model_OrderHistoryPeer
	 */
	 ...
	 * @return     Oops_Model_OrderHistory The current object (for fluent API support)
	 */
	public function setIdOrderHistory($v)
	{
		...
		if ($this->id_order_history !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderHistoryPeer::ID_ORDER_HISTORY;
		}
	...
	public function setIdEmployee($v)
	{
		...
		if ($this->id_employee !== $v) {
			$this->id_employee = $v;
			$this->modifiedColumns[] = Oops_Model_OrderHistoryPeer::ID_EMPLOYEE;
		}
	...
	public function setIdOrder($v)
	{
		...
		if ($this->id_order !== $v) {
			$this->id_order = $v;
			$this->modifiedColumns[] = Oops_Model_OrderHistoryPeer::ID_ORDER;
		}
	...
	public function setIdOrderState($v)
	{
		...
		if ($this->id_order_state !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderHistoryPeer::ID_ORDER_STATE;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Model_OrderHistoryPeer::DATE_ADD;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = Oops_Model_OrderHistoryPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Model_OrderHistory object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Model_OrderHistoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Model_OrderHistoryQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Model_OrderHistoryPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Model_OrderHistoryPeer::ID_ORDER_HISTORY)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ORDER_HISTORY`';
		}
		if ($this->isColumnModified(Oops_Model_OrderHistoryPeer::ID_EMPLOYEE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_EMPLOYEE`';
		}
		if ($this->isColumnModified(Oops_Model_OrderHistoryPeer::ID_ORDER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ORDER`';
		}
		if ($this->isColumnModified(Oops_Model_OrderHistoryPeer::ID_ORDER_STATE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ORDER_STATE`';
		}
		if ($this->isColumnModified(Oops_Model_OrderHistoryPeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}

		$sql = sprintf(
			'INSERT INTO `' . _DB_PREFIX_ . 'djland_order_history` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Model_OrderHistoryPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Model_OrderHistoryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Model_OrderHistory'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Model_OrderHistory'][$this->getPrimaryKey()] = true;
		$keys = Oops_Model_OrderHistoryPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Model_OrderHistoryPeer::ID_ORDER_HISTORY)) $criteria->add(Oops_Model_OrderHistoryPeer::ID_ORDER_HISTORY, $this->id_order_history);
		if ($this->isColumnModified(Oops_Model_OrderHistoryPeer::ID_EMPLOYEE)) $criteria->add(Oops_Model_OrderHistoryPeer::ID_EMPLOYEE, $this->id_employee);
		if ($this->isColumnModified(Oops_Model_OrderHistoryPeer::ID_ORDER)) $criteria->add(Oops_Model_OrderHistoryPeer::ID_ORDER, $this->id_order);
		if ($this->isColumnModified(Oops_Model_OrderHistoryPeer::ID_ORDER_STATE)) $criteria->add(Oops_Model_OrderHistoryPeer::ID_ORDER_STATE, $this->id_order_state);
		if ($this->isColumnModified(Oops_Model_OrderHistoryPeer::DATE_ADD)) $criteria->add(Oops_Model_OrderHistoryPeer::DATE_ADD, $this->date_add);
	...
	{
		$criteria = new Criteria(Oops_Model_OrderHistoryPeer::DATABASE_NAME);
		$criteria->add(Oops_Model_OrderHistoryPeer::ID_ORDER_HISTORY, $this->id_order_history);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Model_OrderHistory (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Model_OrderHistory Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Model_OrderHistoryPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Model_OrderHistoryPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Model_OrderHistoryPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Model_Base_OrderHistory
