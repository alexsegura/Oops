...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_product_download' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_ProductDownloadQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_PRODUCT_DOWNLOAD`, `ID_PRODUCT`, `DISPLAY_FILENAME`, `PHYSICALLY_FILENAME`, `DATE_DEPOSIT`, `DATE_EXPIRATION`, `NB_DAYS_ACCESSIBLE`, `NB_DOWNLOADABLE`, `ACTIVE` FROM `' . _DB_PREFIX_ . 'djland_product_download` WHERE `ID_PRODUCT_DOWNLOAD` = :p0';
		try {
