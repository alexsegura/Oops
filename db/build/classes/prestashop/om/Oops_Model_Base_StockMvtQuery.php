...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_stock_mvt' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_StockMvtQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_STOCK_MVT`, `ID_PRODUCT`, `ID_PRODUCT_ATTRIBUTE`, `ID_ORDER`, `ID_STOCK_MVT_REASON`, `ID_EMPLOYEE`, `QUANTITY`, `DATE_ADD`, `DATE_UPD` FROM `' . _DB_PREFIX_ . 'djland_stock_mvt` WHERE `ID_STOCK_MVT` = :p0';
		try {
