...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_attribute' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_AttributeQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_ATTRIBUTE`, `ID_ATTRIBUTE_GROUP`, `COLOR` FROM `' . _DB_PREFIX_ . 'djland_attribute` WHERE `ID_ATTRIBUTE` = :p0';
		try {
