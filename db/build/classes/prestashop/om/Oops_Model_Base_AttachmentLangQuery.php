...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_attachment_lang' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_AttachmentLangQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_ATTACHMENT`, `ID_LANG`, `NAME`, `DESCRIPTION` FROM `' . _DB_PREFIX_ . 'djland_attachment_lang` WHERE `ID_ATTACHMENT` = :p0 AND `ID_LANG` = :p1';
		try {
