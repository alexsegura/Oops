...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_search_index' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_SearchIndexQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_PRODUCT`, `ID_WORD`, `WEIGHT` FROM `' . _DB_PREFIX_ . 'djland_search_index` WHERE `ID_PRODUCT` = :p0 AND `ID_WORD` = :p1';
		try {
