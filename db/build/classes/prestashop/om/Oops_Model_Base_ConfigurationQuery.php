...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_configuration' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_ConfigurationQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_CONFIGURATION`, `NAME`, `VALUE`, `DATE_ADD`, `DATE_UPD` FROM `' . _DB_PREFIX_ . 'djland_configuration` WHERE `ID_CONFIGURATION` = :p0';
		try {
