...
abstract class Oops_Model_Base_CurrencyPeer {
	...
	const TABLE_NAME = _DB_PREFIX_ . 'djland_currency';
	...
	const ID_CURRENCY = _DB_PREFIX_ . 'djland_currency.ID_CURRENCY';

	/** the column name for the NAME field */
	const NAME = _DB_PREFIX_ . 'djland_currency.NAME';

	/** the column name for the ISO_CODE field */
	const ISO_CODE = _DB_PREFIX_ . 'djland_currency.ISO_CODE';

	/** the column name for the ISO_CODE_NUM field */
	const ISO_CODE_NUM = _DB_PREFIX_ . 'djland_currency.ISO_CODE_NUM';

	/** the column name for the SIGN field */
	const SIGN = _DB_PREFIX_ . 'djland_currency.SIGN';

	/** the column name for the BLANK field */
	const BLANK = _DB_PREFIX_ . 'djland_currency.BLANK';

	/** the column name for the FORMAT field */
	const FORMAT = _DB_PREFIX_ . 'djland_currency.FORMAT';

	/** the column name for the DECIMALS field */
	const DECIMALS = _DB_PREFIX_ . 'djland_currency.DECIMALS';

	/** the column name for the CONVERSION_RATE field */
	const CONVERSION_RATE = _DB_PREFIX_ . 'djland_currency.CONVERSION_RATE';

	/** the column name for the DELETED field */
	const DELETED = _DB_PREFIX_ . 'djland_currency.DELETED';

	/** the column name for the ACTIVE field */
	const ACTIVE = _DB_PREFIX_ . 'djland_currency.ACTIVE';
