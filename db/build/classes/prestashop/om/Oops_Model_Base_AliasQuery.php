...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_alias' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_AliasQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_ALIAS`, `ALIAS`, `SEARCH`, `ACTIVE` FROM `' . _DB_PREFIX_ . 'djland_alias` WHERE `ID_ALIAS` = :p0';
		try {
