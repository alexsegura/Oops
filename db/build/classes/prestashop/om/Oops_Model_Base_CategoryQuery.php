...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_category' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_CategoryQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_CATEGORY`, `ID_PARENT`, `LEVEL_DEPTH`, `NLEFT`, `NRIGHT`, `ACTIVE`, `DATE_ADD`, `DATE_UPD`, `POSITION` FROM `' . _DB_PREFIX_ . 'djland_category` WHERE `ID_CATEGORY` = :p0';
		try {
