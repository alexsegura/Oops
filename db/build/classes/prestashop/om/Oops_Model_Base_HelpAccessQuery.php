...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_help_access' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_HelpAccessQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_HELP_ACCESS`, `LABEL`, `VERSION` FROM `' . _DB_PREFIX_ . 'djland_help_access` WHERE `ID_HELP_ACCESS` = :p0';
		try {
