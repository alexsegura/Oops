...
abstract class Oops_Model_Base_CategoryPeer {
	...
	const TABLE_NAME = _DB_PREFIX_ . 'djland_category';
	...
	const ID_CATEGORY = _DB_PREFIX_ . 'djland_category.ID_CATEGORY';

	/** the column name for the ID_PARENT field */
	const ID_PARENT = _DB_PREFIX_ . 'djland_category.ID_PARENT';

	/** the column name for the LEVEL_DEPTH field */
	const LEVEL_DEPTH = _DB_PREFIX_ . 'djland_category.LEVEL_DEPTH';

	/** the column name for the NLEFT field */
	const NLEFT = _DB_PREFIX_ . 'djland_category.NLEFT';

	/** the column name for the NRIGHT field */
	const NRIGHT = _DB_PREFIX_ . 'djland_category.NRIGHT';

	/** the column name for the ACTIVE field */
	const ACTIVE = _DB_PREFIX_ . 'djland_category.ACTIVE';

	/** the column name for the DATE_ADD field */
	const DATE_ADD = _DB_PREFIX_ . 'djland_category.DATE_ADD';

	/** the column name for the DATE_UPD field */
	const DATE_UPD = _DB_PREFIX_ . 'djland_category.DATE_UPD';

	/** the column name for the POSITION field */
	const POSITION = _DB_PREFIX_ . 'djland_category.POSITION';
