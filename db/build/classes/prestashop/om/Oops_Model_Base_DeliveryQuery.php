...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_delivery' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_DeliveryQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_DELIVERY`, `ID_CARRIER`, `ID_RANGE_PRICE`, `ID_RANGE_WEIGHT`, `ID_ZONE`, `PRICE` FROM `' . _DB_PREFIX_ . 'djland_delivery` WHERE `ID_DELIVERY` = :p0';
		try {
