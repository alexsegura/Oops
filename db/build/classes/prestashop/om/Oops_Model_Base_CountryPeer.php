...
abstract class Oops_Model_Base_CountryPeer {
	...
	const TABLE_NAME = _DB_PREFIX_ . 'djland_country';
	...
	const ID_COUNTRY = _DB_PREFIX_ . 'djland_country.ID_COUNTRY';

	/** the column name for the ID_ZONE field */
	const ID_ZONE = _DB_PREFIX_ . 'djland_country.ID_ZONE';

	/** the column name for the ID_CURRENCY field */
	const ID_CURRENCY = _DB_PREFIX_ . 'djland_country.ID_CURRENCY';

	/** the column name for the ISO_CODE field */
	const ISO_CODE = _DB_PREFIX_ . 'djland_country.ISO_CODE';

	/** the column name for the CALL_PREFIX field */
	const CALL_PREFIX = _DB_PREFIX_ . 'djland_country.CALL_PREFIX';

	/** the column name for the ACTIVE field */
	const ACTIVE = _DB_PREFIX_ . 'djland_country.ACTIVE';

	/** the column name for the CONTAINS_STATES field */
	const CONTAINS_STATES = _DB_PREFIX_ . 'djland_country.CONTAINS_STATES';

	/** the column name for the NEED_IDENTIFICATION_NUMBER field */
	const NEED_IDENTIFICATION_NUMBER = _DB_PREFIX_ . 'djland_country.NEED_IDENTIFICATION_NUMBER';

	/** the column name for the NEED_ZIP_CODE field */
	const NEED_ZIP_CODE = _DB_PREFIX_ . 'djland_country.NEED_ZIP_CODE';

	/** the column name for the ZIP_CODE_FORMAT field */
	const ZIP_CODE_FORMAT = _DB_PREFIX_ . 'djland_country.ZIP_CODE_FORMAT';

	/** the column name for the DISPLAY_TAX_LABEL field */
	const DISPLAY_TAX_LABEL = _DB_PREFIX_ . 'djland_country.DISPLAY_TAX_LABEL';
