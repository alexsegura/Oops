...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_import_match' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_ImportMatchQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_IMPORT_MATCH`, `NAME`, `MATCH`, `SKIP` FROM `' . _DB_PREFIX_ . 'djland_import_match` WHERE `ID_IMPORT_MATCH` = :p0';
		try {
