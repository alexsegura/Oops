...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_log' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_LogQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_LOG`, `SEVERITY`, `ERROR_CODE`, `MESSAGE`, `OBJECT_TYPE`, `OBJECT_ID`, `DATE_ADD`, `DATE_UPD` FROM `' . _DB_PREFIX_ . 'djland_log` WHERE `ID_LOG` = :p0';
		try {
