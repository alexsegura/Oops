...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_specific_price' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_SpecificPriceQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_SPECIFIC_PRICE`, `ID_PRODUCT`, `ID_SHOP`, `ID_CURRENCY`, `ID_COUNTRY`, `ID_GROUP`, `PRICE`, `FROM_QUANTITY`, `REDUCTION`, `REDUCTION_TYPE`, `FROM`, `TO` FROM `' . _DB_PREFIX_ . 'djland_specific_price` WHERE `ID_SPECIFIC_PRICE` = :p0';
		try {
