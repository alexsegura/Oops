...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_attachment' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_AttachmentQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_ATTACHMENT`, `FILE`, `FILE_NAME`, `MIME` FROM `' . _DB_PREFIX_ . 'djland_attachment` WHERE `ID_ATTACHMENT` = :p0';
		try {
