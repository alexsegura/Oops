...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_cms_block_page' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_CmsBlockPageQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_CMS_BLOCK_PAGE`, `ID_CMS_BLOCK`, `ID_CMS`, `IS_CATEGORY` FROM `' . _DB_PREFIX_ . 'djland_cms_block_page` WHERE `ID_CMS_BLOCK_PAGE` = :p0';
		try {
