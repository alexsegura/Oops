...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_tax_rule' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_TaxRuleQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_TAX_RULE`, `ID_TAX_RULES_GROUP`, `ID_COUNTRY`, `ID_STATE`, `ID_COUNTY`, `ID_TAX`, `STATE_BEHAVIOR`, `COUNTY_BEHAVIOR` FROM `' . _DB_PREFIX_ . 'djland_tax_rule` WHERE `ID_TAX_RULE` = :p0';
		try {
