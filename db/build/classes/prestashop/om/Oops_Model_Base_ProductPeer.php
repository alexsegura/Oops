...
abstract class Oops_Model_Base_ProductPeer {
	...
	const TABLE_NAME = _DB_PREFIX_ . 'djland_product';
	...
	const ID_PRODUCT = _DB_PREFIX_ . 'djland_product.ID_PRODUCT';

	/** the column name for the ID_SUPPLIER field */
	const ID_SUPPLIER = _DB_PREFIX_ . 'djland_product.ID_SUPPLIER';

	/** the column name for the ID_MANUFACTURER field */
	const ID_MANUFACTURER = _DB_PREFIX_ . 'djland_product.ID_MANUFACTURER';

	/** the column name for the ID_TAX_RULES_GROUP field */
	const ID_TAX_RULES_GROUP = _DB_PREFIX_ . 'djland_product.ID_TAX_RULES_GROUP';

	/** the column name for the ID_CATEGORY_DEFAULT field */
	const ID_CATEGORY_DEFAULT = _DB_PREFIX_ . 'djland_product.ID_CATEGORY_DEFAULT';

	/** the column name for the ID_COLOR_DEFAULT field */
	const ID_COLOR_DEFAULT = _DB_PREFIX_ . 'djland_product.ID_COLOR_DEFAULT';

	/** the column name for the ON_SALE field */
	const ON_SALE = _DB_PREFIX_ . 'djland_product.ON_SALE';

	/** the column name for the ONLINE_ONLY field */
	const ONLINE_ONLY = _DB_PREFIX_ . 'djland_product.ONLINE_ONLY';

	/** the column name for the EAN13 field */
	const EAN13 = _DB_PREFIX_ . 'djland_product.EAN13';

	/** the column name for the UPC field */
	const UPC = _DB_PREFIX_ . 'djland_product.UPC';

	/** the column name for the ECOTAX field */
	const ECOTAX = _DB_PREFIX_ . 'djland_product.ECOTAX';

	/** the column name for the QUANTITY field */
	const QUANTITY = _DB_PREFIX_ . 'djland_product.QUANTITY';

	/** the column name for the MINIMAL_QUANTITY field */
	const MINIMAL_QUANTITY = _DB_PREFIX_ . 'djland_product.MINIMAL_QUANTITY';

	/** the column name for the PRICE field */
	const PRICE = _DB_PREFIX_ . 'djland_product.PRICE';

	/** the column name for the WHOLESALE_PRICE field */
	const WHOLESALE_PRICE = _DB_PREFIX_ . 'djland_product.WHOLESALE_PRICE';

	/** the column name for the UNITY field */
	const UNITY = _DB_PREFIX_ . 'djland_product.UNITY';

	/** the column name for the UNIT_PRICE_RATIO field */
	const UNIT_PRICE_RATIO = _DB_PREFIX_ . 'djland_product.UNIT_PRICE_RATIO';

	/** the column name for the ADDITIONAL_SHIPPING_COST field */
	const ADDITIONAL_SHIPPING_COST = _DB_PREFIX_ . 'djland_product.ADDITIONAL_SHIPPING_COST';

	/** the column name for the REFERENCE field */
	const REFERENCE = _DB_PREFIX_ . 'djland_product.REFERENCE';

	/** the column name for the SUPPLIER_REFERENCE field */
	const SUPPLIER_REFERENCE = _DB_PREFIX_ . 'djland_product.SUPPLIER_REFERENCE';

	/** the column name for the LOCATION field */
	const LOCATION = _DB_PREFIX_ . 'djland_product.LOCATION';

	/** the column name for the WIDTH field */
	const WIDTH = _DB_PREFIX_ . 'djland_product.WIDTH';

	/** the column name for the HEIGHT field */
	const HEIGHT = _DB_PREFIX_ . 'djland_product.HEIGHT';

	/** the column name for the DEPTH field */
	const DEPTH = _DB_PREFIX_ . 'djland_product.DEPTH';

	/** the column name for the WEIGHT field */
	const WEIGHT = _DB_PREFIX_ . 'djland_product.WEIGHT';

	/** the column name for the OUT_OF_STOCK field */
	const OUT_OF_STOCK = _DB_PREFIX_ . 'djland_product.OUT_OF_STOCK';

	/** the column name for the QUANTITY_DISCOUNT field */
	const QUANTITY_DISCOUNT = _DB_PREFIX_ . 'djland_product.QUANTITY_DISCOUNT';

	/** the column name for the CUSTOMIZABLE field */
	const CUSTOMIZABLE = _DB_PREFIX_ . 'djland_product.CUSTOMIZABLE';

	/** the column name for the UPLOADABLE_FILES field */
	const UPLOADABLE_FILES = _DB_PREFIX_ . 'djland_product.UPLOADABLE_FILES';

	/** the column name for the TEXT_FIELDS field */
	const TEXT_FIELDS = _DB_PREFIX_ . 'djland_product.TEXT_FIELDS';

	/** the column name for the ACTIVE field */
	const ACTIVE = _DB_PREFIX_ . 'djland_product.ACTIVE';

	/** the column name for the AVAILABLE_FOR_ORDER field */
	const AVAILABLE_FOR_ORDER = _DB_PREFIX_ . 'djland_product.AVAILABLE_FOR_ORDER';

	/** the column name for the CONDITION field */
	const CONDITION = _DB_PREFIX_ . 'djland_product.CONDITION';

	/** the column name for the SHOW_PRICE field */
	const SHOW_PRICE = _DB_PREFIX_ . 'djland_product.SHOW_PRICE';

	/** the column name for the INDEXED field */
	const INDEXED = _DB_PREFIX_ . 'djland_product.INDEXED';

	/** the column name for the CACHE_IS_PACK field */
	const CACHE_IS_PACK = _DB_PREFIX_ . 'djland_product.CACHE_IS_PACK';

	/** the column name for the CACHE_HAS_ATTACHMENTS field */
	const CACHE_HAS_ATTACHMENTS = _DB_PREFIX_ . 'djland_product.CACHE_HAS_ATTACHMENTS';

	/** the column name for the CACHE_DEFAULT_ATTRIBUTE field */
	const CACHE_DEFAULT_ATTRIBUTE = _DB_PREFIX_ . 'djland_product.CACHE_DEFAULT_ATTRIBUTE';

	/** the column name for the DATE_ADD field */
	const DATE_ADD = _DB_PREFIX_ . 'djland_product.DATE_ADD';

	/** the column name for the DATE_UPD field */
	const DATE_UPD = _DB_PREFIX_ . 'djland_product.DATE_UPD';
