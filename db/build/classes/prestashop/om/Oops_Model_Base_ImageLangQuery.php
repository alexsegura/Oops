...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_image_lang' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_ImageLangQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_IMAGE`, `ID_LANG`, `LEGEND` FROM `' . _DB_PREFIX_ . 'djland_image_lang` WHERE `ID_IMAGE` = :p0';
		try {
