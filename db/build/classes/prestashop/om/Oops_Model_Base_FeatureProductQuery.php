...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_feature_product' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_FeatureProductQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_FEATURE`, `ID_PRODUCT`, `ID_FEATURE_VALUE` FROM `' . _DB_PREFIX_ . 'djland_feature_product` WHERE `ID_FEATURE` = :p0 AND `ID_PRODUCT` = :p1';
		try {
