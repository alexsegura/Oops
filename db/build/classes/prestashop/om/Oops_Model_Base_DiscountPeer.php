...
abstract class Oops_Model_Base_DiscountPeer {
	...
	const TABLE_NAME = _DB_PREFIX_ . 'djland_discount';
	...
	const ID_DISCOUNT = _DB_PREFIX_ . 'djland_discount.ID_DISCOUNT';

	/** the column name for the ID_DISCOUNT_TYPE field */
	const ID_DISCOUNT_TYPE = _DB_PREFIX_ . 'djland_discount.ID_DISCOUNT_TYPE';

	/** the column name for the BEHAVIOR_NOT_EXHAUSTED field */
	const BEHAVIOR_NOT_EXHAUSTED = _DB_PREFIX_ . 'djland_discount.BEHAVIOR_NOT_EXHAUSTED';

	/** the column name for the ID_CUSTOMER field */
	const ID_CUSTOMER = _DB_PREFIX_ . 'djland_discount.ID_CUSTOMER';

	/** the column name for the ID_GROUP field */
	const ID_GROUP = _DB_PREFIX_ . 'djland_discount.ID_GROUP';

	/** the column name for the ID_CURRENCY field */
	const ID_CURRENCY = _DB_PREFIX_ . 'djland_discount.ID_CURRENCY';

	/** the column name for the NAME field */
	const NAME = _DB_PREFIX_ . 'djland_discount.NAME';

	/** the column name for the VALUE field */
	const VALUE = _DB_PREFIX_ . 'djland_discount.VALUE';

	/** the column name for the QUANTITY field */
	const QUANTITY = _DB_PREFIX_ . 'djland_discount.QUANTITY';

	/** the column name for the QUANTITY_PER_USER field */
	const QUANTITY_PER_USER = _DB_PREFIX_ . 'djland_discount.QUANTITY_PER_USER';

	/** the column name for the CUMULABLE field */
	const CUMULABLE = _DB_PREFIX_ . 'djland_discount.CUMULABLE';

	/** the column name for the CUMULABLE_REDUCTION field */
	const CUMULABLE_REDUCTION = _DB_PREFIX_ . 'djland_discount.CUMULABLE_REDUCTION';

	/** the column name for the DATE_FROM field */
	const DATE_FROM = _DB_PREFIX_ . 'djland_discount.DATE_FROM';

	/** the column name for the DATE_TO field */
	const DATE_TO = _DB_PREFIX_ . 'djland_discount.DATE_TO';

	/** the column name for the MINIMAL field */
	const MINIMAL = _DB_PREFIX_ . 'djland_discount.MINIMAL';

	/** the column name for the ACTIVE field */
	const ACTIVE = _DB_PREFIX_ . 'djland_discount.ACTIVE';

	/** the column name for the CART_DISPLAY field */
	const CART_DISPLAY = _DB_PREFIX_ . 'djland_discount.CART_DISPLAY';

	/** the column name for the DATE_ADD field */
	const DATE_ADD = _DB_PREFIX_ . 'djland_discount.DATE_ADD';

	/** the column name for the DATE_UPD field */
	const DATE_UPD = _DB_PREFIX_ . 'djland_discount.DATE_UPD';
