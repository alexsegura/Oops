...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_currency' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_CurrencyQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_CURRENCY`, `NAME`, `ISO_CODE`, `ISO_CODE_NUM`, `SIGN`, `BLANK`, `FORMAT`, `DECIMALS`, `CONVERSION_RATE`, `DELETED`, `ACTIVE` FROM `' . _DB_PREFIX_ . 'djland_currency` WHERE `ID_CURRENCY` = :p0';
		try {
