...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_cart' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_CartQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_CART`, `ID_CARRIER`, `ID_LANG`, `ID_ADDRESS_DELIVERY`, `ID_ADDRESS_INVOICE`, `ID_CURRENCY`, `ID_CUSTOMER`, `ID_GUEST`, `SECURE_KEY`, `RECYCLABLE`, `GIFT`, `GIFT_MESSAGE`, `DATE_ADD`, `DATE_UPD` FROM `' . _DB_PREFIX_ . 'djland_cart` WHERE `ID_CART` = :p0';
		try {
