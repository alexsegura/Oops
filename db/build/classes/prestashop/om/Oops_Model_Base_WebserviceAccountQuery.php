...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_webservice_account' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_WebserviceAccountQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_WEBSERVICE_ACCOUNT`, `KEY`, `DESCRIPTION`, `CLASS_NAME`, `IS_MODULE`, `MODULE_NAME`, `ACTIVE` FROM `' . _DB_PREFIX_ . 'djland_webservice_account` WHERE `ID_WEBSERVICE_ACCOUNT` = :p0';
		try {
