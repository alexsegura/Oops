...
/**
 * Base class that represents a row from the 'djland_supplier' table.
 *
 * 
 *
 * @package    propel.generator.prestashop.om
 */
abstract class Oops_Model_Base_Supplier extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Model_SupplierPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Model_SupplierPeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Model_Base_Supplier object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Model_Supplier The current object (for fluent API support)
	 */
	public function setIdSupplier($v)
	{
		...
		if ($this->id_supplier !== $v) {
			$this->id_supplier = $v;
			$this->modifiedColumns[] = Oops_Model_SupplierPeer::ID_SUPPLIER;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = Oops_Model_SupplierPeer::NAME;
		}
	...
	public function setDateAdd($v)
	{
		...
		if ($this->date_add !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Model_SupplierPeer::DATE_ADD;
			}
	...
	public function setDateUpd($v)
	{
		...
		if ($this->date_upd !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = Oops_Model_SupplierPeer::DATE_UPD;
			}
		} // if either are not null
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v) {
			$this->active = $v;
			$this->modifiedColumns[] = Oops_Model_SupplierPeer::ACTIVE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = Oops_Model_SupplierPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Model_Supplier object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Model_SupplierPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Model_SupplierQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Model_SupplierPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Model_SupplierPeer::ID_SUPPLIER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_SUPPLIER`';
		}
		if ($this->isColumnModified(Oops_Model_SupplierPeer::NAME)) {
			$modifiedColumns[':p' . $index++]  = '`NAME`';
		}
		if ($this->isColumnModified(Oops_Model_SupplierPeer::DATE_ADD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_ADD`';
		}
		if ($this->isColumnModified(Oops_Model_SupplierPeer::DATE_UPD)) {
			$modifiedColumns[':p' . $index++]  = '`DATE_UPD`';
		}
		if ($this->isColumnModified(Oops_Model_SupplierPeer::ACTIVE)) {
			$modifiedColumns[':p' . $index++]  = '`ACTIVE`';
		}

		$sql = sprintf(
			'INSERT INTO `' . _DB_PREFIX_ . 'djland_supplier` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Model_SupplierPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Model_SupplierPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Model_Supplier'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Model_Supplier'][$this->getPrimaryKey()] = true;
		$keys = Oops_Model_SupplierPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Model_SupplierPeer::ID_SUPPLIER)) $criteria->add(Oops_Model_SupplierPeer::ID_SUPPLIER, $this->id_supplier);
		if ($this->isColumnModified(Oops_Model_SupplierPeer::NAME)) $criteria->add(Oops_Model_SupplierPeer::NAME, $this->name);
		if ($this->isColumnModified(Oops_Model_SupplierPeer::DATE_ADD)) $criteria->add(Oops_Model_SupplierPeer::DATE_ADD, $this->date_add);
		if ($this->isColumnModified(Oops_Model_SupplierPeer::DATE_UPD)) $criteria->add(Oops_Model_SupplierPeer::DATE_UPD, $this->date_upd);
		if ($this->isColumnModified(Oops_Model_SupplierPeer::ACTIVE)) $criteria->add(Oops_Model_SupplierPeer::ACTIVE, $this->active);
	...
	{
		$criteria = new Criteria(Oops_Model_SupplierPeer::DATABASE_NAME);
		$criteria->add(Oops_Model_SupplierPeer::ID_SUPPLIER, $this->id_supplier);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Model_Supplier (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Model_Supplier Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Model_SupplierPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Model_SupplierPeer();
		}
		return self::$peer;
	}
	...
	public function getProduct(PropelPDO $con = null)
	{
		if ($this->aProduct === null && ($this->id_supplier !== null)) {
			$this->aProduct = Oops_Model_ProductQuery::create()
	...
	{
		return (string) $this->exportTo(Oops_Model_SupplierPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Model_Base_Supplier
