...
/**
 * Base class that represents a row from the 'djland_order_detail' table.
 *
 * 
 *
 * @package    propel.generator.prestashop.om
 */
abstract class Oops_Model_Base_OrderDetail extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Model_OrderDetailPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Model_OrderDetailPeer
	 */
	...
	/**
	 * Initializes internal state of Oops_Model_Base_OrderDetail object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     Oops_Model_OrderDetail The current object (for fluent API support)
	 */
	public function setIdOrderDetail($v)
	{
		...
		if ($this->id_order_detail !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::ID_ORDER_DETAIL;
		}
	...
	public function setIdOrder($v)
	{
		...
		if ($this->id_order !== $v) {
			$this->id_order = $v;
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::ID_ORDER;
		}
	...
	public function setProductId($v)
	{
		...
		if ($this->product_id !== $v) {
			$this->product_id = $v;
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_ID;
		}
	...
	public function setProductAttributeId($v)
	{
		...
		if ($this->product_attribute_id !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_ATTRIBUTE_ID;
		}
	...
	public function setProductName($v)
	{
		...
		if ($this->product_name !== $v) {
			$this->product_name = $v;
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_NAME;
		}
	...
	public function setProductQuantity($v)
	{
		...
		if ($this->product_quantity !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY;
		}
	...
	public function setProductQuantityInStock($v)
	{
		...
		if ($this->product_quantity_in_stock !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_IN_STOCK;
		}
	...
	public function setProductQuantityRefunded($v)
	{
		...
		if ($this->product_quantity_refunded !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_REFUNDED;
		}
	...
	public function setProductQuantityReturn($v)
	{
		...
		if ($this->product_quantity_return !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_RETURN;
		}
	...
	public function setProductQuantityReinjected($v)
	{
		...
		if ($this->product_quantity_reinjected !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_REINJECTED;
		}
	...
	public function setProductPrice($v)
	{
		...
		if ($this->product_price !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_PRICE;
		}
	...
	public function setReductionPercent($v)
	{
		...
		if ($this->reduction_percent !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::REDUCTION_PERCENT;
		}
	...
	public function setReductionAmount($v)
	{
		...
		if ($this->reduction_amount !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::REDUCTION_AMOUNT;
		}
	...
	public function setGroupReduction($v)
	{
		...
		if ($this->group_reduction !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::GROUP_REDUCTION;
		}
	...
	public function setProductQuantityDiscount($v)
	{
		...
		if ($this->product_quantity_discount !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_DISCOUNT;
		}
	...
	public function setProductEan13($v)
	{
		...
		if ($this->product_ean13 !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_EAN13;
		}
	...
	public function setProductUpc($v)
	{
		...
		if ($this->product_upc !== $v) {
			$this->product_upc = $v;
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_UPC;
		}
	...
	public function setProductReference($v)
	{
		...
		if ($this->product_reference !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_REFERENCE;
		}
	...
	public function setProductSupplierReference($v)
	{
		...
		if ($this->product_supplier_reference !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_SUPPLIER_REFERENCE;
		}
	...
	public function setProductWeight($v)
	{
		...
		if ($this->product_weight !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::PRODUCT_WEIGHT;
		}
	...
	public function setTaxName($v)
	{
		...
		if ($this->tax_name !== $v) {
			$this->tax_name = $v;
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::TAX_NAME;
		}
	...
	public function setTaxRate($v)
	{
		...
		if ($this->tax_rate !== $v) {
			$this->tax_rate = $v;
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::TAX_RATE;
		}
	...
	public function setEcotax($v)
	{
		...
		if ($this->ecotax !== $v) {
			$this->ecotax = $v;
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::ECOTAX;
		}
	...
	public function setEcotaxTaxRate($v)
	{
		...
		if ($this->ecotax_tax_rate !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::ECOTAX_TAX_RATE;
		}
	...
	public function setDiscountQuantityApplied($v)
	{
		...
		if ($this->discount_quantity_applied !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::DISCOUNT_QUANTITY_APPLIED;
		}
	...
	public function setDownloadHash($v)
	{
		...
		if ($this->download_hash !== $v) {
			...
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::DOWNLOAD_HASH;
		}
	...
	public function setDownloadNb($v)
	{
		...
		if ($this->download_nb !== $v) {
			$this->download_nb = $v;
			$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::DOWNLOAD_NB;
		}
	...
	public function setDownloadDeadline($v)
	{
		...
		if ($this->download_deadline !== null || $dt !== null) {
			...
			if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
				...
				$this->modifiedColumns[] = Oops_Model_OrderDetailPeer::DOWNLOAD_DEADLINE;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 28; // 28 = Oops_Model_OrderDetailPeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Model_OrderDetail object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Model_OrderDetailPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Model_OrderDetailQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Model_OrderDetailPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::ID_ORDER_DETAIL)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ORDER_DETAIL`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::ID_ORDER)) {
			$modifiedColumns[':p' . $index++]  = '`ID_ORDER`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_ID)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_ID`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_ATTRIBUTE_ID)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_ATTRIBUTE_ID`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_NAME)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_NAME`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_QUANTITY`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_IN_STOCK)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_QUANTITY_IN_STOCK`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_REFUNDED)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_QUANTITY_REFUNDED`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_RETURN)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_QUANTITY_RETURN`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_REINJECTED)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_QUANTITY_REINJECTED`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_PRICE)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_PRICE`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::REDUCTION_PERCENT)) {
			$modifiedColumns[':p' . $index++]  = '`REDUCTION_PERCENT`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::REDUCTION_AMOUNT)) {
			$modifiedColumns[':p' . $index++]  = '`REDUCTION_AMOUNT`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::GROUP_REDUCTION)) {
			$modifiedColumns[':p' . $index++]  = '`GROUP_REDUCTION`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_DISCOUNT)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_QUANTITY_DISCOUNT`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_EAN13)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_EAN13`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_UPC)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_UPC`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_REFERENCE)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_REFERENCE`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_SUPPLIER_REFERENCE)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_SUPPLIER_REFERENCE`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_WEIGHT)) {
			$modifiedColumns[':p' . $index++]  = '`PRODUCT_WEIGHT`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::TAX_NAME)) {
			$modifiedColumns[':p' . $index++]  = '`TAX_NAME`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::TAX_RATE)) {
			$modifiedColumns[':p' . $index++]  = '`TAX_RATE`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::ECOTAX)) {
			$modifiedColumns[':p' . $index++]  = '`ECOTAX`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::ECOTAX_TAX_RATE)) {
			$modifiedColumns[':p' . $index++]  = '`ECOTAX_TAX_RATE`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::DISCOUNT_QUANTITY_APPLIED)) {
			$modifiedColumns[':p' . $index++]  = '`DISCOUNT_QUANTITY_APPLIED`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::DOWNLOAD_HASH)) {
			$modifiedColumns[':p' . $index++]  = '`DOWNLOAD_HASH`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::DOWNLOAD_NB)) {
			$modifiedColumns[':p' . $index++]  = '`DOWNLOAD_NB`';
		}
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::DOWNLOAD_DEADLINE)) {
			$modifiedColumns[':p' . $index++]  = '`DOWNLOAD_DEADLINE`';
		}

		$sql = sprintf(
			'INSERT INTO `' . _DB_PREFIX_ . 'djland_order_detail` (%s) VALUES (%s)',
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Oops_Model_OrderDetailPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Oops_Model_OrderDetailPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['Oops_Model_OrderDetail'][$this->getPrimaryKey()])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['Oops_Model_OrderDetail'][$this->getPrimaryKey()] = true;
		$keys = Oops_Model_OrderDetailPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::ID_ORDER_DETAIL)) $criteria->add(Oops_Model_OrderDetailPeer::ID_ORDER_DETAIL, $this->id_order_detail);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::ID_ORDER)) $criteria->add(Oops_Model_OrderDetailPeer::ID_ORDER, $this->id_order);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_ID)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_ID, $this->product_id);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_ATTRIBUTE_ID)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_ATTRIBUTE_ID, $this->product_attribute_id);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_NAME)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_NAME, $this->product_name);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY, $this->product_quantity);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_IN_STOCK)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_IN_STOCK, $this->product_quantity_in_stock);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_REFUNDED)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_REFUNDED, $this->product_quantity_refunded);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_RETURN)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_RETURN, $this->product_quantity_return);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_REINJECTED)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_REINJECTED, $this->product_quantity_reinjected);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_PRICE)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_PRICE, $this->product_price);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::REDUCTION_PERCENT)) $criteria->add(Oops_Model_OrderDetailPeer::REDUCTION_PERCENT, $this->reduction_percent);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::REDUCTION_AMOUNT)) $criteria->add(Oops_Model_OrderDetailPeer::REDUCTION_AMOUNT, $this->reduction_amount);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::GROUP_REDUCTION)) $criteria->add(Oops_Model_OrderDetailPeer::GROUP_REDUCTION, $this->group_reduction);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_DISCOUNT)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_QUANTITY_DISCOUNT, $this->product_quantity_discount);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_EAN13)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_EAN13, $this->product_ean13);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_UPC)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_UPC, $this->product_upc);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_REFERENCE)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_REFERENCE, $this->product_reference);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_SUPPLIER_REFERENCE)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_SUPPLIER_REFERENCE, $this->product_supplier_reference);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::PRODUCT_WEIGHT)) $criteria->add(Oops_Model_OrderDetailPeer::PRODUCT_WEIGHT, $this->product_weight);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::TAX_NAME)) $criteria->add(Oops_Model_OrderDetailPeer::TAX_NAME, $this->tax_name);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::TAX_RATE)) $criteria->add(Oops_Model_OrderDetailPeer::TAX_RATE, $this->tax_rate);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::ECOTAX)) $criteria->add(Oops_Model_OrderDetailPeer::ECOTAX, $this->ecotax);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::ECOTAX_TAX_RATE)) $criteria->add(Oops_Model_OrderDetailPeer::ECOTAX_TAX_RATE, $this->ecotax_tax_rate);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::DISCOUNT_QUANTITY_APPLIED)) $criteria->add(Oops_Model_OrderDetailPeer::DISCOUNT_QUANTITY_APPLIED, $this->discount_quantity_applied);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::DOWNLOAD_HASH)) $criteria->add(Oops_Model_OrderDetailPeer::DOWNLOAD_HASH, $this->download_hash);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::DOWNLOAD_NB)) $criteria->add(Oops_Model_OrderDetailPeer::DOWNLOAD_NB, $this->download_nb);
		if ($this->isColumnModified(Oops_Model_OrderDetailPeer::DOWNLOAD_DEADLINE)) $criteria->add(Oops_Model_OrderDetailPeer::DOWNLOAD_DEADLINE, $this->download_deadline);
	...
	{
		$criteria = new Criteria(Oops_Model_OrderDetailPeer::DATABASE_NAME);
		$criteria->add(Oops_Model_OrderDetailPeer::ID_ORDER_DETAIL, $this->id_order_detail);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Model_OrderDetail (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Model_OrderDetail Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Model_OrderDetailPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Model_OrderDetailPeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(Oops_Model_OrderDetailPeer::DEFAULT_STRING_FORMAT);
	}

} // Oops_Model_Base_OrderDetail
