 ...
 */
abstract class Oops_Model_Base_FeatureValue extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'Oops_Model_FeatureValuePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        Oops_Model_FeatureValuePeer
	 */
	...
	public function setCustom($v)
	{
		...
		if ($this->custom !== $v) {
			$this->custom = $v;
			$this->modifiedColumns[] = Oops_Model_FeatureValuePeer::CUSTOM;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = Oops_Model_FeatureValuePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating Oops_Model_FeatureValue object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = Oops_Model_FeatureValuePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = Oops_Model_FeatureValueQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				Oops_Model_FeatureValuePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(Oops_Model_FeatureValuePeer::ID_FEATURE_VALUE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_FEATURE_VALUE`';
		}
		if ($this->isColumnModified(Oops_Model_FeatureValuePeer::ID_FEATURE)) {
			$modifiedColumns[':p' . $index++]  = '`ID_FEATURE`';
		}
		if ($this->isColumnModified(Oops_Model_FeatureValuePeer::CUSTOM)) {
			$modifiedColumns[':p' . $index++]  = '`CUSTOM`';
		}

		$sql = sprintf(
			'INSERT INTO `' . _DB_PREFIX_ . 'djland_feature_value` (%s) VALUES (%s)',
	...
	{
		$pos = Oops_Model_FeatureValuePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
	{
		...
		$alreadyDumpedObjects['Oops_Model_FeatureValue'][$this->getPrimaryKey()] = true;
		$keys = Oops_Model_FeatureValuePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Oops_Model_FeatureValuePeer::ID_FEATURE_VALUE)) $criteria->add(Oops_Model_FeatureValuePeer::ID_FEATURE_VALUE, $this->id_feature_value);
		if ($this->isColumnModified(Oops_Model_FeatureValuePeer::ID_FEATURE)) $criteria->add(Oops_Model_FeatureValuePeer::ID_FEATURE, $this->id_feature);
		if ($this->isColumnModified(Oops_Model_FeatureValuePeer::CUSTOM)) $criteria->add(Oops_Model_FeatureValuePeer::CUSTOM, $this->custom);
	...
	{
		$criteria = new Criteria(Oops_Model_FeatureValuePeer::DATABASE_NAME);
		$criteria->add(Oops_Model_FeatureValuePeer::ID_FEATURE_VALUE, $this->id_feature_value);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Oops_Model_FeatureValue (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Oops_Model_FeatureValue Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     Oops_Model_FeatureValuePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new Oops_Model_FeatureValuePeer();
		}
		return self::$peer;
	}
