...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_cart_product' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_CartProductQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_CART`, `ID_PRODUCT`, `ID_PRODUCT_ATTRIBUTE`, `QUANTITY`, `DATE_ADD` FROM `' . _DB_PREFIX_ . 'djland_cart_product` WHERE `ID_CART` = :p0';
		try {
