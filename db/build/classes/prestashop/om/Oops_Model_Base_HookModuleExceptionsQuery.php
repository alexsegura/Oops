...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_hook_module_exceptions' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_HookModuleExceptionsQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_HOOK_MODULE_EXCEPTIONS`, `ID_MODULE`, `ID_HOOK`, `FILE_NAME` FROM `' . _DB_PREFIX_ . 'djland_hook_module_exceptions` WHERE `ID_HOOK_MODULE_EXCEPTIONS` = :p0';
		try {
