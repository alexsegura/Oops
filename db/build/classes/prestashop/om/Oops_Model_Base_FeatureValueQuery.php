...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_feature_value' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_FeatureValueQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_FEATURE_VALUE`, `ID_FEATURE`, `CUSTOM` FROM `' . _DB_PREFIX_ . 'djland_feature_value` WHERE `ID_FEATURE_VALUE` = :p0';
		try {
