...
/**
 * Base class that represents a query for the '' . _DB_PREFIX_ . 'djland_configuration_lang' table.
 *
 * 
 *
...
abstract class Oops_Model_Base_ConfigurationLangQuery extends ModelCriteria
{
	...
	{
		$sql = 'SELECT `ID_CONFIGURATION`, `ID_LANG`, `VALUE`, `DATE_UPD` FROM `' . _DB_PREFIX_ . 'djland_configuration_lang` WHERE `ID_CONFIGURATION` = :p0 AND `ID_LANG` = :p1';
		try {
